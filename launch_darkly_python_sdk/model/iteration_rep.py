...
class IterationRep(
    ...
    class MetaOapg:
        ...
        class properties:
            hypothesis = schemas.StrSchema
            status = schemas.StrSchema
            createdAt = schemas.Int64Schema
            _id = schemas.StrSchema
            startedAt = schemas.Int64Schema
            endedAt = schemas.Int64Schema
            winningTreatmentId = schemas.StrSchema
            winningReason = schemas.StrSchema
            canReshuffleTraffic = schemas.BoolSchema
        
            @staticmethod
            def flags() -> typing.Type['IterationRepFlags']:
                return IterationRepFlags
        
            @staticmethod
            def primaryMetric() -> typing.Type['DependentMetricOrMetricGroupRep']:
                return DependentMetricOrMetricGroupRep
        
            @staticmethod
            def primarySingleMetric() -> typing.Type['MetricV2Rep']:
                return MetricV2Rep
        
            @staticmethod
            def primaryFunnel() -> typing.Type['DependentMetricGroupRepWithMetrics']:
                return DependentMetricGroupRepWithMetrics
            randomizationUnit = schemas.StrSchema
            ...
            class treatments(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TreatmentRep']:
                        return TreatmentRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TreatmentRep'], typing.List['TreatmentRep']],
                ...
                def __getitem__(self, i: int) -> 'TreatmentRep':
            ...
            class secondaryMetrics(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MetricV2Rep']:
                        return MetricV2Rep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MetricV2Rep'], typing.List['MetricV2Rep']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'secondaryMetrics':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'MetricV2Rep':
                    return super().__getitem__(i)
            ...
            class metrics(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DependentMetricOrMetricGroupRep']:
                        return DependentMetricOrMetricGroupRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DependentMetricOrMetricGroupRep'], typing.List['DependentMetricOrMetricGroupRep']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'metrics':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'DependentMetricOrMetricGroupRep':
                    return super().__getitem__(i)
            __annotations__ = {
                ...
                "primarySingleMetric": primarySingleMetric,
    ...
    hypothesis: MetaOapg.properties.hypothesis
    status: MetaOapg.properties.status
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["hypothesis"]) -> MetaOapg.properties.hypothesis: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["winningTreatmentId"]) -> MetaOapg.properties.winningTreatmentId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["winningReason"]) -> MetaOapg.properties.winningReason: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["canReshuffleTraffic"]) -> MetaOapg.properties.canReshuffleTraffic: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["flags"]) -> 'IterationRepFlags': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["primaryMetric"]) -> 'DependentMetricOrMetricGroupRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["primarySingleMetric"]) -> 'MetricV2Rep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["primaryFunnel"]) -> 'DependentMetricGroupRepWithMetrics': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["randomizationUnit"]) -> MetaOapg.properties.randomizationUnit: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["treatments"]) -> MetaOapg.properties.treatments: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["secondaryMetrics"]) -> MetaOapg.properties.secondaryMetrics: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hypothesis", "status", "createdAt", "_id", "startedAt", "endedAt", "winningTreatmentId", "winningReason", "canReshuffleTraffic", "flags", "primaryMetric", "primarySingleMetric", "primaryFunnel", "randomizationUnit", "treatments", "secondaryMetrics", "metrics", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["hypothesis"]) -> MetaOapg.properties.hypothesis: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["winningTreatmentId"]) -> typing.Union[MetaOapg.properties.winningTreatmentId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["winningReason"]) -> typing.Union[MetaOapg.properties.winningReason, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["canReshuffleTraffic"]) -> typing.Union[MetaOapg.properties.canReshuffleTraffic, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["flags"]) -> typing.Union['IterationRepFlags', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["primaryMetric"]) -> typing.Union['DependentMetricOrMetricGroupRep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["primarySingleMetric"]) -> typing.Union['MetricV2Rep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["primaryFunnel"]) -> typing.Union['DependentMetricGroupRepWithMetrics', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["randomizationUnit"]) -> typing.Union[MetaOapg.properties.randomizationUnit, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["treatments"]) -> typing.Union[MetaOapg.properties.treatments, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["secondaryMetrics"]) -> typing.Union[MetaOapg.properties.secondaryMetrics, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hypothesis", "status", "createdAt", "_id", "startedAt", "endedAt", "winningTreatmentId", "winningReason", "canReshuffleTraffic", "flags", "primaryMetric", "primarySingleMetric", "primaryFunnel", "randomizationUnit", "treatments", "secondaryMetrics", "metrics", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        hypothesis: typing.Union[MetaOapg.properties.hypothesis, str, ],
        ...
        winningTreatmentId: typing.Union[MetaOapg.properties.winningTreatmentId, str, schemas.Unset] = schemas.unset,
        winningReason: typing.Union[MetaOapg.properties.winningReason, str, schemas.Unset] = schemas.unset,
        canReshuffleTraffic: typing.Union[MetaOapg.properties.canReshuffleTraffic, bool, schemas.Unset] = schemas.unset,
        flags: typing.Union['IterationRepFlags', schemas.Unset] = schemas.unset,
        primaryMetric: typing.Union['DependentMetricOrMetricGroupRep', schemas.Unset] = schemas.unset,
        primarySingleMetric: typing.Union['MetricV2Rep', schemas.Unset] = schemas.unset,
        primaryFunnel: typing.Union['DependentMetricGroupRepWithMetrics', schemas.Unset] = schemas.unset,
        randomizationUnit: typing.Union[MetaOapg.properties.randomizationUnit, str, schemas.Unset] = schemas.unset,
        treatments: typing.Union[MetaOapg.properties.treatments, list, tuple, schemas.Unset] = schemas.unset,
        secondaryMetrics: typing.Union[MetaOapg.properties.secondaryMetrics, list, tuple, schemas.Unset] = schemas.unset,
