...
class TriggerWorkflowRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            _maintainerId = schemas.StrSchema
        
            @staticmethod
            def _maintainer() -> typing.Type['MemberSummary']:
                return MemberSummary
            enabled = schemas.BoolSchema
            _integrationKey = schemas.StrSchema
        
            @staticmethod
            def instructions() -> typing.Type['Instructions']:
                return Instructions
            _lastTriggeredAt = schemas.Int64Schema
            
            
            class _recentTriggerBodies(
                schemas.ListSchema
            ):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RecentTriggerBody']:
                        return RecentTriggerBody
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RecentTriggerBody'], typing.List['RecentTriggerBody']],
                ...
                def __getitem__(self, i: int) -> 'RecentTriggerBody':
                    return super().__getitem__(i)
            _triggerCount = schemas.IntSchema
            triggerURL = schemas.StrSchema
        
            @staticmethod
            def _links() -> typing.Type['TriggerWorkflowRepLinks']:
                return TriggerWorkflowRepLinks
            __annotations__ = {
                "_id": _id,
                "_version": _version,
                ...
                "_recentTriggerBodies": _recentTriggerBodies,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_maintainerId"]) -> MetaOapg.properties._maintainerId: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_integrationKey"]) -> MetaOapg.properties._integrationKey: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["instructions"]) -> 'Instructions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_lastTriggeredAt"]) -> MetaOapg.properties._lastTriggeredAt: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_recentTriggerBodies"]) -> MetaOapg.properties._recentTriggerBodies: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_triggerCount"]) -> MetaOapg.properties._triggerCount: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["triggerURL"]) -> MetaOapg.properties.triggerURL: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'TriggerWorkflowRepLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id", "_version", "_creationDate", "_maintainerId", "_maintainer", "enabled", "_integrationKey", "instructions", "_lastTriggeredAt", "_recentTriggerBodies", "_triggerCount", "triggerURL", "_links", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_creationDate"]) -> typing.Union[MetaOapg.properties._creationDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_maintainerId"]) -> typing.Union[MetaOapg.properties._maintainerId, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_integrationKey"]) -> typing.Union[MetaOapg.properties._integrationKey, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["instructions"]) -> typing.Union['Instructions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_lastTriggeredAt"]) -> typing.Union[MetaOapg.properties._lastTriggeredAt, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_recentTriggerBodies"]) -> typing.Union[MetaOapg.properties._recentTriggerBodies, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_triggerCount"]) -> typing.Union[MetaOapg.properties._triggerCount, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["triggerURL"]) -> typing.Union[MetaOapg.properties.triggerURL, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> typing.Union['TriggerWorkflowRepLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id", "_version", "_creationDate", "_maintainerId", "_maintainer", "enabled", "_integrationKey", "instructions", "_lastTriggeredAt", "_recentTriggerBodies", "_triggerCount", "triggerURL", "_links", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _creationDate: typing.Union[MetaOapg.properties._creationDate, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _maintainerId: typing.Union[MetaOapg.properties._maintainerId, str, schemas.Unset] = schemas.unset,
        _maintainer: typing.Union['MemberSummary', schemas.Unset] = schemas.unset,
        enabled: typing.Union[MetaOapg.properties.enabled, bool, schemas.Unset] = schemas.unset,
        _integrationKey: typing.Union[MetaOapg.properties._integrationKey, str, schemas.Unset] = schemas.unset,
        instructions: typing.Union['Instructions', schemas.Unset] = schemas.unset,
        _lastTriggeredAt: typing.Union[MetaOapg.properties._lastTriggeredAt, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _recentTriggerBodies: typing.Union[MetaOapg.properties._recentTriggerBodies, list, tuple, schemas.Unset] = schemas.unset,
        _triggerCount: typing.Union[MetaOapg.properties._triggerCount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        triggerURL: typing.Union[MetaOapg.properties.triggerURL, str, schemas.Unset] = schemas.unset,
        _links: typing.Union['TriggerWorkflowRepLinks', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
