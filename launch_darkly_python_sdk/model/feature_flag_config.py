...
class FeatureFlagConfig(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            sel = schemas.StrSchema
            lastModified = schemas.Int64Schema
        
            @staticmethod
            def _site() -> typing.Type['Link']:
                return Link
            _environmentName = schemas.StrSchema
            trackEvents = schemas.BoolSchema
            trackEventsFallthrough = schemas.BoolSchema
            _true = schemas.BoolSchema
            ...
            @staticmethod
            def fallthrough() -> typing.Type['VariationOrRolloutRep']:
                return VariationOrRolloutRep
            offVariation = schemas.IntSchema
            ...
            class prerequisites(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Prerequisite']:
                        return Prerequisite
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Prerequisite'], typing.List['Prerequisite']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'prerequisites':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Prerequisite':
                    return super().__getitem__(i)
        
            @staticmethod
            def _access() -> typing.Type['Access']:
                return Access
            _debugEventsUntilDate = schemas.Int64Schema
        
            @staticmethod
            def _summary() -> typing.Type['FlagSummary']:
                return FlagSummary
        
            @staticmethod
            def evaluation() -> typing.Type['FlagConfigEvaluation']:
                return FlagConfigEvaluation
        
            @staticmethod
            def migrationSettings() -> typing.Type['FlagConfigMigrationSettingsRep']:
                return FlagConfigMigrationSettingsRep
            __annotations__ = {
                "version": version,
                "archived": archived,
                "salt": salt,
                ...
                "_access": _access,
                "_debugEventsUntilDate": _debugEventsUntilDate,
                "_summary": _summary,
    ...
    trackEventsFallthrough: MetaOapg.properties.trackEventsFallthrough
    salt: MetaOapg.properties.salt
    _environmentName: MetaOapg.properties._environmentName
    _site: 'Link'
    lastModified: MetaOapg.properties.lastModified
    sel: MetaOapg.properties.sel
    trackEvents: MetaOapg.properties.trackEvents
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sel"]) -> MetaOapg.properties.sel: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_environmentName"]) -> MetaOapg.properties._environmentName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["trackEvents"]) -> MetaOapg.properties.trackEvents: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["trackEventsFallthrough"]) -> MetaOapg.properties.trackEventsFallthrough: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["contextTargets"]) -> MetaOapg.properties.contextTargets: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rules"]) -> MetaOapg.properties.rules: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fallthrough"]) -> 'VariationOrRolloutRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["offVariation"]) -> MetaOapg.properties.offVariation: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prerequisites"]) -> MetaOapg.properties.prerequisites: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_access"]) -> 'Access': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_debugEventsUntilDate"]) -> MetaOapg.properties._debugEventsUntilDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_summary"]) -> 'FlagSummary': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["evaluation"]) -> 'FlagConfigEvaluation': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["migrationSettings"]) -> 'FlagConfigMigrationSettingsRep': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "archived", "salt", "sel", "lastModified", "_site", "_environmentName", "trackEvents", "trackEventsFallthrough", "true", "targets", "contextTargets", "rules", "fallthrough", "offVariation", "prerequisites", "_access", "_debugEventsUntilDate", "_summary", "evaluation", "migrationSettings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sel"]) -> MetaOapg.properties.sel: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lastModified"]) -> MetaOapg.properties.lastModified: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_site"]) -> 'Link': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_environmentName"]) -> MetaOapg.properties._environmentName: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["trackEvents"]) -> MetaOapg.properties.trackEvents: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["trackEventsFallthrough"]) -> MetaOapg.properties.trackEventsFallthrough: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contextTargets"]) -> typing.Union[MetaOapg.properties.contextTargets, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rules"]) -> typing.Union[MetaOapg.properties.rules, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fallthrough"]) -> typing.Union['VariationOrRolloutRep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["offVariation"]) -> typing.Union[MetaOapg.properties.offVariation, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prerequisites"]) -> typing.Union[MetaOapg.properties.prerequisites, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_access"]) -> typing.Union['Access', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_debugEventsUntilDate"]) -> typing.Union[MetaOapg.properties._debugEventsUntilDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_summary"]) -> typing.Union['FlagSummary', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["evaluation"]) -> typing.Union['FlagConfigEvaluation', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["migrationSettings"]) -> typing.Union['FlagConfigMigrationSettingsRep', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        trackEventsFallthrough: typing.Union[MetaOapg.properties.trackEventsFallthrough, bool, ],
        salt: typing.Union[MetaOapg.properties.salt, str, ],
        _environmentName: typing.Union[MetaOapg.properties._environmentName, str, ],
        _site: 'Link',
        lastModified: typing.Union[MetaOapg.properties.lastModified, decimal.Decimal, int, ],
        sel: typing.Union[MetaOapg.properties.sel, str, ],
        trackEvents: typing.Union[MetaOapg.properties.trackEvents, bool, ],
        ...
        contextTargets: typing.Union[MetaOapg.properties.contextTargets, list, tuple, schemas.Unset] = schemas.unset,
        rules: typing.Union[MetaOapg.properties.rules, list, tuple, schemas.Unset] = schemas.unset,
        fallthrough: typing.Union['VariationOrRolloutRep', schemas.Unset] = schemas.unset,
        offVariation: typing.Union[MetaOapg.properties.offVariation, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        prerequisites: typing.Union[MetaOapg.properties.prerequisites, list, tuple, schemas.Unset] = schemas.unset,
        _access: typing.Union['Access', schemas.Unset] = schemas.unset,
        _debugEventsUntilDate: typing.Union[MetaOapg.properties._debugEventsUntilDate, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _summary: typing.Union['FlagSummary', schemas.Unset] = schemas.unset,
        evaluation: typing.Union['FlagConfigEvaluation', schemas.Unset] = schemas.unset,
        migrationSettings: typing.Union['FlagConfigMigrationSettingsRep', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
