...
class AuditLogEntryListingRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _links() -> typing.Type['AuditLogEntryListingRepLinks']:
                return AuditLogEntryListingRepLinks
    ...
    _links: 'AuditLogEntryListingRepLinks'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'AuditLogEntryListingRepLinks': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "_links", "_id", "_accountId", "date", "accesses", "kind", "name", "shortDescription", "title", "comment", "subject", "member", "token", "app", "titleVerb", "target", "parent", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> 'AuditLogEntryListingRepLinks': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "_links", "_id", "_accountId", "date", "accesses", "kind", "name", "shortDescription", "title", "comment", "subject", "member", "token", "app", "titleVerb", "target", "parent", ], str]):
