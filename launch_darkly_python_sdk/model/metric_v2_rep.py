...
class MetricV2Rep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _links() -> typing.Type['MetricV2RepLinks']:
                return MetricV2RepLinks
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'MetricV2RepLinks': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "name", "kind", "_links", "_versionId", "isNumeric", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> 'MetricV2RepLinks': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "name", "kind", "_links", "_versionId", "isNumeric", ], str]):
