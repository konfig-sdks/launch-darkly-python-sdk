...
class PullRequestRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            baseCommitKey = schemas.StrSchema
            headCommitKey = schemas.StrSchema
            filesChanged = schemas.IntSchema
            linesAdded = schemas.IntSchema
            linesDeleted = schemas.IntSchema
            url = schemas.StrSchema
            mergeTime = schemas.Int64Schema
            mergeCommitKey = schemas.StrSchema
        
            @staticmethod
            def deployments() -> typing.Type['DeploymentCollectionRep']:
            ...
            @staticmethod
            def leadTime() -> typing.Type['PullRequestLeadTimeRep']:
                return PullRequestLeadTimeRep
            __annotations__ = {
                "title": title,
                "id": id,
                ...
                "baseCommitKey": baseCommitKey,
                "headCommitKey": headCommitKey,
                "filesChanged": filesChanged,
                "linesAdded": linesAdded,
                "linesDeleted": linesDeleted,
                "url": url,
                "mergeTime": mergeTime,
                "mergeCommitKey": mergeCommitKey,
                "deployments": deployments,
                "flagReferences": flagReferences,
                "leadTime": leadTime,
            }
    
    headCommitKey: MetaOapg.properties.headCommitKey
    createTime: MetaOapg.properties.createTime
    linesAdded: MetaOapg.properties.linesAdded
    author: MetaOapg.properties.author
    filesChanged: MetaOapg.properties.filesChanged
    baseCommitKey: MetaOapg.properties.baseCommitKey
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["baseCommitKey"]) -> MetaOapg.properties.baseCommitKey: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["headCommitKey"]) -> MetaOapg.properties.headCommitKey: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["filesChanged"]) -> MetaOapg.properties.filesChanged: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mergeTime"]) -> MetaOapg.properties.mergeTime: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mergeCommitKey"]) -> MetaOapg.properties.mergeCommitKey: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deployments"]) -> 'DeploymentCollectionRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["flagReferences"]) -> 'FlagReferenceCollectionRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["leadTime"]) -> 'PullRequestLeadTimeRep': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "id", "externalId", "status", "author", "createTime", "baseCommitKey", "headCommitKey", "filesChanged", "linesAdded", "linesDeleted", "url", "mergeTime", "mergeCommitKey", "deployments", "flagReferences", "leadTime", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["createTime"]) -> MetaOapg.properties.createTime: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["baseCommitKey"]) -> MetaOapg.properties.baseCommitKey: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["headCommitKey"]) -> MetaOapg.properties.headCommitKey: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["filesChanged"]) -> MetaOapg.properties.filesChanged: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mergeTime"]) -> typing.Union[MetaOapg.properties.mergeTime, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mergeCommitKey"]) -> typing.Union[MetaOapg.properties.mergeCommitKey, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deployments"]) -> typing.Union['DeploymentCollectionRep', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["leadTime"]) -> typing.Union['PullRequestLeadTimeRep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "id", "externalId", "status", "author", "createTime", "baseCommitKey", "headCommitKey", "filesChanged", "linesAdded", "linesDeleted", "url", "mergeTime", "mergeCommitKey", "deployments", "flagReferences", "leadTime", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        headCommitKey: typing.Union[MetaOapg.properties.headCommitKey, str, ],
        createTime: typing.Union[MetaOapg.properties.createTime, decimal.Decimal, int, ],
        ...
        filesChanged: typing.Union[MetaOapg.properties.filesChanged, decimal.Decimal, int, ],
        baseCommitKey: typing.Union[MetaOapg.properties.baseCommitKey, str, ],
        ...
        mergeTime: typing.Union[MetaOapg.properties.mergeTime, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        mergeCommitKey: typing.Union[MetaOapg.properties.mergeCommitKey, str, schemas.Unset] = schemas.unset,
        deployments: typing.Union['DeploymentCollectionRep', schemas.Unset] = schemas.unset,
        flagReferences: typing.Union['FlagReferenceCollectionRep', schemas.Unset] = schemas.unset,
        leadTime: typing.Union['PullRequestLeadTimeRep', schemas.Unset] = schemas.unset,
