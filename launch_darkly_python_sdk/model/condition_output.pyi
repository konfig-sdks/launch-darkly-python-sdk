...
class ConditionOutput(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _execution() -> typing.Type['ExecutionOutput']:
                return ExecutionOutput
        
            @staticmethod
            def notifyMemberIds() -> typing.Type['ConditionOutputNotifyMemberIds']:
                return ConditionOutputNotifyMemberIds
            ...
            class allReviews(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ReviewOutput']:
                        return ReviewOutput
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ReviewOutput'], typing.List['ReviewOutput']],
                ...
                def __getitem__(self, i: int) -> 'ReviewOutput':
                    return super().__getitem__(i)
            reviewStatus = schemas.StrSchema
            kind = schemas.StrSchema
            scheduleKind = schemas.StrSchema
            executionDate = schemas.Int64Schema
            waitDuration = schemas.IntSchema
            waitDurationUnit = schemas.StrSchema
    ...
    notifyMemberIds: 'ConditionOutputNotifyMemberIds'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_execution"]) -> 'ExecutionOutput': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["notifyMemberIds"]) -> 'ConditionOutputNotifyMemberIds': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scheduleKind"]) -> MetaOapg.properties.scheduleKind: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["executionDate"]) -> MetaOapg.properties.executionDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["waitDuration"]) -> MetaOapg.properties.waitDuration: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["waitDurationUnit"]) -> MetaOapg.properties.waitDurationUnit: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "_id", "_execution", "notifyMemberIds", "allReviews", "reviewStatus", "kind", "scheduleKind", "executionDate", "waitDuration", "waitDurationUnit", "appliedDate", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_execution"]) -> 'ExecutionOutput': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["notifyMemberIds"]) -> 'ConditionOutputNotifyMemberIds': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scheduleKind"]) -> typing.Union[MetaOapg.properties.scheduleKind, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["waitDuration"]) -> typing.Union[MetaOapg.properties.waitDuration, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["waitDurationUnit"]) -> typing.Union[MetaOapg.properties.waitDurationUnit, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "_id", "_execution", "notifyMemberIds", "allReviews", "reviewStatus", "kind", "scheduleKind", "executionDate", "waitDuration", "waitDurationUnit", "appliedDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        scheduleKind: typing.Union[MetaOapg.properties.scheduleKind, str, schemas.Unset] = schemas.unset,
        executionDate: typing.Union[MetaOapg.properties.executionDate, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        waitDuration: typing.Union[MetaOapg.properties.waitDuration, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        waitDurationUnit: typing.Union[MetaOapg.properties.waitDurationUnit, str, schemas.Unset] = schemas.unset,
