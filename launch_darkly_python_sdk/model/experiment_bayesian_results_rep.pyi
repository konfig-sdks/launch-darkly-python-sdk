...
class ExperimentBayesianResultsRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _links() -> typing.Type['ExperimentBayesianResultsRepLinks']:
                return ExperimentBayesianResultsRepLinks
            ...
            class treatmentResults(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TreatmentResultRep']:
                        return TreatmentResultRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TreatmentResultRep'], typing.List['TreatmentResultRep']],
                ...
                def __getitem__(self, i: int) -> 'TreatmentResultRep':
                    return super().__getitem__(i)
        
            @staticmethod
            def metricSeen() -> typing.Type['MetricSeen']:
                return MetricSeen
            probabilityOfMismatch = schemas.NumberSchema
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SlicedResultsRep']:
                        return SlicedResultsRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SlicedResultsRep'], typing.List['SlicedResultsRep']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'SlicedResultsRep':
                    return super().__getitem__(i)
            __annotations__ = {
                "_links": _links,
                "treatmentResults": treatmentResults,
                "metricSeen": metricSeen,
                "probabilityOfMismatch": probabilityOfMismatch,
                "results": results,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'ExperimentBayesianResultsRepLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["treatmentResults"]) -> MetaOapg.properties.treatmentResults: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metricSeen"]) -> 'MetricSeen': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["probabilityOfMismatch"]) -> MetaOapg.properties.probabilityOfMismatch: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_links", "treatmentResults", "metricSeen", "probabilityOfMismatch", "results", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> typing.Union['ExperimentBayesianResultsRepLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["treatmentResults"]) -> typing.Union[MetaOapg.properties.treatmentResults, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metricSeen"]) -> typing.Union['MetricSeen', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["probabilityOfMismatch"]) -> typing.Union[MetaOapg.properties.probabilityOfMismatch, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_links", "treatmentResults", "metricSeen", "probabilityOfMismatch", "results", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        _links: typing.Union['ExperimentBayesianResultsRepLinks', schemas.Unset] = schemas.unset,
        treatmentResults: typing.Union[MetaOapg.properties.treatmentResults, list, tuple, schemas.Unset] = schemas.unset,
        metricSeen: typing.Union['MetricSeen', schemas.Unset] = schemas.unset,
        probabilityOfMismatch: typing.Union[MetaOapg.properties.probabilityOfMismatch, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
