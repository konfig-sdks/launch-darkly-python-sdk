...
class DeploymentRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            applicationVersion = schemas.StrSchema
            startedAt = schemas.Int64Schema
            status = schemas.StrSchema
            kind = schemas.StrSchema
            active = schemas.BoolSchema
            archived = schemas.BoolSchema
            environmentKey = schemas.StrSchema
            numberOfContributors = schemas.IntSchema
            numberOfPullRequests = schemas.IntSchema
            linesAdded = schemas.Int64Schema
            linesDeleted = schemas.Int64Schema
            leadTime = schemas.Int64Schema
            endedAt = schemas.Int64Schema
            durationMs = schemas.Int64Schema
        
            @staticmethod
            def metadata() -> typing.Type['DeploymentRepMetadata']:
                return DeploymentRepMetadata
        
            @staticmethod
            def pullRequests() -> typing.Type['PullRequestCollectionRep']:
                return PullRequestCollectionRep
        
            @staticmethod
            def flagReferences() -> typing.Type['FlagReferenceCollectionRep']:
                return FlagReferenceCollectionRep
        
            @staticmethod
            def leadTimeStages() -> typing.Type['LeadTimeStagesRep']:
                return LeadTimeStagesRep
            __annotations__ = {
                "id": id,
                ...
                "leadTimeStages": leadTimeStages,
            }
    
    applicationVersion: MetaOapg.properties.applicationVersion
    linesAdded: MetaOapg.properties.linesAdded
    kind: MetaOapg.properties.kind
    applicationKey: MetaOapg.properties.applicationKey
    active: MetaOapg.properties.active
    startedAt: MetaOapg.properties.startedAt
    leadTime: MetaOapg.properties.leadTime
    numberOfPullRequests: MetaOapg.properties.numberOfPullRequests
    linesDeleted: MetaOapg.properties.linesDeleted
    environmentKey: MetaOapg.properties.environmentKey
    archived: MetaOapg.properties.archived
    id: MetaOapg.properties.id
    numberOfContributors: MetaOapg.properties.numberOfContributors
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["applicationVersion"]) -> MetaOapg.properties.applicationVersion: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["environmentKey"]) -> MetaOapg.properties.environmentKey: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["numberOfContributors"]) -> MetaOapg.properties.numberOfContributors: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["numberOfPullRequests"]) -> MetaOapg.properties.numberOfPullRequests: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linesAdded"]) -> MetaOapg.properties.linesAdded: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linesDeleted"]) -> MetaOapg.properties.linesDeleted: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["leadTime"]) -> MetaOapg.properties.leadTime: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["endedAt"]) -> MetaOapg.properties.endedAt: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["durationMs"]) -> MetaOapg.properties.durationMs: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'DeploymentRepMetadata': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pullRequests"]) -> 'PullRequestCollectionRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["flagReferences"]) -> 'FlagReferenceCollectionRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["leadTimeStages"]) -> 'LeadTimeStagesRep': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "applicationKey", "applicationVersion", "startedAt", "status", "kind", "active", "archived", "environmentKey", "numberOfContributors", "numberOfPullRequests", "linesAdded", "linesDeleted", "leadTime", "endedAt", "durationMs", "metadata", "pullRequests", "flagReferences", "leadTimeStages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["applicationKey"]) -> MetaOapg.properties.applicationKey: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["applicationVersion"]) -> MetaOapg.properties.applicationVersion: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["environmentKey"]) -> MetaOapg.properties.environmentKey: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["numberOfContributors"]) -> MetaOapg.properties.numberOfContributors: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["numberOfPullRequests"]) -> MetaOapg.properties.numberOfPullRequests: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linesAdded"]) -> MetaOapg.properties.linesAdded: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linesDeleted"]) -> MetaOapg.properties.linesDeleted: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["leadTime"]) -> MetaOapg.properties.leadTime: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["endedAt"]) -> typing.Union[MetaOapg.properties.endedAt, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["durationMs"]) -> typing.Union[MetaOapg.properties.durationMs, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['DeploymentRepMetadata', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pullRequests"]) -> typing.Union['PullRequestCollectionRep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["flagReferences"]) -> typing.Union['FlagReferenceCollectionRep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["leadTimeStages"]) -> typing.Union['LeadTimeStagesRep', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        applicationVersion: typing.Union[MetaOapg.properties.applicationVersion, str, ],
        linesAdded: typing.Union[MetaOapg.properties.linesAdded, decimal.Decimal, int, ],
        kind: typing.Union[MetaOapg.properties.kind, str, ],
        applicationKey: typing.Union[MetaOapg.properties.applicationKey, str, ],
        active: typing.Union[MetaOapg.properties.active, bool, ],
        startedAt: typing.Union[MetaOapg.properties.startedAt, decimal.Decimal, int, ],
        leadTime: typing.Union[MetaOapg.properties.leadTime, decimal.Decimal, int, ],
        numberOfPullRequests: typing.Union[MetaOapg.properties.numberOfPullRequests, decimal.Decimal, int, ],
        linesDeleted: typing.Union[MetaOapg.properties.linesDeleted, decimal.Decimal, int, ],
        environmentKey: typing.Union[MetaOapg.properties.environmentKey, str, ],
        archived: typing.Union[MetaOapg.properties.archived, bool, ],
        id: typing.Union[MetaOapg.properties.id, str, uuid.UUID, ],
        numberOfContributors: typing.Union[MetaOapg.properties.numberOfContributors, decimal.Decimal, int, ],
        status: typing.Union[MetaOapg.properties.status, str, ],
        endedAt: typing.Union[MetaOapg.properties.endedAt, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        durationMs: typing.Union[MetaOapg.properties.durationMs, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        metadata: typing.Union['DeploymentRepMetadata', schemas.Unset] = schemas.unset,
        pullRequests: typing.Union['PullRequestCollectionRep', schemas.Unset] = schemas.unset,
        flagReferences: typing.Union['FlagReferenceCollectionRep', schemas.Unset] = schemas.unset,
        leadTimeStages: typing.Union['LeadTimeStagesRep', schemas.Unset] = schemas.unset,
