...
class TreatmentResultRep(
    ...
    class MetaOapg:
        ...
        class properties:
            treatmentId = schemas.StrSchema
            treatmentName = schemas.StrSchema
            mean = schemas.NumberSchema
        
            @staticmethod
            def credibleInterval() -> typing.Type['CredibleIntervalRep']:
                return CredibleIntervalRep
            pBest = schemas.NumberSchema
            
            
            class relativeDifferences(
                schemas.ListSchema
            ):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['RelativeDifferenceRep']:
                        return RelativeDifferenceRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['RelativeDifferenceRep'], typing.List['RelativeDifferenceRep']],
                ...
                def __getitem__(self, i: int) -> 'RelativeDifferenceRep':
                    return super().__getitem__(i)
            units = schemas.Int64Schema
            traffic = schemas.Int64Schema
            ...
            __annotations__ = {
                ...
                "pBest": pBest,
                "relativeDifferences": relativeDifferences,
                "units": units,
                "traffic": traffic,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["treatmentId"]) -> MetaOapg.properties.treatmentId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["treatmentName"]) -> MetaOapg.properties.treatmentName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mean"]) -> MetaOapg.properties.mean: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["credibleInterval"]) -> 'CredibleIntervalRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pBest"]) -> MetaOapg.properties.pBest: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["relativeDifferences"]) -> MetaOapg.properties.relativeDifferences: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["units"]) -> MetaOapg.properties.units: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["traffic"]) -> MetaOapg.properties.traffic: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["treatmentId", "treatmentName", "mean", "credibleInterval", "pBest", "relativeDifferences", "units", "traffic", "distribution", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["treatmentId"]) -> typing.Union[MetaOapg.properties.treatmentId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["treatmentName"]) -> typing.Union[MetaOapg.properties.treatmentName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mean"]) -> typing.Union[MetaOapg.properties.mean, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["credibleInterval"]) -> typing.Union['CredibleIntervalRep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pBest"]) -> typing.Union[MetaOapg.properties.pBest, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["relativeDifferences"]) -> typing.Union[MetaOapg.properties.relativeDifferences, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["units"]) -> typing.Union[MetaOapg.properties.units, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["traffic"]) -> typing.Union[MetaOapg.properties.traffic, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["treatmentId", "treatmentName", "mean", "credibleInterval", "pBest", "relativeDifferences", "units", "traffic", "distribution", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        treatmentId: typing.Union[MetaOapg.properties.treatmentId, str, schemas.Unset] = schemas.unset,
        treatmentName: typing.Union[MetaOapg.properties.treatmentName, str, schemas.Unset] = schemas.unset,
        mean: typing.Union[MetaOapg.properties.mean, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        credibleInterval: typing.Union['CredibleIntervalRep', schemas.Unset] = schemas.unset,
        pBest: typing.Union[MetaOapg.properties.pBest, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        relativeDifferences: typing.Union[MetaOapg.properties.relativeDifferences, list, tuple, schemas.Unset] = schemas.unset,
        units: typing.Union[MetaOapg.properties.units, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        traffic: typing.Union[MetaOapg.properties.traffic, decimal.Decimal, int, schemas.Unset] = schemas.unset,
