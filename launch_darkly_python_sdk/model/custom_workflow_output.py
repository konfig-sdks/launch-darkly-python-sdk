...
class CustomWorkflowOutput(
        ...
        class properties:
            ...
            class _conflicts(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ConflictOutput']:
                        return ConflictOutput
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ConflictOutput'], typing.List['ConflictOutput']],
                ...
                def __getitem__(self, i: int) -> 'ConflictOutput':
                    return super().__getitem__(i)
            _creationDate = schemas.Int64Schema
            _maintainerId = schemas.StrSchema
        
            @staticmethod
            def _links() -> typing.Type['CustomWorkflowOutputLinks']:
                return CustomWorkflowOutputLinks
            ...
            class stages(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['StageOutput']:
                        return StageOutput
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['StageOutput'], typing.List['StageOutput']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'stages':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'StageOutput':
                    return super().__getitem__(i)
        
            @staticmethod
            def meta() -> typing.Type['WorkflowTemplateMetadata']:
    ...
    _maintainerId: MetaOapg.properties._maintainerId
    _links: 'CustomWorkflowOutputLinks'
    name: MetaOapg.properties.name
    _conflicts: MetaOapg.properties._conflicts
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_conflicts"]) -> MetaOapg.properties._conflicts: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'CustomWorkflowOutputLinks': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["meta"]) -> 'WorkflowTemplateMetadata': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id", "_version", "_conflicts", "_creationDate", "_maintainerId", "_links", "name", "_execution", "description", "kind", "stages", "meta", "templateKey", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_conflicts"]) -> MetaOapg.properties._conflicts: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_creationDate"]) -> MetaOapg.properties._creationDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_maintainerId"]) -> MetaOapg.properties._maintainerId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> 'CustomWorkflowOutputLinks': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["meta"]) -> typing.Union['WorkflowTemplateMetadata', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id", "_version", "_conflicts", "_creationDate", "_maintainerId", "_links", "name", "_execution", "description", "kind", "stages", "meta", "templateKey", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        _execution: 'ExecutionOutput',
        _maintainerId: typing.Union[MetaOapg.properties._maintainerId, str, ],
        _links: 'CustomWorkflowOutputLinks',
        name: typing.Union[MetaOapg.properties.name, str, ],
        _conflicts: typing.Union[MetaOapg.properties._conflicts, list, tuple, ],
        ...
        stages: typing.Union[MetaOapg.properties.stages, list, tuple, schemas.Unset] = schemas.unset,
        meta: typing.Union['WorkflowTemplateMetadata', schemas.Unset] = schemas.unset,
