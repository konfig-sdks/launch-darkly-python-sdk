...
class MetricGroupRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tags() -> typing.Type['MetricGroupRepTags']:
                return MetricGroupRepTags
            ...
            @staticmethod
            def _links() -> typing.Type['MetricGroupRepLinks']:
                return MetricGroupRepLinks
            _creationDate = schemas.Int64Schema
            _lastModified = schemas.Int64Schema
        
            @staticmethod
            def maintainer() -> typing.Type['MaintainerRep']:
                return MaintainerRep
            ...
            class metrics(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MetricInGroupRep']:
                        return MetricInGroupRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MetricInGroupRep'], typing.List['MetricInGroupRep']],
                ...
                def __getitem__(self, i: int) -> 'MetricInGroupRep':
    ...
    _lastModified: MetaOapg.properties._lastModified
    _version: MetaOapg.properties._version
    key: MetaOapg.properties.key
    maintainer: 'MaintainerRep'
    tags: 'MetricGroupRepTags'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tags"]) -> 'MetricGroupRepTags': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'MetricGroupRepLinks': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["maintainer"]) -> 'MaintainerRep': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "_id", "key", "name", "kind", "_links", "_creationDate", "_lastModified", "maintainer", "metrics", "_version", "description", "_access", "experiments", "experimentCount", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tags"]) -> 'MetricGroupRepTags': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> 'MetricGroupRepLinks': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_creationDate"]) -> MetaOapg.properties._creationDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_lastModified"]) -> MetaOapg.properties._lastModified: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["maintainer"]) -> 'MaintainerRep': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tags", "_id", "key", "name", "kind", "_links", "_creationDate", "_lastModified", "maintainer", "metrics", "_version", "description", "_access", "experiments", "experimentCount", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _lastModified: typing.Union[MetaOapg.properties._lastModified, decimal.Decimal, int, ],
