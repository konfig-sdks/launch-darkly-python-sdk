...
class ExpandedFlagRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tags() -> typing.Type['ExpandedFlagRepTags']:
                return ExpandedFlagRepTags
            ...
            @staticmethod
            def _links() -> typing.Type['ExpandedFlagRepLinks']:
                return ExpandedFlagRepLinks
    ...
    tags: 'ExpandedFlagRepTags'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tags"]) -> 'ExpandedFlagRepTags': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'ExpandedFlagRepLinks': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "name", "kind", "key", "_version", "creationDate", "variations", "temporary", "_links", "customProperties", "archived", "description", "includeInSnippet", "clientSideAvailability", "maintainerId", "_maintainer", "archivedDate", "defaults", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tags"]) -> 'ExpandedFlagRepTags': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> 'ExpandedFlagRepLinks': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tags", "name", "kind", "key", "_version", "creationDate", "variations", "temporary", "_links", "customProperties", "archived", "description", "includeInSnippet", "clientSideAvailability", "maintainerId", "_maintainer", "archivedDate", "defaults", ], str]):
