...
class Team(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _links() -> typing.Type['TeamLinks']:
                return TeamLinks
            _lastModified = schemas.Int64Schema
            _version = schemas.IntSchema
            _idpSynced = schemas.BoolSchema
        
            @staticmethod
            def roles() -> typing.Type['TeamCustomRoles']:
                return TeamCustomRoles
        
            @staticmethod
            def members() -> typing.Type['TeamMembers']:
                return TeamMembers
        
            @staticmethod
            def projects() -> typing.Type['TeamProjects']:
                return TeamProjects
        
            @staticmethod
            def maintainers() -> typing.Type['TeamMaintainers']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'TeamLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_lastModified"]) -> MetaOapg.properties._lastModified: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_version"]) -> MetaOapg.properties._version: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_idpSynced"]) -> MetaOapg.properties._idpSynced: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'TeamCustomRoles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["members"]) -> 'TeamMembers': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["projects"]) -> 'TeamProjects': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["maintainers"]) -> 'TeamMaintainers': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "key", "name", "_access", "_creationDate", "_links", "_lastModified", "_version", "_idpSynced", "roles", "members", "projects", "maintainers", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> typing.Union['TeamLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_lastModified"]) -> typing.Union[MetaOapg.properties._lastModified, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_version"]) -> typing.Union[MetaOapg.properties._version, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_idpSynced"]) -> typing.Union[MetaOapg.properties._idpSynced, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> typing.Union['TeamCustomRoles', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["members"]) -> typing.Union['TeamMembers', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["projects"]) -> typing.Union['TeamProjects', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["maintainers"]) -> typing.Union['TeamMaintainers', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "key", "name", "_access", "_creationDate", "_links", "_lastModified", "_version", "_idpSynced", "roles", "members", "projects", "maintainers", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _links: typing.Union['TeamLinks', schemas.Unset] = schemas.unset,
        _lastModified: typing.Union[MetaOapg.properties._lastModified, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _version: typing.Union[MetaOapg.properties._version, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _idpSynced: typing.Union[MetaOapg.properties._idpSynced, bool, schemas.Unset] = schemas.unset,
        roles: typing.Union['TeamCustomRoles', schemas.Unset] = schemas.unset,
        members: typing.Union['TeamMembers', schemas.Unset] = schemas.unset,
        projects: typing.Union['TeamProjects', schemas.Unset] = schemas.unset,
        maintainers: typing.Union['TeamMaintainers', schemas.Unset] = schemas.unset,
