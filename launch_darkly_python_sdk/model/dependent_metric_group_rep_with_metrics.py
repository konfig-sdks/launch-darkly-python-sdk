...
class DependentMetricGroupRepWithMetrics(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _links() -> typing.Type['DependentMetricGroupRepWithMetricsLinks']:
                return DependentMetricGroupRepWithMetricsLinks
    ...
    _links: 'DependentMetricGroupRepWithMetricsLinks'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'DependentMetricGroupRepWithMetricsLinks': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "name", "kind", "_links", "metrics", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> 'DependentMetricGroupRepWithMetricsLinks': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "name", "kind", "_links", "metrics", ], str]):
