...
class RuleClause(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class op(
                ...
                @schemas.classproperty
                def SEGMENT_MATCH(cls):
                    return cls("segmentMatch")
                
                @schemas.classproperty
                def SEM_VER_EQUAL(cls):
                    return cls("semVerEqual")
                
                @schemas.classproperty
                def SEM_VER_LESS_THAN(cls):
                    return cls("semVerLessThan")
                
                @schemas.classproperty
                def SEM_VER_GREATER_THAN(cls):
                    return cls("semVerGreaterThan")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attribute", "op", "negate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attribute", "op", "negate", ], str]):
