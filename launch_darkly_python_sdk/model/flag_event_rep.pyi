...
class FlagEventRep(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            flagKey = schemas.StrSchema
            eventType = schemas.StrSchema
            eventTime = schemas.Int64Schema
        
            @staticmethod
            def impact() -> typing.Type['FlagEventImpactRep']:
                return FlagEventImpactRep
            environmentId = schemas.StrSchema
            environmentKey = schemas.StrSchema
            auditLogEntryId = schemas.StrSchema
        
            @staticmethod
            def member() -> typing.Type['FlagEventMemberRep']:
                return FlagEventMemberRep
        
            @staticmethod
            def actions() -> typing.Type['FlagEventRepActions']:
                return FlagEventRepActions
        
            @staticmethod
            def experiments() -> typing.Type['FlagEventExperimentCollection']:
                return FlagEventExperimentCollection
            __annotations__ = {
    ...
    projectKey: MetaOapg.properties.projectKey
    ...
    flagKey: MetaOapg.properties.flagKey
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["flagKey"]) -> MetaOapg.properties.flagKey: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["impact"]) -> 'FlagEventImpactRep': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["auditLogEntryId"]) -> MetaOapg.properties.auditLogEntryId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["member"]) -> 'FlagEventMemberRep': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["actions"]) -> 'FlagEventRepActions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["experiments"]) -> 'FlagEventExperimentCollection': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "id", "projectId", "projectKey", "flagKey", "eventType", "eventTime", "impact", "environmentId", "environmentKey", "auditLogEntryId", "member", "actions", "experiments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["projectKey"]) -> MetaOapg.properties.projectKey: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["flagKey"]) -> MetaOapg.properties.flagKey: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["impact"]) -> 'FlagEventImpactRep': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["environmentKey"]) -> typing.Union[MetaOapg.properties.environmentKey, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["auditLogEntryId"]) -> typing.Union[MetaOapg.properties.auditLogEntryId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["member"]) -> typing.Union['FlagEventMemberRep', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actions"]) -> typing.Union['FlagEventRepActions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["experiments"]) -> typing.Union['FlagEventExperimentCollection', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "id", "projectId", "projectKey", "flagKey", "eventType", "eventTime", "impact", "environmentId", "environmentKey", "auditLogEntryId", "member", "actions", "experiments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        projectKey: typing.Union[MetaOapg.properties.projectKey, str, ],
        impact: 'FlagEventImpactRep',
        eventTime: typing.Union[MetaOapg.properties.eventTime, decimal.Decimal, int, ],
        ...
        flagKey: typing.Union[MetaOapg.properties.flagKey, str, ],
        environmentId: typing.Union[MetaOapg.properties.environmentId, str, schemas.Unset] = schemas.unset,
        environmentKey: typing.Union[MetaOapg.properties.environmentKey, str, schemas.Unset] = schemas.unset,
        auditLogEntryId: typing.Union[MetaOapg.properties.auditLogEntryId, str, schemas.Unset] = schemas.unset,
        member: typing.Union['FlagEventMemberRep', schemas.Unset] = schemas.unset,
        actions: typing.Union['FlagEventRepActions', schemas.Unset] = schemas.unset,
        experiments: typing.Union['FlagEventExperimentCollection', schemas.Unset] = schemas.unset,
