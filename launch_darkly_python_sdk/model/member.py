...
class Member(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _links() -> typing.Type['MemberLinks']:
                return MemberLinks
            _id = schemas.StrSchema
            role = schemas.StrSchema
            email = schemas.StrSchema
            _pendingInvite = schemas.BoolSchema
            _verified = schemas.BoolSchema
        
            @staticmethod
            def customRoles() -> typing.Type['MemberCustomRoles']:
                return MemberCustomRoles
            mfa = schemas.StrSchema
            _lastSeen = schemas.Int64Schema
            creationDate = schemas.Int64Schema
            firstName = schemas.StrSchema
            lastName = schemas.StrSchema
            _pendingEmail = schemas.StrSchema
        
            @staticmethod
            def excludedDashboards() -> typing.Type['MemberExcludedDashboards']:
                return MemberExcludedDashboards
        
            @staticmethod
            def _lastSeenMetadata() -> typing.Type['LastSeenMetadata']:
                return LastSeenMetadata
        
            @staticmethod
            def _integrationMetadata() -> typing.Type['IntegrationMetadata']:
            ...
            class teams(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MemberTeamSummaryRep']:
                        return MemberTeamSummaryRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MemberTeamSummaryRep'], typing.List['MemberTeamSummaryRep']],
                ...
                def __getitem__(self, i: int) -> 'MemberTeamSummaryRep':
            ...
            class permissionGrants(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MemberPermissionGrantSummaryRep']:
                        return MemberPermissionGrantSummaryRep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MemberPermissionGrantSummaryRep'], typing.List['MemberPermissionGrantSummaryRep']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'permissionGrants':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'MemberPermissionGrantSummaryRep':
                    return super().__getitem__(i)
            ...
            __annotations__ = {
                ...
                "_lastSeenMetadata": _lastSeenMetadata,
                "_integrationMetadata": _integrationMetadata,
                "teams": teams,
                "permissionGrants": permissionGrants,
                "oauthProviders": oauthProviders,
            }
    
    _verified: MetaOapg.properties._verified
    role: MetaOapg.properties.role
    _links: 'MemberLinks'
    _pendingInvite: MetaOapg.properties._pendingInvite
    _lastSeen: MetaOapg.properties._lastSeen
    mfa: MetaOapg.properties.mfa
    _id: MetaOapg.properties._id
    creationDate: MetaOapg.properties.creationDate
    email: MetaOapg.properties.email
    customRoles: 'MemberCustomRoles'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'MemberLinks': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_pendingInvite"]) -> MetaOapg.properties._pendingInvite: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_verified"]) -> MetaOapg.properties._verified: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["customRoles"]) -> 'MemberCustomRoles': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mfa"]) -> MetaOapg.properties.mfa: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_lastSeen"]) -> MetaOapg.properties._lastSeen: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_pendingEmail"]) -> MetaOapg.properties._pendingEmail: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["excludedDashboards"]) -> 'MemberExcludedDashboards': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_lastSeenMetadata"]) -> 'LastSeenMetadata': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_integrationMetadata"]) -> 'IntegrationMetadata': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_links", "_id", "role", "email", "_pendingInvite", "_verified", "customRoles", "mfa", "_lastSeen", "creationDate", "firstName", "lastName", "_pendingEmail", "excludedDashboards", "_lastSeenMetadata", "_integrationMetadata", "teams", "permissionGrants", "oauthProviders", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> 'MemberLinks': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_pendingInvite"]) -> MetaOapg.properties._pendingInvite: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_verified"]) -> MetaOapg.properties._verified: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["customRoles"]) -> 'MemberCustomRoles': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mfa"]) -> MetaOapg.properties.mfa: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_lastSeen"]) -> MetaOapg.properties._lastSeen: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_pendingEmail"]) -> typing.Union[MetaOapg.properties._pendingEmail, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["excludedDashboards"]) -> typing.Union['MemberExcludedDashboards', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_lastSeenMetadata"]) -> typing.Union['LastSeenMetadata', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_integrationMetadata"]) -> typing.Union['IntegrationMetadata', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["oauthProviders"]) -> typing.Union[MetaOapg.properties.oauthProviders, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_links", "_id", "role", "email", "_pendingInvite", "_verified", "customRoles", "mfa", "_lastSeen", "creationDate", "firstName", "lastName", "_pendingEmail", "excludedDashboards", "_lastSeenMetadata", "_integrationMetadata", "teams", "permissionGrants", "oauthProviders", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        _verified: typing.Union[MetaOapg.properties._verified, bool, ],
        role: typing.Union[MetaOapg.properties.role, str, ],
        _links: 'MemberLinks',
        _pendingInvite: typing.Union[MetaOapg.properties._pendingInvite, bool, ],
        _lastSeen: typing.Union[MetaOapg.properties._lastSeen, decimal.Decimal, int, ],
        mfa: typing.Union[MetaOapg.properties.mfa, str, ],
        ...
        _pendingEmail: typing.Union[MetaOapg.properties._pendingEmail, str, schemas.Unset] = schemas.unset,
        excludedDashboards: typing.Union['MemberExcludedDashboards', schemas.Unset] = schemas.unset,
        _lastSeenMetadata: typing.Union['LastSeenMetadata', schemas.Unset] = schemas.unset,
        _integrationMetadata: typing.Union['IntegrationMetadata', schemas.Unset] = schemas.unset,
        ...
        oauthProviders: typing.Union[MetaOapg.properties.oauthProviders, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
