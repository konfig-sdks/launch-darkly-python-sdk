...
from launch_darkly_python_sdk.model.deployment_collection_rep import DeploymentCollectionRep as DeploymentCollectionRepSchema
...
from launch_darkly_python_sdk.type.deployment_collection_rep import DeploymentCollectionRep
...
from launch_darkly_python_sdk.pydantic.deployment_collection_rep import DeploymentCollectionRep as DeploymentCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = DeploymentCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DeploymentCollectionRep
    ...
    async def _alist_deployments_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/deployments',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListDeployments(BaseApi):
    ...
    async def alist_deployments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeploymentCollectionRepPydantic:
        ...
        if validate:
            return DeploymentCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(DeploymentCollectionRepPydantic, raw_response.body)
