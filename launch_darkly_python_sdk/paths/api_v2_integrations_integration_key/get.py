...
from launch_darkly_python_sdk.model.integrations import Integrations as IntegrationsSchema

from launch_darkly_python_sdk.type.integrations import Integrations
...
from launch_darkly_python_sdk.pydantic.integrations import Integrations as IntegrationsPydantic
...
SchemaFor200ResponseBodyApplicationJson = IntegrationsSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_by_integration_mapped_args(
        self,
        integration_key: str,
    ...
    async def _alist_by_integration_oapg(
        self,
...
class ListByIntegrationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_integration(
        self,
        integration_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_by_integration_mapped_args(
            integration_key=integration_key,
        )
        return await self._alist_by_integration_oapg(
    ...
    def list_by_integration(
        ...
        return self._list_by_integration_oapg(
            path_params=args.path,
        )

class ListByIntegration(BaseApi):
    ...
    async def alist_by_integration(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IntegrationsPydantic:
        raw_response = await self.raw.alist_by_integration(
            integration_key=integration_key,
            **kwargs,
        )
        if validate:
            return IntegrationsPydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationsPydantic, raw_response.body)
    ...
    def list_by_integration(
        ...
        raw_response = self.raw.list_by_integration(
            integration_key=integration_key,
        )
        if validate:
            return IntegrationsPydantic(**raw_response.body)
