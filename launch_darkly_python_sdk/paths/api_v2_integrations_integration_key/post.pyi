...
from launch_darkly_python_sdk.model.integration import Integration as IntegrationSchema
from launch_darkly_python_sdk.model.subscription_post_tags import SubscriptionPostTags as SubscriptionPostTagsSchema
...
from launch_darkly_python_sdk.model.subscription_post import SubscriptionPost as SubscriptionPostSchema
from launch_darkly_python_sdk.model.unauthorized_error_rep import UnauthorizedErrorRep as UnauthorizedErrorRepSchema
from launch_darkly_python_sdk.model.subscription_post_config import SubscriptionPostConfig as SubscriptionPostConfigSchema
...
from launch_darkly_python_sdk.model.statement_post_list import StatementPostList as StatementPostListSchema

from launch_darkly_python_sdk.type.statement_post_list import StatementPostList
from launch_darkly_python_sdk.type.subscription_post_tags import SubscriptionPostTags
from launch_darkly_python_sdk.type.integration import Integration
from launch_darkly_python_sdk.type.subscription_post_config import SubscriptionPostConfig
...
from launch_darkly_python_sdk.type.subscription_post import SubscriptionPost

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.subscription_post_tags import SubscriptionPostTags as SubscriptionPostTagsPydantic
from launch_darkly_python_sdk.pydantic.subscription_post_config import SubscriptionPostConfig as SubscriptionPostConfigPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.subscription_post import SubscriptionPost as SubscriptionPostPydantic
from launch_darkly_python_sdk.pydantic.integration import Integration as IntegrationPydantic
...
from launch_darkly_python_sdk.pydantic.statement_post_list import StatementPostList as StatementPostListPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SubscriptionPostSchema


request_body_subscription_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = IntegrationSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_subscription_mapped_args(
        self,
        name: str,
        config: SubscriptionPostConfig,
        integration_key: str,
        tags: typing.Optional[SubscriptionPostTags] = None,
        statements: typing.Optional[StatementPostList] = None,
    ...
    async def _acreate_subscription_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integrations/{integrationKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_subscription_post.serialize(body, content_type)
...
class CreateSubscription(BaseApi):
    ...
    async def acreate_subscription(
        ...
        **kwargs,
        ...
        if validate:
            return IntegrationPydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationPydantic, raw_response.body)
