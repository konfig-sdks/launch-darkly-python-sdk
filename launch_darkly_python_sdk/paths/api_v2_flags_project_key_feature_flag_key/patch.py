...
SchemaFor200ResponseBodyApplicationJson = FeatureFlagSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_feature_flag_mapped_args(
        self,
        patch: JSONPatch,
        project_key: str,
    ...
    async def _aupdate_feature_flag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{featureFlagKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateFeatureFlagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_feature_flag(
        self,
        patch: JSONPatch,
        project_key: str,
        feature_flag_key: str,
        ...
        **kwargs,
        ...
        args = self._update_feature_flag_mapped_args(
            patch=patch,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            comment=comment,
        )
        return await self._aupdate_feature_flag_oapg(
            body=args.body,
...
class UpdateFeatureFlag(BaseApi):
    ...
    async def aupdate_feature_flag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_feature_flag(
            patch=patch,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            comment=comment,
    ...
    def update_feature_flag(
        ...
        raw_response = self.raw.update_feature_flag(
            patch=patch,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            comment=comment,
