...
class BaseApi(api_client.Api):
    ...
    def _single_flag_by_key_mapped_args(
        self,
        project_key: str,
    ...
    async def _asingle_flag_by_key_oapg(
        self,
...
class SingleFlagByKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asingle_flag_by_key(
        self,
        project_key: str,
        feature_flag_key: str,
        env: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._single_flag_by_key_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            env=env,
            expand=expand,
        )
        return await self._asingle_flag_by_key_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def single_flag_by_key(
        self,
        project_key: str,
        feature_flag_key: str,
        env: typing.Optional[str] = None,
        ...
        return self._single_flag_by_key_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class SingleFlagByKey(BaseApi):
    ...
    async def asingle_flag_by_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asingle_flag_by_key(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            env=env,
            expand=expand,
    ...
    def single_flag_by_key(
        ...
        raw_response = self.raw.single_flag_by_key(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            env=env,
            expand=expand,
