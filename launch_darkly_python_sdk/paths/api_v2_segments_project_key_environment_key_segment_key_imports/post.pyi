...
from launch_darkly_python_sdk.model.segments_beta_start_big_segment_import_request import SegmentsBetaStartBigSegmentImportRequest as SegmentsBetaStartBigSegmentImportRequestSchema
...
from launch_darkly_python_sdk.type.segments_beta_start_big_segment_import_request import SegmentsBetaStartBigSegmentImportRequest
...
from launch_darkly_python_sdk.pydantic.segments_beta_start_big_segment_import_request import SegmentsBetaStartBigSegmentImportRequest as SegmentsBetaStartBigSegmentImportRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = SegmentsBetaStartBigSegmentImportRequestSchema


request_body_segments_beta_start_big_segment_import_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _start_big_segment_import_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _astart_big_segment_import_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/imports',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_segments_beta_start_big_segment_import_request.serialize(body, content_type)
    ...
    def _start_big_segment_import_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class StartBigSegmentImportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astart_big_segment_import(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        **kwargs,
        ...
        args = self._start_big_segment_import_mapped_args(
        ...
        return await self._astart_big_segment_import_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def start_big_segment_import(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._start_big_segment_import_oapg(
            body=args.body,
            path_params=args.path,
        )

class StartBigSegmentImport(BaseApi):
    ...
    async def astart_big_segment_import(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astart_big_segment_import(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            file=file,
    ...
    def start_big_segment_import(
        ...
        raw_response = self.raw.start_big_segment_import(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            file=file,
