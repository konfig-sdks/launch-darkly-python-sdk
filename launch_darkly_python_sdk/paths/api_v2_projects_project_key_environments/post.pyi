...
from launch_darkly_python_sdk.model.environment_post import EnvironmentPost as EnvironmentPostSchema
...
from launch_darkly_python_sdk.model.environment_post_tags import EnvironmentPostTags as EnvironmentPostTagsSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema
from launch_darkly_python_sdk.model.environment import Environment as EnvironmentSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema
from launch_darkly_python_sdk.model.source_env import SourceEnv as SourceEnvSchema

from launch_darkly_python_sdk.type.environment import Environment
from launch_darkly_python_sdk.type.environment_post import EnvironmentPost
...
from launch_darkly_python_sdk.type.source_env import SourceEnv
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep
from launch_darkly_python_sdk.type.environment_post_tags import EnvironmentPostTags

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.environment_post_tags import EnvironmentPostTags as EnvironmentPostTagsPydantic
from launch_darkly_python_sdk.pydantic.source_env import SourceEnv as SourceEnvPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.environment import Environment as EnvironmentPydantic
from launch_darkly_python_sdk.pydantic.environment_post import EnvironmentPost as EnvironmentPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EnvironmentPostSchema


request_body_environment_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = EnvironmentSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_environment_mapped_args(
        self,
        name: str,
        key: str,
        color: str,
        project_key: str,
        tags: typing.Optional[EnvironmentPostTags] = None,
        default_ttl: typing.Optional[int] = None,
        secure_mode: typing.Optional[bool] = None,
        default_track_events: typing.Optional[bool] = None,
        confirm_changes: typing.Optional[bool] = None,
        require_comments: typing.Optional[bool] = None,
        source: typing.Optional[SourceEnv] = None,
        ...
        if default_ttl is not None:
            _body["defaultTtl"] = default_ttl
        if secure_mode is not None:
            _body["secureMode"] = secure_mode
        if default_track_events is not None:
            _body["defaultTrackEvents"] = default_track_events
        if confirm_changes is not None:
            _body["confirmChanges"] = confirm_changes
        if require_comments is not None:
            _body["requireComments"] = require_comments
        if source is not None:
            _body["source"] = source
        if critical is not None:
            _body["critical"] = critical
        args.body = _body
    ...
    async def _acreate_new_environment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_environment_post.serialize(body, content_type)
    ...
    def _create_new_environment_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewEnvironmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_environment(
        self,
        name: str,
        key: str,
        color: str,
        ...
        **kwargs,
        ...
        args = self._create_new_environment_mapped_args(
            name=name,
            key=key,
            color=color,
        ...
        return await self._acreate_new_environment_oapg(
            body=args.body,
    ...
    def create_new_environment(
        ...
        return self._create_new_environment_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewEnvironment(BaseApi):
    ...
    async def acreate_new_environment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_environment(
            name=name,
            key=key,
            color=color,
            project_key=project_key,
        ...
        if validate:
            return EnvironmentPydantic(**raw_response.body)
        return api_client.construct_model_instance(EnvironmentPydantic, raw_response.body)
    ...
    def create_new_environment(
        ...
        raw_response = self.raw.create_new_environment(
            name=name,
            key=key,
            color=color,
            project_key=project_key,
