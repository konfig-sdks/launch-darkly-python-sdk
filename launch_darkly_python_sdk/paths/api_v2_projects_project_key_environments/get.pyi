...
from launch_darkly_python_sdk.model.environments import Environments as EnvironmentsSchema
...
from launch_darkly_python_sdk.type.environments import Environments
...
from launch_darkly_python_sdk.pydantic.environments import Environments as EnvironmentsPydantic
...
SchemaFor200ResponseBodyApplicationJson = EnvironmentsSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_environments_mapped_args(
        self,
        project_key: str,
    ...
    async def _alist_environments_oapg(
        self,
...
class ListEnvironmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_environments(
        self,
        project_key: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_environments_mapped_args(
        ...
        return await self._alist_environments_oapg(
    ...
    def list_environments(
        ...
        return self._list_environments_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListEnvironments(BaseApi):
    ...
    async def alist_environments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EnvironmentsPydantic:
        raw_response = await self.raw.alist_environments(
            project_key=project_key,
            limit=limit,
            offset=offset,
            filter=filter,
        ...
        if validate:
            return EnvironmentsPydantic(**raw_response.body)
        return api_client.construct_model_instance(EnvironmentsPydantic, raw_response.body)
    ...
    def list_environments(
        ...
        raw_response = self.raw.list_environments(
            project_key=project_key,
            limit=limit,
            offset=offset,
            filter=filter,
