...
from launch_darkly_python_sdk.model.flag_followers_get_rep import FlagFollowersGetRep as FlagFollowersGetRepSchema
...
from launch_darkly_python_sdk.type.flag_followers_get_rep import FlagFollowersGetRep
...
from launch_darkly_python_sdk.pydantic.flag_followers_get_rep import FlagFollowersGetRep as FlagFollowersGetRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = FlagFollowersGetRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FlagFollowersGetRep
...
class BaseApi(api_client.Api):
    ...
    def _flag_followers_list_mapped_args(
        self,
        project_key: str,
    ...
    async def _aflag_followers_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers',
            auth_settings=_auth,
            headers=_headers,
        )
...
class FlagFollowersListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aflag_followers_list(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._flag_followers_list_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        )
        return await self._aflag_followers_list_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def flag_followers_list(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        return self._flag_followers_list_oapg(
            path_params=args.path,
        )

class FlagFollowersList(BaseApi):
    ...
    async def aflag_followers_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FlagFollowersGetRepPydantic:
        raw_response = await self.raw.aflag_followers_list(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            **kwargs,
        ...
        if validate:
            return FlagFollowersGetRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagFollowersGetRepPydantic, raw_response.body)
    ...
    def flag_followers_list(
        ...
        raw_response = self.raw.flag_followers_list(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        )
