...
class BaseApi(api_client.Api):
    ...
    def _delete_repository_mapped_args(
        self,
        repo: str,
    ...
    async def _adelete_repository_oapg(
        self,
...
class DeleteRepositoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_repository(
        self,
        repo: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_repository_mapped_args(
            repo=repo,
        )
        return await self._adelete_repository_oapg(
...
class DeleteRepository(BaseApi):
    ...
    async def adelete_repository(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_repository(
            repo=repo,
            **kwargs,
        )
    ...
    def delete_repository(
        ...
        raw_response = self.raw.delete_repository(
            repo=repo,
        )
