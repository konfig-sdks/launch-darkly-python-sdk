...
class BaseApi(api_client.Api):
    ...
    def _get_repository_by_repo_mapped_args(
        self,
        repo: str,
    ...
    async def _aget_repository_by_repo_oapg(
        self,
    ...
    def _get_repository_by_repo_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetRepositoryByRepoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_repository_by_repo(
        self,
        repo: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_repository_by_repo_mapped_args(
            repo=repo,
        )
        return await self._aget_repository_by_repo_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_repository_by_repo(
        self,
        repo: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_repository_by_repo_oapg(
            path_params=args.path,
        )

class GetRepositoryByRepo(BaseApi):
    ...
    async def aget_repository_by_repo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_repository_by_repo(
            repo=repo,
            **kwargs,
        )
        if validate:
    ...
    def get_repository_by_repo(
        ...
        raw_response = self.raw.get_repository_by_repo(
            repo=repo,
        )
        if validate:
            return RepositoryRepPydantic(**raw_response.body)
