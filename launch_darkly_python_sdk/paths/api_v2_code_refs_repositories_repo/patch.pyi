...
class BaseApi(api_client.Api):
    ...
    def _update_repository_settings_mapped_args(
        self,
        body: JSONPatch,
        repo: str,
    ...
    async def _aupdate_repository_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/repositories/{repo}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_repository_settings_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateRepositorySettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_repository_settings(
        self,
        body: JSONPatch,
        repo: str,
        **kwargs,
        ...
        args = self._update_repository_settings_mapped_args(
            body=body,
            repo=repo,
        )
        return await self._aupdate_repository_settings_oapg(
            body=args.body,
    ...
    def update_repository_settings(
        ...
        return self._update_repository_settings_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateRepositorySettings(BaseApi):
    ...
    async def aupdate_repository_settings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_repository_settings(
            body=body,
            repo=repo,
            **kwargs,
        )
    ...
    def update_repository_settings(
        ...
        raw_response = self.raw.update_repository_settings(
            body=body,
            repo=repo,
        )
        if validate:
