...
from launch_darkly_python_sdk.model.context_attribute_values_collection import ContextAttributeValuesCollection as ContextAttributeValuesCollectionSchema
...
from launch_darkly_python_sdk.type.context_attribute_values_collection import ContextAttributeValuesCollection
...
from launch_darkly_python_sdk.pydantic.context_attribute_values_collection import ContextAttributeValuesCollection as ContextAttributeValuesCollectionPydantic
...
request_path_attribute_name = api_client.PathParameter(
    name="attributeName",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AttributeNameSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = ContextAttributeValuesCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContextAttributeValuesCollection
...
class BaseApi(api_client.Api):
    ...
    def _get_context_attribute_values_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        attribute_name: str,
    ...
    async def _aget_context_attribute_values_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/context-attributes/{attributeName}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_context_attribute_values_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetContextAttributeValuesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_context_attribute_values(
        self,
        project_key: str,
        environment_key: str,
        attribute_name: str,
        ...
        **kwargs,
        ...
        args = self._get_context_attribute_values_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            attribute_name=attribute_name,
            filter=filter,
        )
        return await self._aget_context_attribute_values_oapg(
    ...
    def get_context_attribute_values(
        ...
        return self._get_context_attribute_values_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetContextAttributeValues(BaseApi):
    ...
    async def aget_context_attribute_values(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContextAttributeValuesCollectionPydantic:
        raw_response = await self.raw.aget_context_attribute_values(
            project_key=project_key,
            environment_key=environment_key,
            attribute_name=attribute_name,
            filter=filter,
        ...
        if validate:
            return ContextAttributeValuesCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContextAttributeValuesCollectionPydantic, raw_response.body)
    ...
    def get_context_attribute_values(
        ...
        raw_response = self.raw.get_context_attribute_values(
            project_key=project_key,
            environment_key=environment_key,
            attribute_name=attribute_name,
            filter=filter,
