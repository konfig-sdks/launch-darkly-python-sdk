...
from launch_darkly_python_sdk.model.extinction_collection_rep import ExtinctionCollectionRep as ExtinctionCollectionRepSchema
...
from launch_darkly_python_sdk.type.extinction_collection_rep import ExtinctionCollectionRep
...
from launch_darkly_python_sdk.pydantic.extinction_collection_rep import ExtinctionCollectionRep as ExtinctionCollectionRepPydantic
...
# Query params
RepoNameSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'repoName': typing.Union[RepoNameSchema, str, ],
...
request_query_repo_name = api_client.QueryParameter(
    name="repoName",
    style=api_client.ParameterStyle.FORM,
    schema=RepoNameSchema,
    explode=True,
)
request_query_branch_name = api_client.QueryParameter(
    name="branchName",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = ExtinctionCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExtinctionCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_extinctions_mapped_args(
        self,
        ...
        if repo_name is not None:
            _query_params["repoName"] = repo_name
    ...
    async def _alist_extinctions_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_repo_name,
            request_query_branch_name,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/extinctions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListExtinctionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_extinctions(
        self,
        repo_name: typing.Optional[str] = None,
        branch_name: typing.Optional[str] = None,
        proj_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_extinctions_mapped_args(
            repo_name=repo_name,
        ...
        return await self._alist_extinctions_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_extinctions(
        self,
        repo_name: typing.Optional[str] = None,
        branch_name: typing.Optional[str] = None,
        proj_key: typing.Optional[str] = None,
        ...
        return self._list_extinctions_oapg(
            query_params=args.query,
        )

class ListExtinctions(BaseApi):
    ...
    async def alist_extinctions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExtinctionCollectionRepPydantic:
        raw_response = await self.raw.alist_extinctions(
            repo_name=repo_name,
            branch_name=branch_name,
            proj_key=proj_key,
            flag_key=flag_key,
        ...
        if validate:
            return ExtinctionCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ExtinctionCollectionRepPydantic, raw_response.body)
    ...
    def list_extinctions(
        ...
        raw_response = self.raw.list_extinctions(
            repo_name=repo_name,
            branch_name=branch_name,
            proj_key=proj_key,
            flag_key=flag_key,
