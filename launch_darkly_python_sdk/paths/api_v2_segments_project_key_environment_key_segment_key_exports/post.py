...
class BaseApi(api_client.Api):
    ...
    def _start_big_segment_export_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _astart_big_segment_export_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/exports',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _start_big_segment_export_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class StartBigSegmentExportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astart_big_segment_export(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        **kwargs,
        ...
        args = self._start_big_segment_export_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        )
        return await self._astart_big_segment_export_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def start_big_segment_export(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._start_big_segment_export_oapg(
            path_params=args.path,
        )

class StartBigSegmentExport(BaseApi):
    ...
    async def astart_big_segment_export(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astart_big_segment_export(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            **kwargs,
    ...
    def start_big_segment_export(
        ...
        raw_response = self.raw.start_big_segment_export(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        )
