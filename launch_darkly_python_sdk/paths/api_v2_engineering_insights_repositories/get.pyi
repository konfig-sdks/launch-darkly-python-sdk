...
from launch_darkly_python_sdk.model.insights_repository_collection import InsightsRepositoryCollection as InsightsRepositoryCollectionSchema
...
from launch_darkly_python_sdk.type.insights_repository_collection import InsightsRepositoryCollection
...
from launch_darkly_python_sdk.pydantic.insights_repository_collection import InsightsRepositoryCollection as InsightsRepositoryCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = InsightsRepositoryCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InsightsRepositoryCollection
    ...
    async def _alist_repositories_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/repositories',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListRepositories(BaseApi):
    ...
    async def alist_repositories(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InsightsRepositoryCollectionPydantic:
        raw_response = await self.raw.alist_repositories(
            expand=expand,
            **kwargs,
        )
        if validate:
            return InsightsRepositoryCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(InsightsRepositoryCollectionPydantic, raw_response.body)
