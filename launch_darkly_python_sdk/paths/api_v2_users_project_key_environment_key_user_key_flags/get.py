...
from launch_darkly_python_sdk.model.user_flag_settings import UserFlagSettings as UserFlagSettingsSchema
...
from launch_darkly_python_sdk.type.user_flag_settings import UserFlagSettings
...
from launch_darkly_python_sdk.pydantic.user_flag_settings import UserFlagSettings as UserFlagSettingsPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserFlagSettingsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserFlagSettings
...
class BaseApi(api_client.Api):
    ...
    def _list_flag_settings_for_user_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
    ...
    async def _alist_flag_settings_for_user_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_flag_settings_for_user_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListFlagSettingsForUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="user_settings")
    async def alist_flag_settings_for_user(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
        **kwargs,
        ...
        args = self._list_flag_settings_for_user_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
        )
        return await self._alist_flag_settings_for_user_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="user_settings")
    def list_flag_settings_for_user(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
        ...
        return self._list_flag_settings_for_user_oapg(
            path_params=args.path,
        )

class ListFlagSettingsForUser(BaseApi):
    ...
    async def alist_flag_settings_for_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserFlagSettingsPydantic:
        raw_response = await self.raw.alist_flag_settings_for_user(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            **kwargs,
        ...
        if validate:
            return UserFlagSettingsPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserFlagSettingsPydantic, raw_response.body)
    ...
    def list_flag_settings_for_user(
        ...
        raw_response = self.raw.list_flag_settings_for_user(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
        )
