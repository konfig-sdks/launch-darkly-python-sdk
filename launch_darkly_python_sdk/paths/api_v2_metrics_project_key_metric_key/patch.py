...
MetricKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectKey': typing.Union[ProjectKeySchema, str, ],
        'metricKey': typing.Union[MetricKeySchema, str, ],
    }
)
...
request_path_metric_key = api_client.PathParameter(
    name="metricKey",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = MetricRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_by_json_patch_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
        metric_key: str,
    ...
    async def _aupdate_by_json_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/metrics/{projectKey}/{metricKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_by_json_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateByJsonPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_by_json_patch(
        self,
        body: JSONPatch,
        project_key: str,
        metric_key: str,
        **kwargs,
        ...
        args = self._update_by_json_patch_mapped_args(
            body=body,
            project_key=project_key,
            metric_key=metric_key,
        )
        return await self._aupdate_by_json_patch_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_by_json_patch(
        self,
        body: JSONPatch,
        project_key: str,
        metric_key: str,
        ...
        return self._update_by_json_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateByJsonPatch(BaseApi):
    ...
    async def aupdate_by_json_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_by_json_patch(
            body=body,
            project_key=project_key,
            metric_key=metric_key,
            **kwargs,
    ...
    def update_by_json_patch(
        ...
        raw_response = self.raw.update_by_json_patch(
            body=body,
            project_key=project_key,
            metric_key=metric_key,
        )
