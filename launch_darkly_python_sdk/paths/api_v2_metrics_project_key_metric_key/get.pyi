...
request_query_version_id = api_client.QueryParameter(
    name="versionId",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _get_single_metric_mapped_args(
        self,
        project_key: str,
        metric_key: str,
        ...
        if version_id is not None:
            _query_params["versionId"] = version_id
    ...
    async def _aget_single_metric_oapg(
        self,
...
class GetSingleMetricRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_metric(
        self,
        project_key: str,
        metric_key: str,
        expand: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_single_metric_mapped_args(
            project_key=project_key,
            metric_key=metric_key,
            expand=expand,
            version_id=version_id,
        )
        return await self._aget_single_metric_oapg(
    ...
    def get_single_metric(
        ...
        return self._get_single_metric_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSingleMetric(BaseApi):
    ...
    async def aget_single_metric(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_metric(
            project_key=project_key,
            metric_key=metric_key,
            expand=expand,
            version_id=version_id,
    ...
    def get_single_metric(
        ...
        raw_response = self.raw.get_single_metric(
            project_key=project_key,
            metric_key=metric_key,
            expand=expand,
            version_id=version_id,
