...
class BaseApi(api_client.Api):
    ...
    def _get_openapi_spec_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_openapi_spec_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/openapi.json',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetOpenapiSpecRaw(BaseApi):
    ...
    async def aget_openapi_spec(
        ...
        **kwargs,
        ...
        args = self._get_openapi_spec_mapped_args(
        )
        return await self._aget_openapi_spec_oapg(
            **kwargs,
        )
    ...
    def get_openapi_spec(
        ...
        return self._get_openapi_spec_oapg(
        )
...
class GetOpenapiSpec(BaseApi):
    ...
    async def aget_openapi_spec(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_openapi_spec(
            **kwargs,
        )
    ...
    def get_openapi_spec(
        ...
        raw_response = self.raw.get_openapi_spec(
        )
