...
from launch_darkly_python_sdk.model.post_insight_group_params import PostInsightGroupParams as PostInsightGroupParamsSchema
...
from launch_darkly_python_sdk.model.insight_group import InsightGroup as InsightGroupSchema
from launch_darkly_python_sdk.model.post_insight_group_params_application_keys import PostInsightGroupParamsApplicationKeys as PostInsightGroupParamsApplicationKeysSchema

from launch_darkly_python_sdk.type.insight_group import InsightGroup
from launch_darkly_python_sdk.type.post_insight_group_params_application_keys import PostInsightGroupParamsApplicationKeys
...
from launch_darkly_python_sdk.type.post_insight_group_params import PostInsightGroupParams
...
from launch_darkly_python_sdk.pydantic.insight_group import InsightGroup as InsightGroupPydantic
from launch_darkly_python_sdk.pydantic.post_insight_group_params import PostInsightGroupParams as PostInsightGroupParamsPydantic
from launch_darkly_python_sdk.pydantic.post_insight_group_params_application_keys import PostInsightGroupParamsApplicationKeys as PostInsightGroupParamsApplicationKeysPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostInsightGroupParamsSchema


request_body_post_insight_group_params = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = InsightGroupSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_insight_group_mapped_args(
        self,
        name: str,
        key: str,
        project_key: str,
        environment_key: str,
        application_keys: typing.Optional[PostInsightGroupParamsApplicationKeys] = None,
    ...
    async def _acreate_insight_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/insights/group',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_post_insight_group_params.serialize(body, content_type)
    ...
    def _create_insight_group_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateInsightGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_insight_group(
        self,
        name: str,
        key: str,
        project_key: str,
        ...
        **kwargs,
        ...
        args = self._create_insight_group_mapped_args(
            name=name,
            key=key,
        ...
        return await self._acreate_insight_group_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_insight_group(
        ...
        return self._create_insight_group_oapg(
            body=args.body,
        )

class CreateInsightGroup(BaseApi):
    ...
    async def acreate_insight_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InsightGroupPydantic:
        raw_response = await self.raw.acreate_insight_group(
            name=name,
            key=key,
            project_key=project_key,
            environment_key=environment_key,
        ...
        if validate:
            return InsightGroupPydantic(**raw_response.body)
        return api_client.construct_model_instance(InsightGroupPydantic, raw_response.body)
    ...
    def create_insight_group(
        ...
        raw_response = self.raw.create_insight_group(
            name=name,
            key=key,
            project_key=project_key,
            environment_key=environment_key,
