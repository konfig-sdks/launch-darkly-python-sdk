...
class BaseApi(api_client.Api):
    ...
    def _delete_big_segment_store_integration_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
    ...
    async def _adelete_big_segment_store_integration_oapg(
        self,
    ...
    def _delete_big_segment_store_integration_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteBigSegmentStoreIntegrationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_big_segment_store_integration(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
        ...
        **kwargs,
        ...
        args = self._delete_big_segment_store_integration_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
        )
        return await self._adelete_big_segment_store_integration_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_big_segment_store_integration(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
        ...
        return self._delete_big_segment_store_integration_oapg(
            path_params=args.path,
        )

class DeleteBigSegmentStoreIntegration(BaseApi):
    ...
    async def adelete_big_segment_store_integration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_big_segment_store_integration(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
    ...
    def delete_big_segment_store_integration(
        ...
        raw_response = self.raw.delete_big_segment_store_integration(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
