...
SchemaFor200ResponseBodyApplicationJson = BigSegmentStoreIntegrationSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_big_segment_store_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
    ...
    async def _aupdate_big_segment_store_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_big_segment_store_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateBigSegmentStoreRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_big_segment_store(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_big_segment_store_mapped_args(
            body=body,
        ...
        return await self._aupdate_big_segment_store_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_big_segment_store(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
        ...
        return self._update_big_segment_store_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateBigSegmentStore(BaseApi):
    ...
    async def aupdate_big_segment_store(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_big_segment_store(
            body=body,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
    ...
    def update_big_segment_store(
        ...
        raw_response = self.raw.update_big_segment_store(
            body=body,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
