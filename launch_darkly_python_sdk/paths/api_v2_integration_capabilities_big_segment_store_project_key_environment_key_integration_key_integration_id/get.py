...
class BaseApi(api_client.Api):
    ...
    def _get_big_segment_store_integration_by_id_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
    ...
    async def _aget_big_segment_store_integration_by_id_oapg(
        self,
    ...
    def _get_big_segment_store_integration_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBigSegmentStoreIntegrationByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_big_segment_store_integration_by_id(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
        ...
        **kwargs,
        ...
        args = self._get_big_segment_store_integration_by_id_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
        )
        return await self._aget_big_segment_store_integration_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_big_segment_store_integration_by_id(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
        ...
        return self._get_big_segment_store_integration_by_id_oapg(
            path_params=args.path,
        )

class GetBigSegmentStoreIntegrationById(BaseApi):
    ...
    async def aget_big_segment_store_integration_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_big_segment_store_integration_by_id(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
    ...
    def get_big_segment_store_integration_by_id(
        ...
        raw_response = self.raw.get_big_segment_store_integration_by_id(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
