...
from launch_darkly_python_sdk.model.insights_chart import InsightsChart as InsightsChartSchema
...
from launch_darkly_python_sdk.type.insights_chart import InsightsChart
...
from launch_darkly_python_sdk.pydantic.insights_chart import InsightsChart as InsightsChartPydantic
...
HasExperimentsSchema = schemas.BoolSchema
ModelGlobalSchema = schemas.StrSchema
GroupBySchema = schemas.StrSchema
ModelFromSchema = schemas.DateTimeSchema
ToSchema = schemas.DateTimeSchema
BucketTypeSchema = schemas.StrSchema
BucketMsSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'hasExperiments': typing.Union[HasExperimentsSchema, bool, ],
        'global': typing.Union[ModelGlobalSchema, str, ],
        ...
        'bucketMs': typing.Union[BucketMsSchema, decimal.Decimal, int, ],
...
request_query_environment_key = api_client.QueryParameter(
    name="environmentKey",
    style=api_client.ParameterStyle.FORM,
...
request_query_has_experiments = api_client.QueryParameter(
    name="hasExperiments",
    style=api_client.ParameterStyle.FORM,
    schema=HasExperimentsSchema,
    explode=True,
)
...
request_query_bucket_ms = api_client.QueryParameter(
    name="bucketMs",
    style=api_client.ParameterStyle.FORM,
    schema=BucketMsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = InsightsChartSchema
...
class BaseApi(api_client.Api):
    ...
    def _release_frequency_data_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        has_experiments: typing.Optional[bool] = None,
        ...
        bucket_type: typing.Optional[str] = None,
        bucket_ms: typing.Optional[int] = None,
        ...
        if environment_key is not None:
            _query_params["environmentKey"] = environment_key
        if application_key is not None:
            _query_params["applicationKey"] = application_key
        if has_experiments is not None:
            _query_params["hasExperiments"] = has_experiments
        if _global is not None:
            _query_params["global"] = _global
        ...
        if bucket_type is not None:
            _query_params["bucketType"] = bucket_type
        if bucket_ms is not None:
            _query_params["bucketMs"] = bucket_ms
        if expand is not None:
            _query_params["expand"] = expand
        args.query = _query_params
        return args

    async def _arelease_frequency_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/charts/releases/frequency',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _release_frequency_data_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ReleaseFrequencyDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arelease_frequency_data(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._release_frequency_data_mapped_args(
        ...
        return await self._arelease_frequency_data_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def release_frequency_data(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        ...
        return self._release_frequency_data_oapg(
            query_params=args.query,
        )

class ReleaseFrequencyData(BaseApi):
    ...
    async def arelease_frequency_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InsightsChartPydantic:
        raw_response = await self.raw.arelease_frequency_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            has_experiments=has_experiments,
        ...
        if validate:
            return InsightsChartPydantic(**raw_response.body)
        return api_client.construct_model_instance(InsightsChartPydantic, raw_response.body)
    ...
    def release_frequency_data(
        ...
        raw_response = self.raw.release_frequency_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            has_experiments=has_experiments,
