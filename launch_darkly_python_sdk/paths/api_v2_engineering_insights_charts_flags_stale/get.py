...
MaintainerIdSchema = schemas.StrSchema
MaintainerTeamKeySchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'maintainerId': typing.Union[MaintainerIdSchema, str, ],
        'maintainerTeamKey': typing.Union[MaintainerTeamKeySchema, str, ],
...
request_query_maintainer_id = api_client.QueryParameter(
    name="maintainerId",
    style=api_client.ParameterStyle.FORM,
    schema=MaintainerIdSchema,
    explode=True,
)
request_query_maintainer_team_key = api_client.QueryParameter(
    name="maintainerTeamKey",
    style=api_client.ParameterStyle.FORM,
    schema=MaintainerTeamKeySchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _stale_flags_chart_data_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        ...
        maintainer_team_key: typing.Optional[str] = None,
        ...
        if maintainer_id is not None:
            _query_params["maintainerId"] = maintainer_id
        if maintainer_team_key is not None:
            _query_params["maintainerTeamKey"] = maintainer_team_key
        if expand is not None:
            _query_params["expand"] = expand
        args.query = _query_params
        return args

    async def _astale_flags_chart_data_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_maintainer_id,
            request_query_maintainer_team_key,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/charts/flags/stale',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _stale_flags_chart_data_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class StaleFlagsChartDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astale_flags_chart_data(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._stale_flags_chart_data_mapped_args(
        ...
        return await self._astale_flags_chart_data_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def stale_flags_chart_data(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        ...
        return self._stale_flags_chart_data_oapg(
            query_params=args.query,
        )

class StaleFlagsChartData(BaseApi):
    ...
    async def astale_flags_chart_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astale_flags_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            group_by=group_by,
    ...
    def stale_flags_chart_data(
        ...
        raw_response = self.raw.stale_flags_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            group_by=group_by,
