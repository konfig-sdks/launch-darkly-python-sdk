...
from launch_darkly_python_sdk.model.application_version_rep import ApplicationVersionRep as ApplicationVersionRepSchema
...
from launch_darkly_python_sdk.type.application_version_rep import ApplicationVersionRep
...
from launch_darkly_python_sdk.pydantic.application_version_rep import ApplicationVersionRep as ApplicationVersionRepPydantic
...
VersionKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'applicationKey': typing.Union[ApplicationKeySchema, str, ],
        'versionKey': typing.Union[VersionKeySchema, str, ],
    }
)
...
request_path_version_key = api_client.PathParameter(
    name="versionKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=VersionKeySchema,
    required=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationJson = ApplicationVersionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ApplicationVersionRep
...
class BaseApi(api_client.Api):
    ...
    def _update_version_patch_mapped_args(
        self,
        body: JSONPatch,
        application_key: str,
        version_key: str,
        ...
        if version_key is not None:
            _path_params["versionKey"] = version_key
        args.path = _path_params
        return args

    async def _aupdate_version_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/applications/{applicationKey}/versions/{versionKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_version_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateVersionPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_version_patch(
        self,
        body: JSONPatch,
        application_key: str,
        version_key: str,
        **kwargs,
        ...
        args = self._update_version_patch_mapped_args(
            body=body,
            application_key=application_key,
            version_key=version_key,
        )
        return await self._aupdate_version_patch_oapg(
            body=args.body,
    ...
    def update_version_patch(
        ...
        return self._update_version_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateVersionPatch(BaseApi):
    ...
    async def aupdate_version_patch(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApplicationVersionRepPydantic:
        raw_response = await self.raw.aupdate_version_patch(
            body=body,
            application_key=application_key,
            version_key=version_key,
            **kwargs,
        ...
        if validate:
            return ApplicationVersionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ApplicationVersionRepPydantic, raw_response.body)
    ...
    def update_version_patch(
        ...
        raw_response = self.raw.update_version_patch(
            body=body,
            application_key=application_key,
            version_key=version_key,
        )
