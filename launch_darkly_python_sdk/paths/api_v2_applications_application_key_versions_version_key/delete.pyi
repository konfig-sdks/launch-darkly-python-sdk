...
class BaseApi(api_client.Api):
    ...
    def _remove_version_mapped_args(
        self,
        application_key: str,
        version_key: str,
    ...
    async def _aremove_version_oapg(
        self,
...
class RemoveVersionRaw(BaseApi):
    ...
    async def aremove_version(
        ...
        **kwargs,
        ...
        args = self._remove_version_mapped_args(
            application_key=application_key,
            version_key=version_key,
        )
        return await self._aremove_version_oapg(
    ...
    def remove_version(
        ...
        return self._remove_version_oapg(
            path_params=args.path,
        )

class RemoveVersion(BaseApi):
    ...
    async def aremove_version(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_version(
            application_key=application_key,
            version_key=version_key,
            **kwargs,
        )
    ...
    def remove_version(
        ...
        raw_response = self.raw.remove_version(
            application_key=application_key,
            version_key=version_key,
        )
