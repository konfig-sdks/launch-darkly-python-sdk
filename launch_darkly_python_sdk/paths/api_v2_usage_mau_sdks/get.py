...
from launch_darkly_python_sdk.model.sdk_list_rep import SdkListRep as SdkListRepSchema
...
from launch_darkly_python_sdk.type.sdk_list_rep import SdkListRep
...
from launch_darkly_python_sdk.pydantic.sdk_list_rep import SdkListRep as SdkListRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = SdkListRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_mau_sdks_by_type_mapped_args(
        self,
    ...
    async def _alist_mau_sdks_by_type_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/mau/sdks',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_mau_sdks_by_type_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListMauSdksByTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_mau_sdks_by_type(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        sdktype: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_mau_sdks_by_type_mapped_args(
            _from=_from,
            to=to,
            sdktype=sdktype,
        )
        return await self._alist_mau_sdks_by_type_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_mau_sdks_by_type(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        sdktype: typing.Optional[str] = None,
        ...
        return self._list_mau_sdks_by_type_oapg(
            query_params=args.query,
        )

class ListMauSdksByType(BaseApi):
    ...
    async def alist_mau_sdks_by_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_mau_sdks_by_type(
            _from=_from,
            to=to,
            sdktype=sdktype,
            **kwargs,
        ...
        if validate:
            return SdkListRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(SdkListRepPydantic, raw_response.body)
    ...
    def list_mau_sdks_by_type(
        ...
        raw_response = self.raw.list_mau_sdks_by_type(
            _from=_from,
            to=to,
            sdktype=sdktype,
        )
