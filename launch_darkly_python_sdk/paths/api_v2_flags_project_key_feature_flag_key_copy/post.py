...
from launch_darkly_python_sdk.model.flag_copy_config_post import FlagCopyConfigPost as FlagCopyConfigPostSchema
...
from launch_darkly_python_sdk.model.flag_copy_config_post_excluded_actions import FlagCopyConfigPostExcludedActions as FlagCopyConfigPostExcludedActionsSchema
from launch_darkly_python_sdk.model.method_not_allowed_error_rep import MethodNotAllowedErrorRep as MethodNotAllowedErrorRepSchema
from launch_darkly_python_sdk.model.flag_copy_config_post_included_actions import FlagCopyConfigPostIncludedActions as FlagCopyConfigPostIncludedActionsSchema
from launch_darkly_python_sdk.model.flag_copy_config_environment import FlagCopyConfigEnvironment as FlagCopyConfigEnvironmentSchema

from launch_darkly_python_sdk.type.flag_copy_config_environment import FlagCopyConfigEnvironment
...
from launch_darkly_python_sdk.type.method_not_allowed_error_rep import MethodNotAllowedErrorRep
...
from launch_darkly_python_sdk.type.flag_copy_config_post_excluded_actions import FlagCopyConfigPostExcludedActions
from launch_darkly_python_sdk.type.status_conflict_error_rep import StatusConflictErrorRep
from launch_darkly_python_sdk.type.flag_copy_config_post import FlagCopyConfigPost
from launch_darkly_python_sdk.type.flag_copy_config_post_included_actions import FlagCopyConfigPostIncludedActions

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.flag_copy_config_post_excluded_actions import FlagCopyConfigPostExcludedActions as FlagCopyConfigPostExcludedActionsPydantic
from launch_darkly_python_sdk.pydantic.flag_copy_config_post import FlagCopyConfigPost as FlagCopyConfigPostPydantic
from launch_darkly_python_sdk.pydantic.method_not_allowed_error_rep import MethodNotAllowedErrorRep as MethodNotAllowedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.flag_copy_config_post_included_actions import FlagCopyConfigPostIncludedActions as FlagCopyConfigPostIncludedActionsPydantic
from launch_darkly_python_sdk.pydantic.flag_copy_config_environment import FlagCopyConfigEnvironment as FlagCopyConfigEnvironmentPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FlagCopyConfigPostSchema


request_body_flag_copy_config_post = api_client.RequestBody(
    content={
...
SchemaFor405ResponseBodyApplicationJson = MethodNotAllowedErrorRepSchema


@dataclass
class ApiResponseFor405(api_client.ApiResponse):
    body: MethodNotAllowedErrorRep
...
class BaseApi(api_client.Api):
    ...
    def _copy_flag_settings_mapped_args(
        self,
        ...
        included_actions: typing.Optional[FlagCopyConfigPostIncludedActions] = None,
        excluded_actions: typing.Optional[FlagCopyConfigPostExcludedActions] = None,
    ...
    async def _acopy_flag_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{featureFlagKey}/copy',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_flag_copy_config_post.serialize(body, content_type)
...
class CopyFlagSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acopy_flag_settings(
        self,
        source: FlagCopyConfigEnvironment,
        target: FlagCopyConfigEnvironment,
        project_key: str,
        ...
        **kwargs,
        ...
        args = self._copy_flag_settings_mapped_args(
            source=source,
            target=target,
        ...
        return await self._acopy_flag_settings_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def copy_flag_settings(
        self,
        source: FlagCopyConfigEnvironment,
        target: FlagCopyConfigEnvironment,
        project_key: str,
        ...
        return self._copy_flag_settings_oapg(
            body=args.body,
            path_params=args.path,
        )

class CopyFlagSettings(BaseApi):
    ...
    async def acopy_flag_settings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acopy_flag_settings(
            source=source,
            target=target,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
    ...
    def copy_flag_settings(
        ...
        raw_response = self.raw.copy_flag_settings(
            source=source,
            target=target,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
