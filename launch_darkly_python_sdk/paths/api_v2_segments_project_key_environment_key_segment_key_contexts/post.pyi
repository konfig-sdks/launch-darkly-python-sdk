...
class BaseApi(api_client.Api):
    ...
    def _update_context_targets_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aupdate_context_targets_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/contexts',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_context_targets_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateContextTargetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_context_targets(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_context_targets_mapped_args(
        ...
        return await self._aupdate_context_targets_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_context_targets(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._update_context_targets_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateContextTargets(BaseApi):
    ...
    async def aupdate_context_targets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_context_targets(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            included=included,
    ...
    def update_context_targets(
        ...
        raw_response = self.raw.update_context_targets(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            included=included,
