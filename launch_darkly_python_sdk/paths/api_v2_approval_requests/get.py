...
from launch_darkly_python_sdk.model.expandable_approval_requests_response import ExpandableApprovalRequestsResponse as ExpandableApprovalRequestsResponseSchema
...
from launch_darkly_python_sdk.type.expandable_approval_requests_response import ExpandableApprovalRequestsResponse
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.expandable_approval_requests_response import ExpandableApprovalRequestsResponse as ExpandableApprovalRequestsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ExpandableApprovalRequestsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExpandableApprovalRequestsResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExpandableApprovalRequestsResponsePydantic:
        ...
        if validate:
            return ExpandableApprovalRequestsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpandableApprovalRequestsResponsePydantic, raw_response.body)
