...
from launch_darkly_python_sdk.model.create_approval_request_request_notify_member_ids import CreateApprovalRequestRequestNotifyMemberIds as CreateApprovalRequestRequestNotifyMemberIdsSchema
from launch_darkly_python_sdk.model.create_approval_request_request_notify_team_keys import CreateApprovalRequestRequestNotifyTeamKeys as CreateApprovalRequestRequestNotifyTeamKeysSchema
...
from launch_darkly_python_sdk.model.create_approval_request_request import CreateApprovalRequestRequest as CreateApprovalRequestRequestSchema
from launch_darkly_python_sdk.model.approval_request_response import ApprovalRequestResponse as ApprovalRequestResponseSchema
...
from launch_darkly_python_sdk.type.create_approval_request_request_notify_member_ids import CreateApprovalRequestRequestNotifyMemberIds
from launch_darkly_python_sdk.type.create_approval_request_request_notify_team_keys import CreateApprovalRequestRequestNotifyTeamKeys
from launch_darkly_python_sdk.type.approval_request_response import ApprovalRequestResponse
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.create_approval_request_request import CreateApprovalRequestRequest
...
from launch_darkly_python_sdk.pydantic.create_approval_request_request_notify_team_keys import CreateApprovalRequestRequestNotifyTeamKeys as CreateApprovalRequestRequestNotifyTeamKeysPydantic
from launch_darkly_python_sdk.pydantic.create_approval_request_request import CreateApprovalRequestRequest as CreateApprovalRequestRequestPydantic
...
from launch_darkly_python_sdk.pydantic.create_approval_request_request_notify_member_ids import CreateApprovalRequestRequestNotifyMemberIds as CreateApprovalRequestRequestNotifyMemberIdsPydantic
...
from launch_darkly_python_sdk.pydantic.approval_request_response import ApprovalRequestResponse as ApprovalRequestResponsePydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateApprovalRequestRequestSchema


request_body_create_approval_request_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ApprovalRequestResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ApprovalRequestResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_request_flag_mapped_args(
        self,
        description: str,
        resource_id: str,
        instructions: Instructions,
        comment: typing.Optional[str] = None,
        notify_member_ids: typing.Optional[CreateApprovalRequestRequestNotifyMemberIds] = None,
        notify_team_keys: typing.Optional[CreateApprovalRequestRequestNotifyTeamKeys] = None,
    ...
    async def _acreate_request_flag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/approval-requests',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_approval_request_request.serialize(body, content_type)
...
class CreateRequestFlagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_request_flag(
        self,
        description: str,
        resource_id: str,
        instructions: Instructions,
        ...
        **kwargs,
        ...
        args = self._create_request_flag_mapped_args(
        ...
        return await self._acreate_request_flag_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_request_flag(
        self,
        description: str,
        resource_id: str,
        instructions: Instructions,
        ...
        return self._create_request_flag_oapg(
            body=args.body,
        )

class CreateRequestFlag(BaseApi):
    ...
    async def acreate_request_flag(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApprovalRequestResponsePydantic:
        raw_response = await self.raw.acreate_request_flag(
            description=description,
            resource_id=resource_id,
            instructions=instructions,
            comment=comment,
        ...
        if validate:
            return ApprovalRequestResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ApprovalRequestResponsePydantic, raw_response.body)
    ...
    def create_request_flag(
        ...
        raw_response = self.raw.create_request_flag(
            description=description,
            resource_id=resource_id,
            instructions=instructions,
            comment=comment,
