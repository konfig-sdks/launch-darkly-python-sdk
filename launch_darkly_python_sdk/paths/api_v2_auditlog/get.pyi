...
from launch_darkly_python_sdk.model.audit_log_entry_listing_rep_collection import AuditLogEntryListingRepCollection as AuditLogEntryListingRepCollectionSchema
...
from launch_darkly_python_sdk.type.audit_log_entry_listing_rep_collection import AuditLogEntryListingRepCollection
...
from launch_darkly_python_sdk.pydantic.audit_log_entry_listing_rep_collection import AuditLogEntryListingRepCollection as AuditLogEntryListingRepCollectionPydantic
...
# Query params
BeforeSchema = schemas.Int64Schema
...
SchemaFor200ResponseBodyApplicationJson = AuditLogEntryListingRepCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AuditLogEntryListingRepCollection
...
class BaseApi(api_client.Api):
    ...
    def _list_audit_log_entries_mapped_args(
        self,
    ...
    async def _alist_audit_log_entries_oapg(
        self,
    ...
    def _list_audit_log_entries_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListAuditLogEntriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_audit_log_entries(
        self,
        before: typing.Optional[int] = None,
        after: typing.Optional[int] = None,
        q: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_audit_log_entries_mapped_args(
            before=before,
            after=after,
            q=q,
            limit=limit,
        ...
        return await self._alist_audit_log_entries_oapg(
    ...
    def list_audit_log_entries(
        ...
        return self._list_audit_log_entries_oapg(
            query_params=args.query,
        )

class ListAuditLogEntries(BaseApi):
    ...
    async def alist_audit_log_entries(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AuditLogEntryListingRepCollectionPydantic:
        raw_response = await self.raw.alist_audit_log_entries(
            before=before,
            after=after,
            q=q,
            limit=limit,
        ...
        if validate:
            return AuditLogEntryListingRepCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(AuditLogEntryListingRepCollectionPydantic, raw_response.body)
    ...
    def list_audit_log_entries(
        ...
        raw_response = self.raw.list_audit_log_entries(
            before=before,
            after=after,
            q=q,
            limit=limit,
