...
from launch_darkly_python_sdk.model.integration_delivery_configuration import IntegrationDeliveryConfiguration as IntegrationDeliveryConfigurationSchema
...
from launch_darkly_python_sdk.type.integration_delivery_configuration import IntegrationDeliveryConfiguration
...
from launch_darkly_python_sdk.pydantic.integration_delivery_configuration import IntegrationDeliveryConfiguration as IntegrationDeliveryConfigurationPydantic
...
SchemaFor201ResponseBodyApplicationJson = IntegrationDeliveryConfigurationSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: IntegrationDeliveryConfiguration
...
class BaseApi(api_client.Api):
    ...
    def _create_delivery_configuration_mapped_args(
        self,
    ...
    async def _acreate_delivery_configuration_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}/{integrationKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_delivery_configuration_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateDeliveryConfigurationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_delivery_configuration(
        self,
        config: FormVariableConfig,
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._create_delivery_configuration_mapped_args(
            config=config,
        ...
        return await self._acreate_delivery_configuration_oapg(
            body=args.body,
    ...
    def create_delivery_configuration(
        ...
        return self._create_delivery_configuration_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateDeliveryConfiguration(BaseApi):
    ...
    async def acreate_delivery_configuration(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IntegrationDeliveryConfigurationPydantic:
        raw_response = await self.raw.acreate_delivery_configuration(
            config=config,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
        ...
        if validate:
            return IntegrationDeliveryConfigurationPydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationDeliveryConfigurationPydantic, raw_response.body)
    ...
    def create_delivery_configuration(
        ...
        raw_response = self.raw.create_delivery_configuration(
            config=config,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
