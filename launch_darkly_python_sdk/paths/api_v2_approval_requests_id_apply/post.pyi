...
class BaseApi(api_client.Api):
    ...
    def _apply_request_flag_mapped_args(
        self,
        id: str,
    ...
    async def _aapply_request_flag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/approval-requests/{id}/apply',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class ApplyRequestFlagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aapply_request_flag(
        self,
        id: str,
        comment: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._apply_request_flag_mapped_args(
            id=id,
            comment=comment,
        )
        return await self._aapply_request_flag_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def apply_request_flag(
        self,
        id: str,
        comment: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._apply_request_flag_oapg(
            body=args.body,
            path_params=args.path,
        )

class ApplyRequestFlag(BaseApi):
    ...
    async def aapply_request_flag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aapply_request_flag(
            id=id,
            comment=comment,
            **kwargs,
        )
    ...
    def apply_request_flag(
        ...
        raw_response = self.raw.apply_request_flag(
            id=id,
            comment=comment,
        )
        if validate:
