...
from launch_darkly_python_sdk.model.series_list_rep import SeriesListRep as SeriesListRepSchema

from launch_darkly_python_sdk.type.series_list_rep import SeriesListRep
...
from launch_darkly_python_sdk.pydantic.series_list_rep import SeriesListRep as SeriesListRepPydantic
...
SdktypeSchema = schemas.StrSchema
SdkSchema = schemas.StrSchema
AnonymousSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'sdktype': typing.Union[SdktypeSchema, str, ],
        'sdk': typing.Union[SdkSchema, str, ],
        'anonymous': typing.Union[AnonymousSchema, str, ],
...
request_query_sdktype = api_client.QueryParameter(
    name="sdktype",
    style=api_client.ParameterStyle.FORM,
    schema=SdktypeSchema,
    explode=True,
)
request_query_sdk = api_client.QueryParameter(
    name="sdk",
    style=api_client.ParameterStyle.FORM,
    schema=SdkSchema,
    explode=True,
)
request_query_anonymous = api_client.QueryParameter(
    name="anonymous",
    style=api_client.ParameterStyle.FORM,
    schema=AnonymousSchema,
    explode=True,
)
request_query_groupby = api_client.QueryParameter(
    name="groupby",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = SeriesListRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_mau_usage_data_mapped_args(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        project: typing.Optional[str] = None,
        environment: typing.Optional[str] = None,
        sdktype: typing.Optional[str] = None,
        sdk: typing.Optional[str] = None,
        anonymous: typing.Optional[str] = None,
        groupby: typing.Optional[str] = None,
        ...
        if sdktype is not None:
            _query_params["sdktype"] = sdktype
        if sdk is not None:
            _query_params["sdk"] = sdk
        if anonymous is not None:
            _query_params["anonymous"] = anonymous
        if groupby is not None:
            _query_params["groupby"] = groupby
        args.query = _query_params
        return args

    async def _aget_mau_usage_data_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_sdktype,
            request_query_sdk,
            request_query_anonymous,
            request_query_groupby,
        ):
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/mau',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMauUsageDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_mau_usage_data(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        project: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_mau_usage_data_mapped_args(
            _from=_from,
            to=to,
            project=project,
        ...
        return await self._aget_mau_usage_data_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_mau_usage_data(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        project: typing.Optional[str] = None,
        ...
        return self._get_mau_usage_data_oapg(
            query_params=args.query,
        )

class GetMauUsageData(BaseApi):
    ...
    async def aget_mau_usage_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SeriesListRepPydantic:
        raw_response = await self.raw.aget_mau_usage_data(
            _from=_from,
            to=to,
            project=project,
            environment=environment,
        ...
        if validate:
            return SeriesListRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(SeriesListRepPydantic, raw_response.body)
    ...
    def get_mau_usage_data(
        ...
        raw_response = self.raw.get_mau_usage_data(
            _from=_from,
            to=to,
            project=project,
            environment=environment,
