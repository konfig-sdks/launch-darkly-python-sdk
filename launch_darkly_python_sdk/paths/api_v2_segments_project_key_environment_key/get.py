...
from launch_darkly_python_sdk.model.user_segments import UserSegments as UserSegmentsSchema
...
from launch_darkly_python_sdk.type.user_segments import UserSegments
...
from launch_darkly_python_sdk.pydantic.user_segments import UserSegments as UserSegmentsPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserSegmentsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_segment_list_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_segment_list_oapg(
        self,
...
class GetSegmentListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_segment_list(
        self,
        project_key: str,
        environment_key: str,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_segment_list_mapped_args(
        ...
        return await self._aget_segment_list_oapg(
    ...
    def get_segment_list(
        ...
        return self._get_segment_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSegmentList(BaseApi):
    ...
    async def aget_segment_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserSegmentsPydantic:
        raw_response = await self.raw.aget_segment_list(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return UserSegmentsPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserSegmentsPydantic, raw_response.body)
    ...
    def get_segment_list(
        ...
        raw_response = self.raw.get_segment_list(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            offset=offset,
