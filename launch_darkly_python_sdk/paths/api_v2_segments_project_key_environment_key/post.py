...
from launch_darkly_python_sdk.model.segment_body_tags import SegmentBodyTags as SegmentBodyTagsSchema
from launch_darkly_python_sdk.model.segment_body import SegmentBody as SegmentBodySchema
...
from launch_darkly_python_sdk.type.segment_body_tags import SegmentBodyTags
from launch_darkly_python_sdk.type.segment_body import SegmentBody
...
from launch_darkly_python_sdk.pydantic.segment_body import SegmentBody as SegmentBodyPydantic
...
from launch_darkly_python_sdk.pydantic.segment_body_tags import SegmentBodyTags as SegmentBodyTagsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SegmentBodySchema


request_body_segment_body = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = UserSegmentSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_segment_mapped_args(
        ...
        project_key: str,
        environment_key: str,
        tags: typing.Optional[SegmentBodyTags] = None,
        description: typing.Optional[str] = None,
        unbounded: typing.Optional[bool] = None,
        unbounded_context_kind: typing.Optional[str] = None,
        ...
        if unbounded is not None:
            _body["unbounded"] = unbounded
        if unbounded_context_kind is not None:
            _body["unboundedContextKind"] = unbounded_context_kind
        args.body = _body
    ...
    async def _acreate_segment_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_segment_body.serialize(body, content_type)
