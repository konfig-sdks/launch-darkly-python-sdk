...
from launch_darkly_python_sdk.model.statistics_root import StatisticsRoot as StatisticsRootSchema
...
from launch_darkly_python_sdk.type.statistics_root import StatisticsRoot
...
from launch_darkly_python_sdk.pydantic.statistics_root import StatisticsRoot as StatisticsRootPydantic

SchemaFor200ResponseBodyApplicationJson = StatisticsRootSchema
    ...
    async def _aget_statistics_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/statistics',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetStatistics(BaseApi):
    ...
    async def aget_statistics(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StatisticsRootPydantic:
        raw_response = await self.raw.aget_statistics(
            **kwargs,
        )
        if validate:
            return StatisticsRootPydantic(**raw_response.body)
        return api_client.construct_model_instance(StatisticsRootPydantic, raw_response.body)
