...
from launch_darkly_python_sdk.model.user_attribute_names_rep import UserAttributeNamesRep as UserAttributeNamesRepSchema
...
from launch_darkly_python_sdk.type.user_attribute_names_rep import UserAttributeNamesRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.user_attribute_names_rep import UserAttributeNamesRep as UserAttributeNamesRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserAttributeNamesRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserAttributeNamesRep
...
class BaseApi(api_client.Api):
    ...
    def _get_all_in_use_user_attributes_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_all_in_use_user_attributes_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/user-attributes/{projectKey}/{environmentKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_all_in_use_user_attributes_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllInUseUserAttributesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="users_(beta)")
    async def aget_all_in_use_user_attributes(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._get_all_in_use_user_attributes_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._aget_all_in_use_user_attributes_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="users_(beta)")
    def get_all_in_use_user_attributes(
        self,
        project_key: str,
        environment_key: str,
    ) -> typing.Union[
        ...
        return self._get_all_in_use_user_attributes_oapg(
            path_params=args.path,
        )

class GetAllInUseUserAttributes(BaseApi):
    ...
    async def aget_all_in_use_user_attributes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserAttributeNamesRepPydantic:
        raw_response = await self.raw.aget_all_in_use_user_attributes(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
        if validate:
            return UserAttributeNamesRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserAttributeNamesRepPydantic, raw_response.body)
    ...
    def get_all_in_use_user_attributes(
        ...
        raw_response = self.raw.get_all_in_use_user_attributes(
            project_key=project_key,
            environment_key=environment_key,
        )
        if validate:
