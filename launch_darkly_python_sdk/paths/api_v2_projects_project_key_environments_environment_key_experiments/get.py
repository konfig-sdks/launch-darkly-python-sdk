...
from launch_darkly_python_sdk.model.experiment_collection_rep import ExperimentCollectionRep as ExperimentCollectionRepSchema

from launch_darkly_python_sdk.type.experiment_collection_rep import ExperimentCollectionRep
...
from launch_darkly_python_sdk.pydantic.experiment_collection_rep import ExperimentCollectionRep as ExperimentCollectionRepPydantic
...
LifecycleStateSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'lifecycleState': typing.Union[LifecycleStateSchema, str, ],
    },
    total=False
)
...
request_query_lifecycle_state = api_client.QueryParameter(
    name="lifecycleState",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = ExperimentCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExperimentCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_experiments_in_environment_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        ...
        lifecycle_state: typing.Optional[str] = None,
        ...
        if lifecycle_state is not None:
            _query_params["lifecycleState"] = lifecycle_state
    ...
    async def _alist_experiments_in_environment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/experiments',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_experiments_in_environment_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListExperimentsInEnvironmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_experiments_in_environment(
        self,
        project_key: str,
        environment_key: str,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_experiments_in_environment_mapped_args(
        ...
        return await self._alist_experiments_in_environment_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_experiments_in_environment(
        self,
        project_key: str,
        environment_key: str,
        limit: typing.Optional[int] = None,
        ...
        return self._list_experiments_in_environment_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListExperimentsInEnvironment(BaseApi):
    ...
    async def alist_experiments_in_environment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExperimentCollectionRepPydantic:
        raw_response = await self.raw.alist_experiments_in_environment(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return ExperimentCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ExperimentCollectionRepPydantic, raw_response.body)
    ...
    def list_experiments_in_environment(
        ...
        raw_response = self.raw.list_experiments_in_environment(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            offset=offset,
