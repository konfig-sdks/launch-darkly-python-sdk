...
from launch_darkly_python_sdk.model.experiment_post import ExperimentPost as ExperimentPostSchema
...
from launch_darkly_python_sdk.type.experiment_post import ExperimentPost
...
from launch_darkly_python_sdk.pydantic.experiment_post import ExperimentPost as ExperimentPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ExperimentPostSchema


request_body_experiment_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ExperimentSchema
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_new_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_experiment_post.serialize(body, content_type)
