...
from launch_darkly_python_sdk.model.audit_log_entry_rep import AuditLogEntryRep as AuditLogEntryRepSchema
...
from launch_darkly_python_sdk.type.audit_log_entry_rep import AuditLogEntryRep
...
from launch_darkly_python_sdk.pydantic.audit_log_entry_rep import AuditLogEntryRep as AuditLogEntryRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = AuditLogEntryRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AuditLogEntryRep
    ...
    async def _adetail_entry_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/auditlog/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DetailEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adetail_entry(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._detail_entry_mapped_args(
            id=id,
        )
        return await self._adetail_entry_oapg(
    ...
    def detail_entry(
        ...
        return self._detail_entry_oapg(
            path_params=args.path,
        )

class DetailEntry(BaseApi):
    ...
    async def adetail_entry(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AuditLogEntryRepPydantic:
        raw_response = await self.raw.adetail_entry(
            id=id,
            **kwargs,
        )
        if validate:
            return AuditLogEntryRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(AuditLogEntryRepPydantic, raw_response.body)
    ...
    def detail_entry(
        ...
        raw_response = self.raw.detail_entry(
            id=id,
        )
        if validate:
            return AuditLogEntryRepPydantic(**raw_response.body)
