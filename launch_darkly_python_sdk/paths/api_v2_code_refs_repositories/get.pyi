...
from launch_darkly_python_sdk.model.repository_collection_rep import RepositoryCollectionRep as RepositoryCollectionRepSchema
...
from launch_darkly_python_sdk.type.repository_collection_rep import RepositoryCollectionRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.repository_collection_rep import RepositoryCollectionRep as RepositoryCollectionRepPydantic
...
# Query params
WithBranchesSchema = schemas.StrSchema
WithReferencesForDefaultBranchSchema = schemas.StrSchema
ProjKeySchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'withBranches': typing.Union[WithBranchesSchema, str, ],
        'withReferencesForDefaultBranch': typing.Union[WithReferencesForDefaultBranchSchema, str, ],
        'projKey': typing.Union[ProjKeySchema, str, ],
...
request_query_with_branches = api_client.QueryParameter(
    name="withBranches",
    style=api_client.ParameterStyle.FORM,
    schema=WithBranchesSchema,
    explode=True,
)
request_query_with_references_for_default_branch = api_client.QueryParameter(
    name="withReferencesForDefaultBranch",
    style=api_client.ParameterStyle.FORM,
    schema=WithReferencesForDefaultBranchSchema,
    explode=True,
)
request_query_proj_key = api_client.QueryParameter(
    name="projKey",
    style=api_client.ParameterStyle.FORM,
    schema=ProjKeySchema,
    explode=True,
)
request_query_flag_key = api_client.QueryParameter(
    name="flagKey",
    style=api_client.ParameterStyle.FORM,
    schema=FlagKeySchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = RepositoryCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RepositoryCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_repositories_mapped_args(
        self,
        with_branches: typing.Optional[str] = None,
        with_references_for_default_branch: typing.Optional[str] = None,
        proj_key: typing.Optional[str] = None,
        flag_key: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        if with_branches is not None:
            _query_params["withBranches"] = with_branches
        if with_references_for_default_branch is not None:
            _query_params["withReferencesForDefaultBranch"] = with_references_for_default_branch
        if proj_key is not None:
            _query_params["projKey"] = proj_key
        if flag_key is not None:
            _query_params["flagKey"] = flag_key
        args.query = _query_params
        return args

    async def _alist_repositories_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_with_branches,
            request_query_with_references_for_default_branch,
            request_query_proj_key,
            request_query_flag_key,
        ):
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/repositories',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListRepositoriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_repositories(
        self,
        with_branches: typing.Optional[str] = None,
        with_references_for_default_branch: typing.Optional[str] = None,
        proj_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_repositories_mapped_args(
            with_branches=with_branches,
            with_references_for_default_branch=with_references_for_default_branch,
            proj_key=proj_key,
            flag_key=flag_key,
        )
        return await self._alist_repositories_oapg(
    ...
    def list_repositories(
        ...
        return self._list_repositories_oapg(
            query_params=args.query,
        )

class ListRepositories(BaseApi):
    ...
    async def alist_repositories(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RepositoryCollectionRepPydantic:
        raw_response = await self.raw.alist_repositories(
            with_branches=with_branches,
            with_references_for_default_branch=with_references_for_default_branch,
            proj_key=proj_key,
            flag_key=flag_key,
        ...
        if validate:
            return RepositoryCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(RepositoryCollectionRepPydantic, raw_response.body)
    ...
    def list_repositories(
        ...
        raw_response = self.raw.list_repositories(
            with_branches=with_branches,
            with_references_for_default_branch=with_references_for_default_branch,
            proj_key=proj_key,
            flag_key=flag_key,
