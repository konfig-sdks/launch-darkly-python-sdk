...
from launch_darkly_python_sdk.model.repository_rep import RepositoryRep as RepositoryRepSchema
...
from launch_darkly_python_sdk.model.repository_post import RepositoryPost as RepositoryPostSchema

from launch_darkly_python_sdk.type.repository_rep import RepositoryRep
...
from launch_darkly_python_sdk.type.repository_post import RepositoryPost
...
from launch_darkly_python_sdk.pydantic.repository_post import RepositoryPost as RepositoryPostPydantic
...
from launch_darkly_python_sdk.pydantic.repository_rep import RepositoryRep as RepositoryRepPydantic
...
# body param
SchemaForRequestBodyApplicationJson = RepositoryPostSchema


request_body_repository_post = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RepositoryRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_repository_mapped_args(
        self,
        name: str,
        source_link: typing.Optional[str] = None,
        commit_url_template: typing.Optional[str] = None,
        hunk_url_template: typing.Optional[str] = None,
        ...
        if source_link is not None:
            _body["sourceLink"] = source_link
        if commit_url_template is not None:
            _body["commitUrlTemplate"] = commit_url_template
        if hunk_url_template is not None:
            _body["hunkUrlTemplate"] = hunk_url_template
        if type is not None:
            _body["type"] = type
        if default_branch is not None:
            _body["defaultBranch"] = default_branch
        args.body = _body
        return args

    async def _acreate_repository_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_repository_post.serialize(body, content_type)
...
class CreateRepositoryRaw(BaseApi):
    ...
    async def acreate_repository(
        ...
        **kwargs,
        ...
        args = self._create_repository_mapped_args(
            name=name,
            source_link=source_link,
            commit_url_template=commit_url_template,
            hunk_url_template=hunk_url_template,
            type=type,
            default_branch=default_branch,
        )
        return await self._acreate_repository_oapg(
            body=args.body,
            **kwargs,
        )
...
class CreateRepository(BaseApi):
    ...
    async def acreate_repository(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RepositoryRepPydantic:
        raw_response = await self.raw.acreate_repository(
            name=name,
            source_link=source_link,
            commit_url_template=commit_url_template,
            hunk_url_template=hunk_url_template,
        ...
        if validate:
            return RepositoryRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(RepositoryRepPydantic, raw_response.body)
    ...
    def create_repository(
        ...
        raw_response = self.raw.create_repository(
            name=name,
            source_link=source_link,
            commit_url_template=commit_url_template,
            hunk_url_template=hunk_url_template,
