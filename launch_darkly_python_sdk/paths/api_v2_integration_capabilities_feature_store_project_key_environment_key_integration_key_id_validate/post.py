...
from launch_darkly_python_sdk.model.integration_delivery_configuration_response import IntegrationDeliveryConfigurationResponse as IntegrationDeliveryConfigurationResponseSchema
...
from launch_darkly_python_sdk.type.integration_delivery_configuration_response import IntegrationDeliveryConfigurationResponse
...
from launch_darkly_python_sdk.pydantic.integration_delivery_configuration_response import IntegrationDeliveryConfigurationResponse as IntegrationDeliveryConfigurationResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = IntegrationDeliveryConfigurationResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: IntegrationDeliveryConfigurationResponse
...
class BaseApi(api_client.Api):
    ...
    def _validate_delivery_configuration_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
    ...
    async def _avalidate_delivery_configuration_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}/{integrationKey}/{id}/validate',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _validate_delivery_configuration_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ValidateDeliveryConfigurationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avalidate_delivery_configuration(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
        ...
        **kwargs,
        ...
        args = self._validate_delivery_configuration_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            id=id,
        )
        return await self._avalidate_delivery_configuration_oapg(
    ...
    def validate_delivery_configuration(
        ...
        return self._validate_delivery_configuration_oapg(
            path_params=args.path,
        )

class ValidateDeliveryConfiguration(BaseApi):
    ...
    async def avalidate_delivery_configuration(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IntegrationDeliveryConfigurationResponsePydantic:
        raw_response = await self.raw.avalidate_delivery_configuration(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            id=id,
        ...
        if validate:
            return IntegrationDeliveryConfigurationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationDeliveryConfigurationResponsePydantic, raw_response.body)
    ...
    def validate_delivery_configuration(
        ...
        raw_response = self.raw.validate_delivery_configuration(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            id=id,
