...
from launch_darkly_python_sdk.model.experiment_results import ExperimentResults as ExperimentResultsSchema
...
from launch_darkly_python_sdk.type.experiment_results import ExperimentResults
...
from launch_darkly_python_sdk.pydantic.experiment_results import ExperimentResults as ExperimentResultsPydantic
...
SchemaFor200ResponseBodyApplicationJson = ExperimentResultsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExperimentResults
...
class BaseApi(api_client.Api):
    ...
    def _get_legacy_experiment_results_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_legacy_experiment_results_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{featureFlagKey}/experiments/{environmentKey}/{metricKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_legacy_experiment_results_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetLegacyExperimentResultsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="experiments_(beta)")
    async def aget_legacy_experiment_results(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_legacy_experiment_results_mapped_args(
        ...
        return await self._aget_legacy_experiment_results_oapg(
    ...
    def get_legacy_experiment_results(
        ...
        return self._get_legacy_experiment_results_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetLegacyExperimentResults(BaseApi):
    ...
    async def aget_legacy_experiment_results(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExperimentResultsPydantic:
        raw_response = await self.raw.aget_legacy_experiment_results(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            metric_key=metric_key,
        ...
        if validate:
            return ExperimentResultsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ExperimentResultsPydantic, raw_response.body)
    ...
    def get_legacy_experiment_results(
        ...
        raw_response = self.raw.get_legacy_experiment_results(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            metric_key=metric_key,
