...
from launch_darkly_python_sdk.model.context_attribute_names_collection import ContextAttributeNamesCollection as ContextAttributeNamesCollectionSchema
...
from launch_darkly_python_sdk.type.context_attribute_names_collection import ContextAttributeNamesCollection

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.context_attribute_names_collection import ContextAttributeNamesCollection as ContextAttributeNamesCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = ContextAttributeNamesCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContextAttributeNamesCollection
...
class BaseApi(api_client.Api):
    ...
    def _get_attribute_names_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_attribute_names_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/context-attributes',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAttributeNamesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_attribute_names(
        self,
        project_key: str,
        environment_key: str,
        filter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_attribute_names_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
        )
        return await self._aget_attribute_names_oapg(
    ...
    def get_attribute_names(
        ...
        return self._get_attribute_names_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAttributeNames(BaseApi):
    ...
    async def aget_attribute_names(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContextAttributeNamesCollectionPydantic:
        raw_response = await self.raw.aget_attribute_names(
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
            **kwargs,
        ...
        if validate:
            return ContextAttributeNamesCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContextAttributeNamesCollectionPydantic, raw_response.body)
    ...
    def get_attribute_names(
        ...
        raw_response = self.raw.get_attribute_names(
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
        )
