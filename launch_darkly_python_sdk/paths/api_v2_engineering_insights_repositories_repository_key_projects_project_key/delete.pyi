...
# Path params
RepositoryKeySchema = schemas.StrSchema
ProjectKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'repositoryKey': typing.Union[RepositoryKeySchema, str, ],
...
request_path_repository_key = api_client.PathParameter(
    name="repositoryKey",
...
class BaseApi(api_client.Api):
    ...
    def _remove_repository_project_association_mapped_args(
        self,
        repository_key: str,
        project_key: str,
        ...
        if repository_key is not None:
            _path_params["repositoryKey"] = repository_key
        if project_key is not None:
            _path_params["projectKey"] = project_key
        args.path = _path_params
        return args

    async def _aremove_repository_project_association_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/repositories/{repositoryKey}/projects/{projectKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_repository_project_association_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveRepositoryProjectAssociationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_repository_project_association(
        self,
        repository_key: str,
        project_key: str,
        **kwargs,
        ...
        args = self._remove_repository_project_association_mapped_args(
            repository_key=repository_key,
            project_key=project_key,
        )
        return await self._aremove_repository_project_association_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_repository_project_association(
        self,
        repository_key: str,
        project_key: str,
    ) -> typing.Union[
        ...
        return self._remove_repository_project_association_oapg(
            path_params=args.path,
        )

class RemoveRepositoryProjectAssociation(BaseApi):
    ...
    async def aremove_repository_project_association(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_repository_project_association(
            repository_key=repository_key,
            project_key=project_key,
            **kwargs,
        )
    ...
    def remove_repository_project_association(
        ...
        raw_response = self.raw.remove_repository_project_association(
            repository_key=repository_key,
            project_key=project_key,
        )
