...
from launch_darkly_python_sdk.model.teams_add_multiple_members_to_team_request import TeamsAddMultipleMembersToTeamRequest as TeamsAddMultipleMembersToTeamRequestSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema
from launch_darkly_python_sdk.model.team_imports_rep import TeamImportsRep as TeamImportsRepSchema
...
from launch_darkly_python_sdk.type.teams_add_multiple_members_to_team_request import TeamsAddMultipleMembersToTeamRequest
...
from launch_darkly_python_sdk.type.team_imports_rep import TeamImportsRep
...
from launch_darkly_python_sdk.pydantic.team_imports_rep import TeamImportsRep as TeamImportsRepPydantic
from launch_darkly_python_sdk.pydantic.teams_add_multiple_members_to_team_request import TeamsAddMultipleMembersToTeamRequest as TeamsAddMultipleMembersToTeamRequestPydantic

from . import path

# Path params
TeamKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'teamKey': typing.Union[TeamKeySchema, str, ],
    }
)
...
request_path_team_key = api_client.PathParameter(
    name="teamKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TeamKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyMultipartFormData = TeamsAddMultipleMembersToTeamRequestSchema


request_body_teams_add_multiple_members_to_team_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TeamImportsRepSchema
...
SchemaFor207ResponseBodyApplicationJson = TeamImportsRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _add_multiple_members_to_team_mapped_args(
        self,
        team_key: str,
    ...
    async def _aadd_multiple_members_to_team_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/teams/{teamKey}/members',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_teams_add_multiple_members_to_team_request.serialize(body, content_type)
    ...
    def _add_multiple_members_to_team_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddMultipleMembersToTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_multiple_members_to_team(
        self,
        team_key: str,
        file: typing.Optional[typing.IO] = None,
        **kwargs,
        ...
        args = self._add_multiple_members_to_team_mapped_args(
            team_key=team_key,
            file=file,
        )
        return await self._aadd_multiple_members_to_team_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_multiple_members_to_team(
        self,
        team_key: str,
        file: typing.Optional[typing.IO] = None,
    ) -> typing.Union[
        ...
        return self._add_multiple_members_to_team_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddMultipleMembersToTeam(BaseApi):
    ...
    async def aadd_multiple_members_to_team(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamImportsRepPydantic:
        raw_response = await self.raw.aadd_multiple_members_to_team(
            team_key=team_key,
            file=file,
            **kwargs,
        )
        if validate:
            return TeamImportsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamImportsRepPydantic, raw_response.body)
    ...
    def add_multiple_members_to_team(
        ...
        raw_response = self.raw.add_multiple_members_to_team(
            team_key=team_key,
            file=file,
        )
        if validate:
