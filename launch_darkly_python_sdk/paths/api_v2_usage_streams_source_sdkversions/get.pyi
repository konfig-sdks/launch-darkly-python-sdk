...
from launch_darkly_python_sdk.model.sdk_version_list_rep import SdkVersionListRep as SdkVersionListRepSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema

from launch_darkly_python_sdk.type.sdk_version_list_rep import SdkVersionListRep
...
from launch_darkly_python_sdk.pydantic.sdk_version_list_rep import SdkVersionListRep as SdkVersionListRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = SdkVersionListRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SdkVersionListRep
...
class BaseApi(api_client.Api):
    ...
    def _list_sdk_versions_mapped_args(
        self,
        source: str,
    ...
    async def _alist_sdk_versions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/streams/{source}/sdkversions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListSdkVersionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_sdk_versions(
        self,
        source: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_sdk_versions_mapped_args(
            source=source,
        )
        return await self._alist_sdk_versions_oapg(
    ...
    def list_sdk_versions(
        ...
        return self._list_sdk_versions_oapg(
            path_params=args.path,
        )

class ListSdkVersions(BaseApi):
    ...
    async def alist_sdk_versions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SdkVersionListRepPydantic:
        raw_response = await self.raw.alist_sdk_versions(
            source=source,
            **kwargs,
        )
        if validate:
            return SdkVersionListRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(SdkVersionListRepPydantic, raw_response.body)
    ...
    def list_sdk_versions(
        ...
        raw_response = self.raw.list_sdk_versions(
            source=source,
        )
        if validate:
            return SdkVersionListRepPydantic(**raw_response.body)
