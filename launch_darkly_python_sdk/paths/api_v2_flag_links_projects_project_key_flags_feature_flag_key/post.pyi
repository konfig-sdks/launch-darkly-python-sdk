...
from launch_darkly_python_sdk.model.flag_link_post_metadata import FlagLinkPostMetadata as FlagLinkPostMetadataSchema
from launch_darkly_python_sdk.model.unauthorized_error_rep import UnauthorizedErrorRep as UnauthorizedErrorRepSchema
from launch_darkly_python_sdk.model.flag_link_post import FlagLinkPost as FlagLinkPostSchema
...
from launch_darkly_python_sdk.model.flag_link_rep import FlagLinkRep as FlagLinkRepSchema

from launch_darkly_python_sdk.type.flag_link_post import FlagLinkPost
...
from launch_darkly_python_sdk.type.flag_link_rep import FlagLinkRep
from launch_darkly_python_sdk.type.flag_link_post_metadata import FlagLinkPostMetadata

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.flag_link_post import FlagLinkPost as FlagLinkPostPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.flag_link_rep import FlagLinkRep as FlagLinkRepPydantic
...
from launch_darkly_python_sdk.pydantic.flag_link_post_metadata import FlagLinkPostMetadata as FlagLinkPostMetadataPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FlagLinkPostSchema


request_body_flag_link_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FlagLinkRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_flag_link_mapped_args(
        self,
        project_key: str,
        ...
        deep_link: typing.Optional[str] = None,
        metadata: typing.Optional[FlagLinkPostMetadata] = None,
    ...
    async def _acreate_flag_link_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_flag_link_post.serialize(body, content_type)
...
class CreateFlagLinkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_flag_link(
        self,
        project_key: str,
        feature_flag_key: str,
        title: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_flag_link_mapped_args(
        ...
        return await self._acreate_flag_link_oapg(
            body=args.body,
    ...
    def create_flag_link(
        ...
        return self._create_flag_link_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateFlagLink(BaseApi):
    ...
    async def acreate_flag_link(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_flag_link(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            title=title,
            description=description,
        ...
        if validate:
            return FlagLinkRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagLinkRepPydantic, raw_response.body)
    ...
    def create_flag_link(
        ...
        raw_response = self.raw.create_flag_link(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            title=title,
            description=description,
