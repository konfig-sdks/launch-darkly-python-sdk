...
from launch_darkly_python_sdk.model.flag_link_collection_rep import FlagLinkCollectionRep as FlagLinkCollectionRepSchema
...
from launch_darkly_python_sdk.type.flag_link_collection_rep import FlagLinkCollectionRep
...
from launch_darkly_python_sdk.pydantic.flag_link_collection_rep import FlagLinkCollectionRep as FlagLinkCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = FlagLinkCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FlagLinkCollectionRep
...
class ListLinksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_links(
        self,
        project_key: str,
        feature_flag_key: str,
        **kwargs,
        ...
        args = self._list_links_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
        )
        return await self._alist_links_oapg(
    ...
    def list_links(
        ...
        return self._list_links_oapg(
            path_params=args.path,
        )

class ListLinks(BaseApi):
    ...
    async def alist_links(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FlagLinkCollectionRepPydantic:
        raw_response = await self.raw.alist_links(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            **kwargs,
        )
        if validate:
            return FlagLinkCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagLinkCollectionRepPydantic, raw_response.body)
    ...
    def list_links(
        ...
        raw_response = self.raw.list_links(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
        )
        if validate:
