...
from launch_darkly_python_sdk.model.feature_flag_status_across_environments import FeatureFlagStatusAcrossEnvironments as FeatureFlagStatusAcrossEnvironmentsSchema

from launch_darkly_python_sdk.type.feature_flag_status_across_environments import FeatureFlagStatusAcrossEnvironments
...
from launch_darkly_python_sdk.pydantic.feature_flag_status_across_environments import FeatureFlagStatusAcrossEnvironments as FeatureFlagStatusAcrossEnvironmentsPydantic
...
request_query_env = api_client.QueryParameter(
    name="env",
...
SchemaFor200ResponseBodyApplicationJson = FeatureFlagStatusAcrossEnvironmentsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeatureFlagStatusAcrossEnvironments
...
class BaseApi(api_client.Api):
    ...
    def _across_environments_mapped_args(
        self,
        project_key: str,
    ...
    async def _aacross_environments_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flag-status/{projectKey}/{featureFlagKey}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class AcrossEnvironmentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aacross_environments(
        self,
        project_key: str,
        feature_flag_key: str,
        env: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._across_environments_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            env=env,
        )
        return await self._aacross_environments_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def across_environments(
        self,
        project_key: str,
        feature_flag_key: str,
        env: typing.Optional[str] = None,
        ...
        return self._across_environments_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class AcrossEnvironments(BaseApi):
    ...
    async def aacross_environments(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeatureFlagStatusAcrossEnvironmentsPydantic:
        raw_response = await self.raw.aacross_environments(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            env=env,
            **kwargs,
        ...
        if validate:
            return FeatureFlagStatusAcrossEnvironmentsPydantic(**raw_response.body)
        return api_client.construct_model_instance(FeatureFlagStatusAcrossEnvironmentsPydantic, raw_response.body)
    ...
    def across_environments(
        ...
        raw_response = self.raw.across_environments(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            env=env,
        )
