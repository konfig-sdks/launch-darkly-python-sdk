...
from launch_darkly_python_sdk.model.deployment_rep import DeploymentRep as DeploymentRepSchema
...
from launch_darkly_python_sdk.type.deployment_rep import DeploymentRep
...
from launch_darkly_python_sdk.pydantic.deployment_rep import DeploymentRep as DeploymentRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = DeploymentRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_deployment_by_id_mapped_args(
        self,
        body: JSONPatch,
        deployment_id: str,
    ...
    async def _aupdate_deployment_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/deployments/{deploymentID}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_deployment_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateDeploymentByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_deployment_by_id(
        self,
        body: JSONPatch,
        deployment_id: str,
        **kwargs,
        ...
        args = self._update_deployment_by_id_mapped_args(
            body=body,
            deployment_id=deployment_id,
        )
        return await self._aupdate_deployment_by_id_oapg(
            body=args.body,
    ...
    def update_deployment_by_id(
        ...
        return self._update_deployment_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDeploymentById(BaseApi):
    ...
    async def aupdate_deployment_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeploymentRepPydantic:
        raw_response = await self.raw.aupdate_deployment_by_id(
            body=body,
            deployment_id=deployment_id,
            **kwargs,
        )
        if validate:
            return DeploymentRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(DeploymentRepPydantic, raw_response.body)
    ...
    def update_deployment_by_id(
        ...
        raw_response = self.raw.update_deployment_by_id(
            body=body,
            deployment_id=deployment_id,
        )
        if validate:
