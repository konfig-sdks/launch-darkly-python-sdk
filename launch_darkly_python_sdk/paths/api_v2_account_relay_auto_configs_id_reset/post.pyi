...
class BaseApi(api_client.Api):
    ...
    def _reset_secret_key_with_expiry_mapped_args(
        self,
        id: str,
    ...
    async def _areset_secret_key_with_expiry_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/account/relay-auto-configs/{id}/reset',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _reset_secret_key_with_expiry_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ResetSecretKeyWithExpiryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_secret_key_with_expiry(
        self,
        id: str,
        expiry: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._reset_secret_key_with_expiry_mapped_args(
            id=id,
            expiry=expiry,
        )
        return await self._areset_secret_key_with_expiry_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def reset_secret_key_with_expiry(
        self,
        id: str,
        expiry: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        return self._reset_secret_key_with_expiry_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ResetSecretKeyWithExpiry(BaseApi):
    ...
    async def areset_secret_key_with_expiry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areset_secret_key_with_expiry(
            id=id,
            expiry=expiry,
            **kwargs,
        )
    ...
    def reset_secret_key_with_expiry(
        ...
        raw_response = self.raw.reset_secret_key_with_expiry(
            id=id,
            expiry=expiry,
        )
        if validate:
