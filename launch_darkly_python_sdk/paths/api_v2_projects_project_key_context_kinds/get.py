...
from launch_darkly_python_sdk.model.context_kinds_collection_rep import ContextKindsCollectionRep as ContextKindsCollectionRepSchema
...
from launch_darkly_python_sdk.type.context_kinds_collection_rep import ContextKindsCollectionRep
...
from launch_darkly_python_sdk.pydantic.context_kinds_collection_rep import ContextKindsCollectionRep as ContextKindsCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = ContextKindsCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContextKindsCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_context_kinds_by_project_mapped_args(
        self,
        project_key: str,
    ...
    async def _alist_context_kinds_by_project_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/context-kinds',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_context_kinds_by_project_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListContextKindsByProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_context_kinds_by_project(
        self,
        project_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_context_kinds_by_project_mapped_args(
            project_key=project_key,
        )
        return await self._alist_context_kinds_by_project_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_context_kinds_by_project(
        self,
        project_key: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._list_context_kinds_by_project_oapg(
            path_params=args.path,
        )

class ListContextKindsByProject(BaseApi):
    ...
    async def alist_context_kinds_by_project(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContextKindsCollectionRepPydantic:
        raw_response = await self.raw.alist_context_kinds_by_project(
            project_key=project_key,
            **kwargs,
        )
        if validate:
            return ContextKindsCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContextKindsCollectionRepPydantic, raw_response.body)
    ...
    def list_context_kinds_by_project(
        ...
        raw_response = self.raw.list_context_kinds_by_project(
            project_key=project_key,
        )
        if validate:
            return ContextKindsCollectionRepPydantic(**raw_response.body)
