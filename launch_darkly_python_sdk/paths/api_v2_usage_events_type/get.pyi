...
class BaseApi(api_client.Api):
    ...
    def _get_events_usage_data_mapped_args(
        self,
        type: str,
    ...
    async def _aget_events_usage_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/events/{type}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_events_usage_data_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetEventsUsageDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_events_usage_data(
        self,
        type: str,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_events_usage_data_mapped_args(
            type=type,
            _from=_from,
            to=to,
        )
        return await self._aget_events_usage_data_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_events_usage_data(
        self,
        type: str,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        ...
        return self._get_events_usage_data_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetEventsUsageData(BaseApi):
    ...
    async def aget_events_usage_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_events_usage_data(
            type=type,
            _from=_from,
            to=to,
            **kwargs,
    ...
    def get_events_usage_data(
        ...
        raw_response = self.raw.get_events_usage_data(
            type=type,
            _from=_from,
            to=to,
        )
