...
from launch_darkly_python_sdk.model.post_approval_request_apply_request import PostApprovalRequestApplyRequest as PostApprovalRequestApplyRequestSchema
...
from launch_darkly_python_sdk.type.post_approval_request_apply_request import PostApprovalRequestApplyRequest
...
from launch_darkly_python_sdk.pydantic.post_approval_request_apply_request import PostApprovalRequestApplyRequest as PostApprovalRequestApplyRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostApprovalRequestApplyRequestSchema


request_body_post_approval_request_apply_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _apply_request_flag_0_mapped_args(
        self,
        project_key: str,
    ...
    async def _aapply_request_flag_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}/apply',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_post_approval_request_apply_request.serialize(body, content_type)
    ...
    def _apply_request_flag_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ApplyRequestFlag0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aapply_request_flag_0(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._apply_request_flag_0_mapped_args(
        ...
        return await self._aapply_request_flag_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def apply_request_flag_0(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        return self._apply_request_flag_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class ApplyRequestFlag0(BaseApi):
    ...
    async def aapply_request_flag_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aapply_request_flag_0(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    def apply_request_flag_0(
        ...
        raw_response = self.raw.apply_request_flag_0(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
