...
from launch_darkly_python_sdk.model.insight_scores import InsightScores as InsightScoresSchema
...
from launch_darkly_python_sdk.type.insight_scores import InsightScores
...
from launch_darkly_python_sdk.pydantic.insight_scores import InsightScores as InsightScoresPydantic
...
SchemaFor200ResponseBodyApplicationJson = InsightScoresSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_insight_scores_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_insight_scores_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/insights/scores',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetInsightScoresRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_insight_scores(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_insight_scores_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
        )
        return await self._aget_insight_scores_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_insight_scores(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        ...
        return self._get_insight_scores_oapg(
            query_params=args.query,
        )

class GetInsightScores(BaseApi):
    ...
    async def aget_insight_scores(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InsightScoresPydantic:
        raw_response = await self.raw.aget_insight_scores(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            **kwargs,
        ...
        if validate:
            return InsightScoresPydantic(**raw_response.body)
        return api_client.construct_model_instance(InsightScoresPydantic, raw_response.body)
    ...
    def get_insight_scores(
        ...
        raw_response = self.raw.get_insight_scores(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
        )
