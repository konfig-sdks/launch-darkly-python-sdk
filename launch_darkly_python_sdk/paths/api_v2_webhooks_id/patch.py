...
class BaseApi(api_client.Api):
    ...
    def _update_settings_patch_mapped_args(
        self,
        body: JSONPatch,
        id: str,
    ...
    async def _aupdate_settings_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/webhooks/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_settings_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSettingsPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_settings_patch(
        self,
        body: JSONPatch,
        id: str,
        **kwargs,
        ...
        args = self._update_settings_patch_mapped_args(
            body=body,
            id=id,
        )
        return await self._aupdate_settings_patch_oapg(
            body=args.body,
    ...
    def update_settings_patch(
        ...
        return self._update_settings_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSettingsPatch(BaseApi):
    ...
    async def aupdate_settings_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_settings_patch(
            body=body,
            id=id,
            **kwargs,
        )
    ...
    def update_settings_patch(
        ...
        raw_response = self.raw.update_settings_patch(
            body=body,
            id=id,
        )
        if validate:
