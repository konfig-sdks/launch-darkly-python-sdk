...
from launch_darkly_python_sdk.model.users_rep import UsersRep as UsersRepSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema

from launch_darkly_python_sdk.type.users_rep import UsersRep
...
from launch_darkly_python_sdk.pydantic.users_rep import UsersRep as UsersRepPydantic
...
SearchAfterSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'searchAfter': typing.Union[SearchAfterSchema, str, ],
    },
    total=False
)
...
request_query_search_after = api_client.QueryParameter(
    name="searchAfter",
    style=api_client.ParameterStyle.FORM,
    schema=SearchAfterSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = UsersRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_environment_users_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        ...
        if search_after is not None:
            _query_params["searchAfter"] = search_after
    ...
    async def _alist_environment_users_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/users/{projectKey}/{environmentKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_environment_users_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListEnvironmentUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="users")
    async def alist_environment_users(
        self,
        project_key: str,
        environment_key: str,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_environment_users_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            search_after=search_after,
        )
        return await self._alist_environment_users_oapg(
    ...
    def list_environment_users(
        ...
        return self._list_environment_users_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListEnvironmentUsers(BaseApi):
    ...
    async def alist_environment_users(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_environment_users(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            search_after=search_after,
        ...
        if validate:
            return UsersRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(UsersRepPydantic, raw_response.body)
    ...
    def list_environment_users(
        ...
        raw_response = self.raw.list_environment_users(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            search_after=search_after,
