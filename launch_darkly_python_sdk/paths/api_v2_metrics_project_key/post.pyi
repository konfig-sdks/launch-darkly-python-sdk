...
from launch_darkly_python_sdk.model.metric_rep import MetricRep as MetricRepSchema
from launch_darkly_python_sdk.model.metric_post import MetricPost as MetricPostSchema
...
from launch_darkly_python_sdk.model.metric_post_randomization_units import MetricPostRandomizationUnits as MetricPostRandomizationUnitsSchema
from launch_darkly_python_sdk.model.unauthorized_error_rep import UnauthorizedErrorRep as UnauthorizedErrorRepSchema
from launch_darkly_python_sdk.model.metric_post_tags import MetricPostTags as MetricPostTagsSchema
...
from launch_darkly_python_sdk.model.url_post import UrlPost as UrlPostSchema

from launch_darkly_python_sdk.type.metric_post import MetricPost
from launch_darkly_python_sdk.type.metric_post_randomization_units import MetricPostRandomizationUnits
from launch_darkly_python_sdk.type.metric_rep import MetricRep
...
from launch_darkly_python_sdk.type.metric_post_tags import MetricPostTags
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep
from launch_darkly_python_sdk.type.url_post import UrlPost
...
from launch_darkly_python_sdk.pydantic.metric_post_randomization_units import MetricPostRandomizationUnits as MetricPostRandomizationUnitsPydantic
from launch_darkly_python_sdk.pydantic.metric_post_tags import MetricPostTags as MetricPostTagsPydantic
from launch_darkly_python_sdk.pydantic.metric_rep import MetricRep as MetricRepPydantic
from launch_darkly_python_sdk.pydantic.metric_post import MetricPost as MetricPostPydantic
...
from launch_darkly_python_sdk.pydantic.url_post import UrlPost as UrlPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MetricPostSchema


request_body_metric_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MetricRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_metric_mapped_args(
        ...
        kind: str,
        project_key: str,
        tags: typing.Optional[MetricPostTags] = None,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        selector: typing.Optional[str] = None,
        urls: typing.Optional[typing.List[UrlPost]] = None,
        is_active: typing.Optional[bool] = None,
        is_numeric: typing.Optional[bool] = None,
        unit: typing.Optional[str] = None,
        event_key: typing.Optional[str] = None,
        success_criteria: typing.Optional[str] = None,
        randomization_units: typing.Optional[MetricPostRandomizationUnits] = None,
        unit_aggregation_type: typing.Optional[str] = None,
        ...
        if is_numeric is not None:
            _body["isNumeric"] = is_numeric
        if unit is not None:
            _body["unit"] = unit
        if event_key is not None:
            _body["eventKey"] = event_key
        if success_criteria is not None:
            _body["successCriteria"] = success_criteria
        if randomization_units is not None:
            _body["randomizationUnits"] = randomization_units
        if unit_aggregation_type is not None:
            _body["unitAggregationType"] = unit_aggregation_type
        args.body = _body
    ...
    async def _acreate_new_metric_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/metrics/{projectKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_metric_post.serialize(body, content_type)
...
class CreateNewMetric(BaseApi):
    ...
    async def acreate_new_metric(
        ...
        **kwargs,
        ...
        if validate:
            return MetricRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(MetricRepPydantic, raw_response.body)
