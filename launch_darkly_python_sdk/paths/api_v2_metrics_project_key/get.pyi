...
from launch_darkly_python_sdk.model.metric_collection_rep import MetricCollectionRep as MetricCollectionRepSchema
...
from launch_darkly_python_sdk.type.metric_collection_rep import MetricCollectionRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.metric_collection_rep import MetricCollectionRep as MetricCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = MetricCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MetricCollectionRep
...
class ListForProject(BaseApi):
    ...
    async def alist_for_project(
        ...
        **kwargs,
        ...
        if validate:
            return MetricCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(MetricCollectionRepPydantic, raw_response.body)
