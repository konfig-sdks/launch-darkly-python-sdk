...
from launch_darkly_python_sdk.model.members import Members as MembersSchema
...
from launch_darkly_python_sdk.model.new_member_form_list_post import NewMemberFormListPost as NewMemberFormListPostSchema

from launch_darkly_python_sdk.type.new_member_form_list_post import NewMemberFormListPost
...
from launch_darkly_python_sdk.type.members import Members
...
from launch_darkly_python_sdk.pydantic.members import Members as MembersPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.new_member_form_list_post import NewMemberFormListPost as NewMemberFormListPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = NewMemberFormListPostSchema


request_body_new_member_form_list_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MembersSchema
...
class BaseApi(api_client.Api):
    ...
    def _invite_new_members_mapped_args(
        self,
    ...
    async def _ainvite_new_members_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_new_member_form_list_post.serialize(body, content_type)
...
class InviteNewMembersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvite_new_members(
        self,
        body: NewMemberFormListPost,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._invite_new_members_mapped_args(
            body=body,
        )
        return await self._ainvite_new_members_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def invite_new_members(
        ...
        return self._invite_new_members_oapg(
            body=args.body,
        )

class InviteNewMembers(BaseApi):
    ...
    async def ainvite_new_members(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainvite_new_members(
            body=body,
            **kwargs,
        )
        if validate:
            return MembersPydantic(**raw_response.body)
        return api_client.construct_model_instance(MembersPydantic, raw_response.body)
    ...
    def invite_new_members(
        ...
        raw_response = self.raw.invite_new_members(
            body=body,
        )
        if validate:
            return MembersPydantic(**raw_response.body)
