...
from launch_darkly_python_sdk.model.members_patch_input import MembersPatchInput as MembersPatchInputSchema
...
from launch_darkly_python_sdk.model.bulk_edit_members_rep import BulkEditMembersRep as BulkEditMembersRepSchema
...
from launch_darkly_python_sdk.type.bulk_edit_members_rep import BulkEditMembersRep
...
from launch_darkly_python_sdk.type.members_patch_input import MembersPatchInput
...
from launch_darkly_python_sdk.pydantic.bulk_edit_members_rep import BulkEditMembersRep as BulkEditMembersRepPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.members_patch_input import MembersPatchInput as MembersPatchInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MembersPatchInputSchema


request_body_members_patch_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BulkEditMembersRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BulkEditMembersRep
...
class BaseApi(api_client.Api):
    ...
    def _modify_members_roles_mapped_args(
        self,
    ...
    async def _amodify_members_roles_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/members',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_members_patch_input.serialize(body, content_type)
    ...
    def _modify_members_roles_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ModifyMembersRolesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amodify_members_roles(
        self,
        instructions: Instructions,
        comment: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._modify_members_roles_mapped_args(
            instructions=instructions,
            comment=comment,
        )
        return await self._amodify_members_roles_oapg(
            body=args.body,
            **kwargs,
        )
    
    def modify_members_roles(
        self,
        instructions: Instructions,
        comment: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._modify_members_roles_oapg(
            body=args.body,
        )

class ModifyMembersRoles(BaseApi):
    ...
    async def amodify_members_roles(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BulkEditMembersRepPydantic:
        raw_response = await self.raw.amodify_members_roles(
            instructions=instructions,
            comment=comment,
            **kwargs,
        )
        if validate:
            return BulkEditMembersRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(BulkEditMembersRepPydantic, raw_response.body)
    ...
    def modify_members_roles(
        ...
        raw_response = self.raw.modify_members_roles(
            instructions=instructions,
            comment=comment,
        )
        if validate:
