...
from launch_darkly_python_sdk.model.big_segment_store_integration_collection import BigSegmentStoreIntegrationCollection as BigSegmentStoreIntegrationCollectionSchema
...
from launch_darkly_python_sdk.type.big_segment_store_integration_collection import BigSegmentStoreIntegrationCollection
...
from launch_darkly_python_sdk.pydantic.big_segment_store_integration_collection import BigSegmentStoreIntegrationCollection as BigSegmentStoreIntegrationCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = BigSegmentStoreIntegrationCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BigSegmentStoreIntegrationCollection
...
class BaseApi(api_client.Api):
    ...
    def _list_big_segment_store_integrations_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_big_segment_store_integrations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/big-segment-store',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_big_segment_store_integrations_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ListBigSegmentStoreIntegrationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_big_segment_store_integrations(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_big_segment_store_integrations_mapped_args(
        )
        return await self._alist_big_segment_store_integrations_oapg(
            **kwargs,
        )
    
    def list_big_segment_store_integrations(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._list_big_segment_store_integrations_oapg(
        )

class ListBigSegmentStoreIntegrations(BaseApi):

    async def alist_big_segment_store_integrations(
        self,
        validate: bool = False,
        **kwargs,
    ) -> BigSegmentStoreIntegrationCollectionPydantic:
        raw_response = await self.raw.alist_big_segment_store_integrations(
            **kwargs,
        )
        if validate:
            return BigSegmentStoreIntegrationCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(BigSegmentStoreIntegrationCollectionPydantic, raw_response.body)
    ...
    def list_big_segment_store_integrations(
        ...
        raw_response = self.raw.list_big_segment_store_integrations(
        )
        if validate:
            return BigSegmentStoreIntegrationCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(BigSegmentStoreIntegrationCollectionPydantic, raw_response.body)
