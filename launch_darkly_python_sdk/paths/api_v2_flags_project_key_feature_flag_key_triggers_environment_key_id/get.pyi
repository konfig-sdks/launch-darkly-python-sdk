...
class BaseApi(api_client.Api):
    ...
    def _get_trigger_by_id_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_trigger_by_id_oapg(
        self,
...
class GetTriggerByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_trigger_by_id(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_trigger_by_id_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
        )
        return await self._aget_trigger_by_id_oapg(
    ...
    def get_trigger_by_id(
        ...
        return self._get_trigger_by_id_oapg(
            path_params=args.path,
        )

class GetTriggerById(BaseApi):
    ...
    async def aget_trigger_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_trigger_by_id(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    def get_trigger_by_id(
        ...
        raw_response = self.raw.get_trigger_by_id(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
