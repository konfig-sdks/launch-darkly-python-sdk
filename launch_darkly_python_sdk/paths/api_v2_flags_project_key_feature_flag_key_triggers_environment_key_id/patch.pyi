...
from launch_darkly_python_sdk.model.flag_trigger_input import FlagTriggerInput as FlagTriggerInputSchema
...
from launch_darkly_python_sdk.model.instruction import Instruction as InstructionSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema
from launch_darkly_python_sdk.model.trigger_workflow_rep import TriggerWorkflowRep as TriggerWorkflowRepSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema

from launch_darkly_python_sdk.type.trigger_workflow_rep import TriggerWorkflowRep
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.flag_trigger_input import FlagTriggerInput
from launch_darkly_python_sdk.type.rate_limited_error_rep import RateLimitedErrorRep
from launch_darkly_python_sdk.type.instruction import Instruction
...
from launch_darkly_python_sdk.pydantic.trigger_workflow_rep import TriggerWorkflowRep as TriggerWorkflowRepPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.instruction import Instruction as InstructionPydantic
from launch_darkly_python_sdk.pydantic.flag_trigger_input import FlagTriggerInput as FlagTriggerInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FlagTriggerInputSchema


request_body_flag_trigger_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TriggerWorkflowRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TriggerWorkflowRep
...
class BaseApi(api_client.Api):
    ...
    def _update_trigger_workflow_patch_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        ...
        instructions: typing.Optional[typing.List[Instruction]] = None,
    ...
    async def _aupdate_trigger_workflow_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_flag_trigger_input.serialize(body, content_type)
    ...
    def _update_trigger_workflow_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateTriggerWorkflowPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_trigger_workflow_patch(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        ...
        **kwargs,
        ...
        args = self._update_trigger_workflow_patch_mapped_args(
        ...
        return await self._aupdate_trigger_workflow_patch_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_trigger_workflow_patch(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        ...
        return self._update_trigger_workflow_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateTriggerWorkflowPatch(BaseApi):
    ...
    async def aupdate_trigger_workflow_patch(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TriggerWorkflowRepPydantic:
        raw_response = await self.raw.aupdate_trigger_workflow_patch(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            id=id,
        ...
        if validate:
            return TriggerWorkflowRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(TriggerWorkflowRepPydantic, raw_response.body)
    ...
    def update_trigger_workflow_patch(
        ...
        raw_response = self.raw.update_trigger_workflow_patch(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            id=id,
