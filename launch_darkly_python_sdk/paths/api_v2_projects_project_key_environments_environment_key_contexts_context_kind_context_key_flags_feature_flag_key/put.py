...
from launch_darkly_python_sdk.model.value_put import ValuePut as ValuePutSchema

from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.value_put import ValuePut
...
from launch_darkly_python_sdk.pydantic.value_put import ValuePut as ValuePutPydantic
...
ContextKindSchema = schemas.StrSchema
ContextKeySchema = schemas.StrSchema
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'contextKind': typing.Union[ContextKindSchema, str, ],
        'contextKey': typing.Union[ContextKeySchema, str, ],
...
request_path_context_kind = api_client.PathParameter(
    name="contextKind",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ContextKindSchema,
    required=True,
)
request_path_context_key = api_client.PathParameter(
    name="contextKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ContextKeySchema,
    required=True,
)
...
# body param
SchemaForRequestBodyApplicationJson = ValuePutSchema


request_body_value_put = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_settings_for_context_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        context_kind: str,
        ...
        setting: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        ...
        if context_kind is not None:
            _path_params["contextKind"] = context_kind
    ...
    async def _aupdate_settings_for_context_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_path_context_kind,
            request_path_context_key,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{contextKind}/{contextKey}/flags/{featureFlagKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_value_put.serialize(body, content_type)
    ...
    def _update_settings_for_context_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSettingsForContextRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_settings_for_context(
        self,
        project_key: str,
        environment_key: str,
        context_kind: str,
        ...
        **kwargs,
        ...
        args = self._update_settings_for_context_mapped_args(
        ...
        return await self._aupdate_settings_for_context_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_settings_for_context(
        self,
        project_key: str,
        environment_key: str,
        context_kind: str,
        ...
        return self._update_settings_for_context_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSettingsForContext(BaseApi):
    ...
    async def aupdate_settings_for_context(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_settings_for_context(
            project_key=project_key,
            environment_key=environment_key,
            context_kind=context_kind,
            context_key=context_key,
    ...
    def update_settings_for_context(
        ...
        raw_response = self.raw.update_settings_for_context(
            project_key=project_key,
            environment_key=environment_key,
            context_kind=context_kind,
            context_key=context_key,
