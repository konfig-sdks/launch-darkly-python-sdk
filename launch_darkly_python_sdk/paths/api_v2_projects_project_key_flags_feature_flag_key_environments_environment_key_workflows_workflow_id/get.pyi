...
SchemaFor200ResponseBodyApplicationJson = CustomWorkflowOutputSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_custom_workflow_by_id_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_custom_workflow_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows/{workflowId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_custom_workflow_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCustomWorkflowByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_custom_workflow_by_id(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_custom_workflow_by_id_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            workflow_id=workflow_id,
        )
        return await self._aget_custom_workflow_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_custom_workflow_by_id(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        return self._get_custom_workflow_by_id_oapg(
            path_params=args.path,
        )

class GetCustomWorkflowById(BaseApi):
    ...
    async def aget_custom_workflow_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_custom_workflow_by_id(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            workflow_id=workflow_id,
    ...
    def get_custom_workflow_by_id(
        ...
        raw_response = self.raw.get_custom_workflow_by_id(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            workflow_id=workflow_id,
