...
from launch_darkly_python_sdk.model.big_segment_target import BigSegmentTarget as BigSegmentTargetSchema
...
from launch_darkly_python_sdk.type.big_segment_target import BigSegmentTarget
...
from launch_darkly_python_sdk.pydantic.big_segment_target import BigSegmentTarget as BigSegmentTargetPydantic
...
SchemaFor200ResponseBodyApplicationJson = BigSegmentTargetSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BigSegmentTarget
...
class BaseApi(api_client.Api):
    ...
    def _get_context_membership_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aget_context_membership_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/contexts/{contextKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_context_membership_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetContextMembershipRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_context_membership(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_context_membership_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            context_key=context_key,
        )
        return await self._aget_context_membership_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_context_membership(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._get_context_membership_oapg(
            path_params=args.path,
        )

class GetContextMembership(BaseApi):
    ...
    async def aget_context_membership(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BigSegmentTargetPydantic:
        raw_response = await self.raw.aget_context_membership(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            context_key=context_key,
        ...
        if validate:
            return BigSegmentTargetPydantic(**raw_response.body)
        return api_client.construct_model_instance(BigSegmentTargetPydantic, raw_response.body)
    ...
    def get_context_membership(
        ...
        raw_response = self.raw.get_context_membership(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            context_key=context_key,
