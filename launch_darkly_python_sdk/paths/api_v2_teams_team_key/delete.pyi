...
class BaseApi(api_client.Api):
    ...
    def _remove_by_team_key_mapped_args(
        self,
        team_key: str,
    ...
    async def _aremove_by_team_key_oapg(
        self,
...
class RemoveByTeamKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_by_team_key(
        self,
        team_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_by_team_key_mapped_args(
            team_key=team_key,
        )
        return await self._aremove_by_team_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_by_team_key(
        self,
        team_key: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._remove_by_team_key_oapg(
            path_params=args.path,
        )

class RemoveByTeamKey(BaseApi):
    ...
    async def aremove_by_team_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_by_team_key(
            team_key=team_key,
            **kwargs,
        )
    ...
    def remove_by_team_key(
        ...
        raw_response = self.raw.remove_by_team_key(
            team_key=team_key,
        )
