...
class BaseApi(api_client.Api):
    ...
    def _get_by_team_key_mapped_args(
        self,
        team_key: str,
    ...
    async def _aget_by_team_key_oapg(
        self,
...
class GetByTeamKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_team_key(
        self,
        team_key: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_by_team_key_mapped_args(
            team_key=team_key,
            expand=expand,
        )
        return await self._aget_by_team_key_oapg(
    ...
    def get_by_team_key(
        ...
        return self._get_by_team_key_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByTeamKey(BaseApi):
    ...
    async def aget_by_team_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_team_key(
            team_key=team_key,
            expand=expand,
            **kwargs,
        )
    ...
    def get_by_team_key(
        ...
        raw_response = self.raw.get_by_team_key(
            team_key=team_key,
            expand=expand,
        )
        if validate:
