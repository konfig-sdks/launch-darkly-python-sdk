...
from launch_darkly_python_sdk.model.team_patch_input import TeamPatchInput as TeamPatchInputSchema

from launch_darkly_python_sdk.type.team_patch_input import TeamPatchInput
...
from launch_darkly_python_sdk.pydantic.team_patch_input import TeamPatchInput as TeamPatchInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TeamPatchInputSchema


request_body_team_patch_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_semantic_patch_mapped_args(
        self,
    ...
    async def _aupdate_semantic_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/teams/{teamKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_team_patch_input.serialize(body, content_type)
    ...
    def _update_semantic_patch_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateSemanticPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_semantic_patch(
        self,
        instructions: Instructions,
        team_key: str,
        comment: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_semantic_patch_mapped_args(
            instructions=instructions,
            team_key=team_key,
            comment=comment,
            expand=expand,
        )
        return await self._aupdate_semantic_patch_oapg(
            body=args.body,
    ...
    def update_semantic_patch(
        ...
        return self._update_semantic_patch_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateSemanticPatch(BaseApi):
    ...
    async def aupdate_semantic_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_semantic_patch(
            instructions=instructions,
            team_key=team_key,
            comment=comment,
            expand=expand,
    ...
    def update_semantic_patch(
        ...
        raw_response = self.raw.update_semantic_patch(
            instructions=instructions,
            team_key=team_key,
            comment=comment,
            expand=expand,
