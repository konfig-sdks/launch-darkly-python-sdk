...
from launch_darkly_python_sdk.model.custom_workflows_listing_output import CustomWorkflowsListingOutput as CustomWorkflowsListingOutputSchema

from launch_darkly_python_sdk.type.custom_workflows_listing_output import CustomWorkflowsListingOutput
...
from launch_darkly_python_sdk.pydantic.custom_workflows_listing_output import CustomWorkflowsListingOutput as CustomWorkflowsListingOutputPydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomWorkflowsListingOutputSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomWorkflowsListingOutput
...
class BaseApi(api_client.Api):
    ...
    def _get_feature_flag_environments_workflows_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_feature_flag_environments_workflows_oapg(
        self,
    ...
    def _get_feature_flag_environments_workflows_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetFeatureFlagEnvironmentsWorkflowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_feature_flag_environments_workflows(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_feature_flag_environments_workflows_mapped_args(
        ...
        return await self._aget_feature_flag_environments_workflows_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_feature_flag_environments_workflows(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        return self._get_feature_flag_environments_workflows_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFeatureFlagEnvironmentsWorkflows(BaseApi):
    ...
    async def aget_feature_flag_environments_workflows(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomWorkflowsListingOutputPydantic:
        raw_response = await self.raw.aget_feature_flag_environments_workflows(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            status=status,
        ...
        if validate:
            return CustomWorkflowsListingOutputPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomWorkflowsListingOutputPydantic, raw_response.body)
    ...
    def get_feature_flag_environments_workflows(
        ...
        raw_response = self.raw.get_feature_flag_environments_workflows(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            status=status,
