...
from launch_darkly_python_sdk.model.custom_workflow_input import CustomWorkflowInput as CustomWorkflowInputSchema
...
from launch_darkly_python_sdk.model.custom_workflow_output import CustomWorkflowOutput as CustomWorkflowOutputSchema
...
from launch_darkly_python_sdk.type.custom_workflow_input import CustomWorkflowInput
from launch_darkly_python_sdk.type.custom_workflow_output import CustomWorkflowOutput

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.custom_workflow_input import CustomWorkflowInput as CustomWorkflowInputPydantic
...
from launch_darkly_python_sdk.pydantic.custom_workflow_output import CustomWorkflowOutput as CustomWorkflowOutputPydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'templateKey': typing.Union[TemplateKeySchema, str, ],
...
request_query_template_key = api_client.QueryParameter(
    name="templateKey",
...
# body param
SchemaForRequestBodyApplicationJson = CustomWorkflowInputSchema


request_body_custom_workflow_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CustomWorkflowOutputSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: CustomWorkflowOutput
...
class BaseApi(api_client.Api):
    ...
    def _create_workflow_mapped_args(
        ...
        args.body = _body
        if template_key is not None:
            _query_params["templateKey"] = template_key
        if dry_run is not None:
            _query_params["dryRun"] = dry_run
    ...
    async def _acreate_workflow_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_custom_workflow_input.serialize(body, content_type)
...
class CreateWorkflow(BaseApi):
    ...
    async def acreate_workflow(
        ...
        **kwargs,
        ...
        if validate:
            return CustomWorkflowOutputPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomWorkflowOutputPydantic, raw_response.body)
