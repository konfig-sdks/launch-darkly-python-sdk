...
class BaseApi(api_client.Api):
    ...
    def _remove_by_environment_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aremove_by_environment_key_oapg(
        self,
    ...
    def _remove_by_environment_key_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveByEnvironmentKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_by_environment_key(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._remove_by_environment_key_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._aremove_by_environment_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_by_environment_key(
        self,
        project_key: str,
        environment_key: str,
    ) -> typing.Union[
        ...
        return self._remove_by_environment_key_oapg(
            path_params=args.path,
        )

class RemoveByEnvironmentKey(BaseApi):
    ...
    async def aremove_by_environment_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_by_environment_key(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
    ...
    def remove_by_environment_key(
        ...
        raw_response = self.raw.remove_by_environment_key(
            project_key=project_key,
            environment_key=environment_key,
        )
