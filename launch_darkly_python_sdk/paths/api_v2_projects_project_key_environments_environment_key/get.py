...
class BaseApi(api_client.Api):
    ...
    def _get_by_project_and_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_by_project_and_key_oapg(
        self,
    ...
    def _get_by_project_and_key_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByProjectAndKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_project_and_key(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._get_by_project_and_key_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._aget_by_project_and_key_oapg(
    ...
    def get_by_project_and_key(
        ...
        return self._get_by_project_and_key_oapg(
            path_params=args.path,
        )

class GetByProjectAndKey(BaseApi):
    ...
    async def aget_by_project_and_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_project_and_key(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
    ...
    def get_by_project_and_key(
        ...
        raw_response = self.raw.get_by_project_and_key(
            project_key=project_key,
            environment_key=environment_key,
        )
        if validate:
