...
from launch_darkly_python_sdk.model.export import Export as ExportSchema

from launch_darkly_python_sdk.type.export import Export
...
from launch_darkly_python_sdk.pydantic.export import Export as ExportPydantic
...
SchemaFor200ResponseBodyApplicationJson = ExportSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_big_segment_export_info_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aget_big_segment_export_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/exports/{exportID}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_big_segment_export_info_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBigSegmentExportInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_big_segment_export_info(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_big_segment_export_info_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            export_id=export_id,
        )
        return await self._aget_big_segment_export_info_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_big_segment_export_info(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._get_big_segment_export_info_oapg(
            path_params=args.path,
        )

class GetBigSegmentExportInfo(BaseApi):
    ...
    async def aget_big_segment_export_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_big_segment_export_info(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            export_id=export_id,
        ...
        if validate:
            return ExportPydantic(**raw_response.body)
        return api_client.construct_model_instance(ExportPydantic, raw_response.body)
    ...
    def get_big_segment_export_info(
        ...
        raw_response = self.raw.get_big_segment_export_info(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            export_id=export_id,
