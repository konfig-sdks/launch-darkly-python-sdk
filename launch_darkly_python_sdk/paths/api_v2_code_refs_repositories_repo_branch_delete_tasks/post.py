...
from launch_darkly_python_sdk.model.code_references_asynchronously_delete_branches_request import CodeReferencesAsynchronouslyDeleteBranchesRequest as CodeReferencesAsynchronouslyDeleteBranchesRequestSchema
...
from launch_darkly_python_sdk.type.code_references_asynchronously_delete_branches_request import CodeReferencesAsynchronouslyDeleteBranchesRequest
...
from launch_darkly_python_sdk.pydantic.code_references_asynchronously_delete_branches_request import CodeReferencesAsynchronouslyDeleteBranchesRequest as CodeReferencesAsynchronouslyDeleteBranchesRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CodeReferencesAsynchronouslyDeleteBranchesRequestSchema


request_body_code_references_asynchronously_delete_branches_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _asynchronously_delete_branches_mapped_args(
        self,
        body: CodeReferencesAsynchronouslyDeleteBranchesRequest,
        repo: str,
    ...
    async def _aasynchronously_delete_branches_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/repositories/{repo}/branch-delete-tasks',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_code_references_asynchronously_delete_branches_request.serialize(body, content_type)
    ...
    def _asynchronously_delete_branches_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AsynchronouslyDeleteBranchesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aasynchronously_delete_branches(
        self,
        body: CodeReferencesAsynchronouslyDeleteBranchesRequest,
        repo: str,
        **kwargs,
        ...
        args = self._asynchronously_delete_branches_mapped_args(
            body=body,
            repo=repo,
        )
        return await self._aasynchronously_delete_branches_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def asynchronously_delete_branches(
        self,
        body: CodeReferencesAsynchronouslyDeleteBranchesRequest,
        repo: str,
    ) -> typing.Union[
        ...
        return self._asynchronously_delete_branches_oapg(
            body=args.body,
            path_params=args.path,
        )

class AsynchronouslyDeleteBranches(BaseApi):
    ...
    async def aasynchronously_delete_branches(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aasynchronously_delete_branches(
            body=body,
            repo=repo,
            **kwargs,
        )
    ...
    def asynchronously_delete_branches(
        ...
        raw_response = self.raw.asynchronously_delete_branches(
            body=body,
            repo=repo,
        )
