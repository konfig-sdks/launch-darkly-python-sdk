...
from launch_darkly_python_sdk.model.tag_collection import TagCollection as TagCollectionSchema
...
from launch_darkly_python_sdk.type.tag_collection import TagCollection
...
from launch_darkly_python_sdk.pydantic.tag_collection import TagCollection as TagCollectionPydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'pre': typing.Union[PreSchema, str, ],
...
request_query_pre = api_client.QueryParameter(
    name="pre",
    style=api_client.ParameterStyle.FORM,
    schema=PreSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationJson = TagCollectionSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return TagCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(TagCollectionPydantic, raw_response.body)
