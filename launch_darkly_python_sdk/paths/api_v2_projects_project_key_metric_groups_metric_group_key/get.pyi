...
class BaseApi(api_client.Api):
    ...
    def _get_metric_group_details_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_metric_group_details_oapg(
        self,
    ...
    def _get_metric_group_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMetricGroupDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_metric_group_details(
        self,
        project_key: str,
        metric_group_key: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_metric_group_details_mapped_args(
            project_key=project_key,
            metric_group_key=metric_group_key,
            expand=expand,
        )
        return await self._aget_metric_group_details_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_metric_group_details(
        self,
        project_key: str,
        metric_group_key: str,
        expand: typing.Optional[str] = None,
        ...
        return self._get_metric_group_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMetricGroupDetails(BaseApi):
    ...
    async def aget_metric_group_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_metric_group_details(
            project_key=project_key,
            metric_group_key=metric_group_key,
            expand=expand,
            **kwargs,
    ...
    def get_metric_group_details(
        ...
        raw_response = self.raw.get_metric_group_details(
            project_key=project_key,
            metric_group_key=metric_group_key,
            expand=expand,
        )
