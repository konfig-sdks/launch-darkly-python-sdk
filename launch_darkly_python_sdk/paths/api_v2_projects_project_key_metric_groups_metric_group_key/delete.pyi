...
class BaseApi(api_client.Api):
    ...
    def _delete_metric_group_mapped_args(
        self,
        project_key: str,
    ...
    async def _adelete_metric_group_oapg(
        self,
...
class DeleteMetricGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_metric_group(
        self,
        project_key: str,
        metric_group_key: str,
        **kwargs,
        ...
        args = self._delete_metric_group_mapped_args(
            project_key=project_key,
            metric_group_key=metric_group_key,
        )
        return await self._adelete_metric_group_oapg(
    ...
    def delete_metric_group(
        ...
        return self._delete_metric_group_oapg(
            path_params=args.path,
        )

class DeleteMetricGroup(BaseApi):
    ...
    async def adelete_metric_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_metric_group(
            project_key=project_key,
            metric_group_key=metric_group_key,
            **kwargs,
        )
    ...
    def delete_metric_group(
        ...
        raw_response = self.raw.delete_metric_group(
            project_key=project_key,
            metric_group_key=metric_group_key,
        )
