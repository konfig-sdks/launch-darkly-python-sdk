...
MetricGroupKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectKey': typing.Union[ProjectKeySchema, str, ],
        'metricGroupKey': typing.Union[MetricGroupKeySchema, str, ],
    }
)
...
request_path_metric_group_key = api_client.PathParameter(
    name="metricGroupKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MetricGroupKeySchema,
    required=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationJson = MetricGroupRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_metric_group_by_key_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
        ...
        if metric_group_key is not None:
            _path_params["metricGroupKey"] = metric_group_key
        args.path = _path_params
        return args

    async def _aupdate_metric_group_by_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_metric_group_by_key_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateMetricGroupByKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_metric_group_by_key(
        self,
        body: JSONPatch,
        project_key: str,
        metric_group_key: str,
        **kwargs,
        ...
        args = self._update_metric_group_by_key_mapped_args(
            body=body,
            project_key=project_key,
            metric_group_key=metric_group_key,
        )
        return await self._aupdate_metric_group_by_key_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_metric_group_by_key(
        self,
        body: JSONPatch,
        project_key: str,
        metric_group_key: str,
        ...
        return self._update_metric_group_by_key_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateMetricGroupByKey(BaseApi):
    ...
    async def aupdate_metric_group_by_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_metric_group_by_key(
            body=body,
            project_key=project_key,
            metric_group_key=metric_group_key,
            **kwargs,
    ...
    def update_metric_group_by_key(
        ...
        raw_response = self.raw.update_metric_group_by_key(
            body=body,
            project_key=project_key,
            metric_group_key=metric_group_key,
        )
