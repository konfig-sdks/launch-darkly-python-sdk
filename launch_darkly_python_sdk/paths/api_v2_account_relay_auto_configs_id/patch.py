...
from launch_darkly_python_sdk.model.relay_auto_config_rep import RelayAutoConfigRep as RelayAutoConfigRepSchema
...
from launch_darkly_python_sdk.model.patch_with_comment import PatchWithComment as PatchWithCommentSchema

from launch_darkly_python_sdk.type.relay_auto_config_rep import RelayAutoConfigRep
...
from launch_darkly_python_sdk.type.patch_with_comment import PatchWithComment
...
from launch_darkly_python_sdk.pydantic.patch_with_comment import PatchWithComment as PatchWithCommentPydantic
from launch_darkly_python_sdk.pydantic.relay_auto_config_rep import RelayAutoConfigRep as RelayAutoConfigRepPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PatchWithCommentSchema


request_body_patch_with_comment = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RelayAutoConfigRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RelayAutoConfigRep
...
class BaseApi(api_client.Api):
    ...
    def _update_config_patch_mapped_args(
        self,
        patch: JSONPatch,
        id: str,
    ...
    async def _aupdate_config_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/account/relay-auto-configs/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_patch_with_comment.serialize(body, content_type)
...
class UpdateConfigPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_config_patch(
        self,
        patch: JSONPatch,
        id: str,
        comment: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_config_patch_mapped_args(
            patch=patch,
            id=id,
            comment=comment,
        )
        return await self._aupdate_config_patch_oapg(
            body=args.body,
    ...
    def update_config_patch(
        ...
        return self._update_config_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateConfigPatch(BaseApi):
    ...
    async def aupdate_config_patch(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RelayAutoConfigRepPydantic:
        raw_response = await self.raw.aupdate_config_patch(
            patch=patch,
            id=id,
            comment=comment,
            **kwargs,
        ...
        if validate:
            return RelayAutoConfigRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(RelayAutoConfigRepPydantic, raw_response.body)
    ...
    def update_config_patch(
        ...
        raw_response = self.raw.update_config_patch(
            patch=patch,
            id=id,
            comment=comment,
        )
