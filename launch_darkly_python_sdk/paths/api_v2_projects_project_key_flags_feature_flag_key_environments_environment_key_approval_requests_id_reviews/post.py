...
SchemaFor200ResponseBodyApplicationJson = FlagConfigApprovalRequestResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _review_flag_request_mapped_args(
        self,
        project_key: str,
    ...
    async def _areview_flag_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}/reviews',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class ReviewFlagRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areview_flag_request(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._review_flag_request_mapped_args(
        ...
        return await self._areview_flag_request_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def review_flag_request(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        return self._review_flag_request_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReviewFlagRequest(BaseApi):
    ...
    async def areview_flag_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areview_flag_request(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    def review_flag_request(
        ...
        raw_response = self.raw.review_flag_request(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
