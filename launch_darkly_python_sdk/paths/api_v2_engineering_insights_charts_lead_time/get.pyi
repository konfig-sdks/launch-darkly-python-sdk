...
class BaseApi(api_client.Api):
    ...
    def _lead_time_chart_data_mapped_args(
        self,
        project_key: str,
    ...
    async def _alead_time_chart_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/charts/lead-time',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _lead_time_chart_data_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class LeadTimeChartDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alead_time_chart_data(
        self,
        project_key: str,
        environment_key: typing.Optional[str] = None,
        application_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._lead_time_chart_data_mapped_args(
        ...
        return await self._alead_time_chart_data_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def lead_time_chart_data(
        self,
        project_key: str,
        environment_key: typing.Optional[str] = None,
        application_key: typing.Optional[str] = None,
        ...
        return self._lead_time_chart_data_oapg(
            query_params=args.query,
        )

class LeadTimeChartData(BaseApi):
    ...
    async def alead_time_chart_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alead_time_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            _from=_from,
    ...
    def lead_time_chart_data(
        ...
        raw_response = self.raw.lead_time_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            _from=_from,
