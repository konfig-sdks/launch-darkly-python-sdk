...
from launch_darkly_python_sdk.model.post_flag_scheduled_changes_input import PostFlagScheduledChangesInput as PostFlagScheduledChangesInputSchema
...
from launch_darkly_python_sdk.type.post_flag_scheduled_changes_input import PostFlagScheduledChangesInput
...
from launch_darkly_python_sdk.pydantic.post_flag_scheduled_changes_input import PostFlagScheduledChangesInput as PostFlagScheduledChangesInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostFlagScheduledChangesInputSchema


request_body_post_flag_scheduled_changes_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FeatureFlagScheduledChangeSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_workflow_mapped_args(
        self,
        execution_date: int,
    ...
    async def _acreate_workflow_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_post_flag_scheduled_changes_input.serialize(body, content_type)
...
class CreateWorkflowRaw(BaseApi):
    ...
    async def acreate_workflow(
        ...
        **kwargs,
        ...
        args = self._create_workflow_mapped_args(
        ...
        return await self._acreate_workflow_oapg(
            body=args.body,
...
class CreateWorkflow(BaseApi):
    ...
    async def acreate_workflow(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_workflow(
            execution_date=execution_date,
            instructions=instructions,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
    ...
    def create_workflow(
        ...
        raw_response = self.raw.create_workflow(
            execution_date=execution_date,
            instructions=instructions,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
