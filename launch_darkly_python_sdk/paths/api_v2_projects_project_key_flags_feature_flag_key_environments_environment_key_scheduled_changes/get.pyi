...
from launch_darkly_python_sdk.model.feature_flag_scheduled_changes import FeatureFlagScheduledChanges as FeatureFlagScheduledChangesSchema

from launch_darkly_python_sdk.type.feature_flag_scheduled_changes import FeatureFlagScheduledChanges
...
from launch_darkly_python_sdk.pydantic.feature_flag_scheduled_changes import FeatureFlagScheduledChanges as FeatureFlagScheduledChangesPydantic
...
SchemaFor200ResponseBodyApplicationJson = FeatureFlagScheduledChangesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeatureFlagScheduledChanges
...
class ListChangesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_changes(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._list_changes_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        )
        return await self._alist_changes_oapg(
...
class ListChanges(BaseApi):
    ...
    async def alist_changes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeatureFlagScheduledChangesPydantic:
        raw_response = await self.raw.alist_changes(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            **kwargs,
        ...
        if validate:
            return FeatureFlagScheduledChangesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FeatureFlagScheduledChangesPydantic, raw_response.body)
    ...
    def list_changes(
        ...
        raw_response = self.raw.list_changes(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        )
