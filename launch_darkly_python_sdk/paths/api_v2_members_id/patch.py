...
SchemaFor200ResponseBodyApplicationJson = MemberSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_member_patch_mapped_args(
        self,
        body: JSONPatch,
        id: str,
    ...
    async def _aupdate_member_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/members/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateMemberPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_member_patch(
        self,
        body: JSONPatch,
        id: str,
        **kwargs,
        ...
        args = self._update_member_patch_mapped_args(
            body=body,
            id=id,
        )
        return await self._aupdate_member_patch_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_member_patch(
        self,
        body: JSONPatch,
        id: str,
    ) -> typing.Union[
        ...
        return self._update_member_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateMemberPatch(BaseApi):
    ...
    async def aupdate_member_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_member_patch(
            body=body,
            id=id,
            **kwargs,
        )
    ...
    def update_member_patch(
        ...
        raw_response = self.raw.update_member_patch(
            body=body,
            id=id,
        )
        if validate:
