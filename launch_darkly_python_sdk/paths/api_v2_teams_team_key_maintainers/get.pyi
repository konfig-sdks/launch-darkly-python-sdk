...
from launch_darkly_python_sdk.model.team_maintainers import TeamMaintainers as TeamMaintainersSchema
...
from launch_darkly_python_sdk.type.team_maintainers import TeamMaintainers
...
from launch_darkly_python_sdk.pydantic.team_maintainers import TeamMaintainers as TeamMaintainersPydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamMaintainersSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamMaintainers
...
class BaseApi(api_client.Api):
    ...
    def _get_maintainers_mapped_args(
        self,
        team_key: str,
    ...
    async def _aget_maintainers_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/teams/{teamKey}/maintainers',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMaintainersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_maintainers(
        self,
        team_key: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_maintainers_mapped_args(
            team_key=team_key,
            limit=limit,
            offset=offset,
        )
        return await self._aget_maintainers_oapg(
    ...
    def get_maintainers(
        ...
        return self._get_maintainers_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMaintainers(BaseApi):
    ...
    async def aget_maintainers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamMaintainersPydantic:
        raw_response = await self.raw.aget_maintainers(
            team_key=team_key,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return TeamMaintainersPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamMaintainersPydantic, raw_response.body)
    ...
    def get_maintainers(
        ...
        raw_response = self.raw.get_maintainers(
            team_key=team_key,
            limit=limit,
            offset=offset,
        )
