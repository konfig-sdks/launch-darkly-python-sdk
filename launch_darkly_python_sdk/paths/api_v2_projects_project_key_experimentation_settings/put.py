...
from launch_darkly_python_sdk.model.randomization_settings_rep import RandomizationSettingsRep as RandomizationSettingsRepSchema
from launch_darkly_python_sdk.model.randomization_settings_put import RandomizationSettingsPut as RandomizationSettingsPutSchema
...
from launch_darkly_python_sdk.model.randomization_unit_input import RandomizationUnitInput as RandomizationUnitInputSchema

from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.randomization_unit_input import RandomizationUnitInput
...
from launch_darkly_python_sdk.type.randomization_settings_put import RandomizationSettingsPut
...
from launch_darkly_python_sdk.type.randomization_settings_rep import RandomizationSettingsRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.randomization_settings_put import RandomizationSettingsPut as RandomizationSettingsPutPydantic
...
from launch_darkly_python_sdk.pydantic.randomization_settings_rep import RandomizationSettingsRep as RandomizationSettingsRepPydantic
from launch_darkly_python_sdk.pydantic.randomization_unit_input import RandomizationUnitInput as RandomizationUnitInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = RandomizationSettingsPutSchema


request_body_randomization_settings_put = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RandomizationSettingsRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RandomizationSettingsRep
...
class BaseApi(api_client.Api):
    ...
    def _update_experimentation_settings_mapped_args(
        self,
        randomization_units: typing.List[RandomizationUnitInput],
        project_key: str,
        ...
        if randomization_units is not None:
            _body["randomizationUnits"] = randomization_units
        args.body = _body
    ...
    async def _aupdate_experimentation_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/experimentation-settings',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_randomization_settings_put.serialize(body, content_type)
    ...
    def _update_experimentation_settings_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExperimentationSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_experimentation_settings(
        self,
        randomization_units: typing.List[RandomizationUnitInput],
        project_key: str,
        **kwargs,
        ...
        args = self._update_experimentation_settings_mapped_args(
            randomization_units=randomization_units,
            project_key=project_key,
        )
        return await self._aupdate_experimentation_settings_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_experimentation_settings(
        self,
        randomization_units: typing.List[RandomizationUnitInput],
        project_key: str,
    ) -> typing.Union[
        ...
        return self._update_experimentation_settings_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExperimentationSettings(BaseApi):
    ...
    async def aupdate_experimentation_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RandomizationSettingsRepPydantic:
        raw_response = await self.raw.aupdate_experimentation_settings(
            randomization_units=randomization_units,
            project_key=project_key,
            **kwargs,
        )
        if validate:
            return RandomizationSettingsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(RandomizationSettingsRepPydantic, raw_response.body)
    ...
    def update_experimentation_settings(
        ...
        raw_response = self.raw.update_experimentation_settings(
            randomization_units=randomization_units,
            project_key=project_key,
        )
        if validate:
