...
class BaseApi(api_client.Api):
    ...
    def _get_experimentation_settings_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_experimentation_settings_oapg(
        self,
    ...
    def _get_experimentation_settings_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExperimentationSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_experimentation_settings(
        self,
        project_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_experimentation_settings_mapped_args(
            project_key=project_key,
        )
        return await self._aget_experimentation_settings_oapg(
    ...
    def get_experimentation_settings(
        ...
        return self._get_experimentation_settings_oapg(
            path_params=args.path,
        )

class GetExperimentationSettings(BaseApi):
    ...
    async def aget_experimentation_settings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_experimentation_settings(
            project_key=project_key,
            **kwargs,
        )
        if validate:
    ...
    def get_experimentation_settings(
        ...
        raw_response = self.raw.get_experimentation_settings(
            project_key=project_key,
        )
        if validate:
            return RandomizationSettingsRepPydantic(**raw_response.body)
