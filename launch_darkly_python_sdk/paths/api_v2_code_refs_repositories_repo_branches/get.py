...
from launch_darkly_python_sdk.model.branch_collection_rep import BranchCollectionRep as BranchCollectionRepSchema

from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.branch_collection_rep import BranchCollectionRep
...
from launch_darkly_python_sdk.pydantic.branch_collection_rep import BranchCollectionRep as BranchCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = BranchCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BranchCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_branches_mapped_args(
        self,
        repo: str,
    ...
    async def _alist_branches_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/repositories/{repo}/branches',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListBranchesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_branches(
        self,
        repo: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_branches_mapped_args(
            repo=repo,
        )
        return await self._alist_branches_oapg(
    ...
    def list_branches(
        ...
        return self._list_branches_oapg(
            path_params=args.path,
        )

class ListBranches(BaseApi):
    ...
    async def alist_branches(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BranchCollectionRepPydantic:
        raw_response = await self.raw.alist_branches(
            repo=repo,
            **kwargs,
        )
        if validate:
            return BranchCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(BranchCollectionRepPydantic, raw_response.body)
    ...
    def list_branches(
        ...
        raw_response = self.raw.list_branches(
            repo=repo,
        )
        if validate:
            return BranchCollectionRepPydantic(**raw_response.body)
