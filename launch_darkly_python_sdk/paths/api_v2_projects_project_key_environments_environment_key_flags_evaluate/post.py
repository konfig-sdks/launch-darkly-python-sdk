...
from launch_darkly_python_sdk.model.context_instance_evaluations import ContextInstanceEvaluations as ContextInstanceEvaluationsSchema
...
from launch_darkly_python_sdk.type.context_instance_evaluations import ContextInstanceEvaluations
...
from launch_darkly_python_sdk.pydantic.context_instance_evaluations import ContextInstanceEvaluations as ContextInstanceEvaluationsPydantic
...
SchemaFor200ResponseBodyApplicationJson = ContextInstanceEvaluationsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContextInstanceEvaluations
...
class BaseApi(api_client.Api):
    ...
    def _evaluate_flags_for_context_instance_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aevaluate_flags_for_context_instance_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/flags/evaluate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _evaluate_flags_for_context_instance_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class EvaluateFlagsForContextInstanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevaluate_flags_for_context_instance(
        self,
        project_key: str,
        environment_key: str,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._evaluate_flags_for_context_instance_mapped_args(
        ...
        return await self._aevaluate_flags_for_context_instance_oapg(
            body=args.body,
    ...
    def evaluate_flags_for_context_instance(
        self,
        project_key: str,
        environment_key: str,
        limit: typing.Optional[int] = None,
        ...
        return self._evaluate_flags_for_context_instance_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class EvaluateFlagsForContextInstance(BaseApi):
    ...
    async def aevaluate_flags_for_context_instance(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContextInstanceEvaluationsPydantic:
        raw_response = await self.raw.aevaluate_flags_for_context_instance(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return ContextInstanceEvaluationsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContextInstanceEvaluationsPydantic, raw_response.body)
    ...
    def evaluate_flags_for_context_instance(
        ...
        raw_response = self.raw.evaluate_flags_for_context_instance(
            project_key=project_key,
            environment_key=environment_key,
            limit=limit,
            offset=offset,
