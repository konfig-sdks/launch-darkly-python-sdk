...
from launch_darkly_python_sdk.model.destination_post import DestinationPost as DestinationPostSchema
...
from launch_darkly_python_sdk.type.destination_post import DestinationPost
...
from launch_darkly_python_sdk.pydantic.destination_post import DestinationPost as DestinationPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DestinationPostSchema


request_body_destination_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = DestinationSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_destination_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _acreate_destination_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/destinations/{projectKey}/{environmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_destination_post.serialize(body, content_type)
...
class CreateDestinationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_destination(
        self,
        project_key: str,
        environment_key: str,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_destination_mapped_args(
        ...
        return await self._acreate_destination_oapg(
            body=args.body,
...
class CreateDestination(BaseApi):
    ...
    async def acreate_destination(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_destination(
            project_key=project_key,
            environment_key=environment_key,
            name=name,
            kind=kind,
    ...
    def create_destination(
        ...
        raw_response = self.raw.create_destination(
            project_key=project_key,
            environment_key=environment_key,
            name=name,
            kind=kind,
