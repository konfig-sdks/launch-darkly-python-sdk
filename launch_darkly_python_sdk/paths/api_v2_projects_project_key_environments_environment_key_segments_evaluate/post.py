...
from launch_darkly_python_sdk.model.context_instance_segment_memberships import ContextInstanceSegmentMemberships as ContextInstanceSegmentMembershipsSchema
from launch_darkly_python_sdk.model.context_instance import ContextInstance as ContextInstanceSchema

from launch_darkly_python_sdk.type.context_instance import ContextInstance
...
from launch_darkly_python_sdk.type.context_instance_segment_memberships import ContextInstanceSegmentMemberships

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.context_instance import ContextInstance as ContextInstancePydantic
from launch_darkly_python_sdk.pydantic.context_instance_segment_memberships import ContextInstanceSegmentMemberships as ContextInstanceSegmentMembershipsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ContextInstanceSchema


request_body_context_instance = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContextInstanceSegmentMembershipsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContextInstanceSegmentMemberships
...
class BaseApi(api_client.Api):
    ...
    def _evaluate_segment_memberships_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aevaluate_segment_memberships_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/segments/evaluate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_context_instance.serialize(body, content_type)
    ...
    def _evaluate_segment_memberships_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EvaluateSegmentMembershipsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevaluate_segment_memberships(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._evaluate_segment_memberships_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._aevaluate_segment_memberships_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def evaluate_segment_memberships(
        self,
        project_key: str,
        environment_key: str,
    ) -> typing.Union[
        ...
        return self._evaluate_segment_memberships_oapg(
            body=args.body,
            path_params=args.path,
        )

class EvaluateSegmentMemberships(BaseApi):
    ...
    async def aevaluate_segment_memberships(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContextInstanceSegmentMembershipsPydantic:
        raw_response = await self.raw.aevaluate_segment_memberships(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
        if validate:
            return ContextInstanceSegmentMembershipsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContextInstanceSegmentMembershipsPydantic, raw_response.body)
    ...
    def evaluate_segment_memberships(
        ...
        raw_response = self.raw.evaluate_segment_memberships(
            project_key=project_key,
            environment_key=environment_key,
        )
        if validate:
