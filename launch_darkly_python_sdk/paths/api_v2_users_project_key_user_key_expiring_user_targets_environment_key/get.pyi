...
from launch_darkly_python_sdk.model.expiring_user_target_get_response import ExpiringUserTargetGetResponse as ExpiringUserTargetGetResponseSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema

from launch_darkly_python_sdk.type.expiring_user_target_get_response import ExpiringUserTargetGetResponse
...
from launch_darkly_python_sdk.pydantic.expiring_user_target_get_response import ExpiringUserTargetGetResponse as ExpiringUserTargetGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ExpiringUserTargetGetResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExpiringUserTargetGetResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_expiring_flag_targets_mapped_args(
        self,
        project_key: str,
        user_key: str,
        environment_key: str,
    ...
    async def _aget_user_expiring_flag_targets_oapg(
        self,
    ...
    def _get_user_expiring_flag_targets_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserExpiringFlagTargetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="user_settings")
    async def aget_user_expiring_flag_targets(
        self,
        project_key: str,
        user_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._get_user_expiring_flag_targets_mapped_args(
            project_key=project_key,
            user_key=user_key,
            environment_key=environment_key,
        )
        return await self._aget_user_expiring_flag_targets_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="user_settings")
    def get_user_expiring_flag_targets(
        self,
        project_key: str,
        user_key: str,
        environment_key: str,
        ...
        return self._get_user_expiring_flag_targets_oapg(
            path_params=args.path,
        )

class GetUserExpiringFlagTargets(BaseApi):
    ...
    async def aget_user_expiring_flag_targets(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExpiringUserTargetGetResponsePydantic:
        raw_response = await self.raw.aget_user_expiring_flag_targets(
            project_key=project_key,
            user_key=user_key,
            environment_key=environment_key,
            **kwargs,
        ...
        if validate:
            return ExpiringUserTargetGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpiringUserTargetGetResponsePydantic, raw_response.body)
    ...
    def get_user_expiring_flag_targets(
        ...
        raw_response = self.raw.get_user_expiring_flag_targets(
            project_key=project_key,
            user_key=user_key,
            environment_key=environment_key,
        )
