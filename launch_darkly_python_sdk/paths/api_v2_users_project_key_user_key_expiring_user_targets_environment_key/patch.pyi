...
from launch_darkly_python_sdk.model.instruction_user_request import InstructionUserRequest as InstructionUserRequestSchema
...
from launch_darkly_python_sdk.model.patch_users_request import PatchUsersRequest as PatchUsersRequestSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema

from launch_darkly_python_sdk.type.patch_users_request import PatchUsersRequest
...
from launch_darkly_python_sdk.type.instruction_user_request import InstructionUserRequest

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.patch_users_request import PatchUsersRequest as PatchUsersRequestPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.instruction_user_request import InstructionUserRequest as InstructionUserRequestPydantic
...
request_path_user_key = api_client.PathParameter(
    name="userKey",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationJson = PatchUsersRequestSchema


request_body_patch_users_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_expiring_user_target_mapped_args(
        self,
        instructions: typing.List[InstructionUserRequest],
        project_key: str,
        user_key: str,
        environment_key: str,
    ...
    async def _aupdate_expiring_user_target_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_patch_users_request.serialize(body, content_type)
    ...
    def _update_expiring_user_target_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExpiringUserTargetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="user_settings")
    async def aupdate_expiring_user_target(
        self,
        instructions: typing.List[InstructionUserRequest],
        project_key: str,
        user_key: str,
        ...
        **kwargs,
        ...
        args = self._update_expiring_user_target_mapped_args(
        ...
        return await self._aupdate_expiring_user_target_oapg(
            body=args.body,
    ...
    @api_client.DeprecationWarningOnce(prefix="user_settings")
    def update_expiring_user_target(
        self,
        instructions: typing.List[InstructionUserRequest],
        project_key: str,
        user_key: str,
        ...
        return self._update_expiring_user_target_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExpiringUserTarget(BaseApi):
    ...
    async def aupdate_expiring_user_target(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_expiring_user_target(
            instructions=instructions,
            project_key=project_key,
            user_key=user_key,
            environment_key=environment_key,
    ...
    def update_expiring_user_target(
        ...
        raw_response = self.raw.update_expiring_user_target(
            instructions=instructions,
            project_key=project_key,
            user_key=user_key,
            environment_key=environment_key,
