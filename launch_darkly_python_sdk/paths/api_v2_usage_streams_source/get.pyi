...
class BaseApi(api_client.Api):
    ...
    def _get_stream_usage_mapped_args(
        self,
        source: str,
    ...
    async def _aget_stream_usage_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/streams/{source}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetStreamUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_stream_usage(
        self,
        source: str,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_stream_usage_mapped_args(
            source=source,
            _from=_from,
            to=to,
            tz=tz,
        )
        return await self._aget_stream_usage_oapg(
    ...
    def get_stream_usage(
        ...
        return self._get_stream_usage_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetStreamUsage(BaseApi):
    ...
    async def aget_stream_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_stream_usage(
            source=source,
            _from=_from,
            to=to,
            tz=tz,
    ...
    def get_stream_usage(
        ...
        raw_response = self.raw.get_stream_usage(
            source=source,
            _from=_from,
            to=to,
            tz=tz,
