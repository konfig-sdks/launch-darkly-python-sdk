...
from launch_darkly_python_sdk.model.member_teams_post_input import MemberTeamsPostInput as MemberTeamsPostInputSchema
...
from launch_darkly_python_sdk.model.member import Member as MemberSchema
...
from launch_darkly_python_sdk.model.member_teams_post_input_team_keys import MemberTeamsPostInputTeamKeys as MemberTeamsPostInputTeamKeysSchema

from launch_darkly_python_sdk.type.member import Member
...
from launch_darkly_python_sdk.type.member_teams_post_input import MemberTeamsPostInput
from launch_darkly_python_sdk.type.member_teams_post_input_team_keys import MemberTeamsPostInputTeamKeys

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.member_teams_post_input_team_keys import MemberTeamsPostInputTeamKeys as MemberTeamsPostInputTeamKeysPydantic
from launch_darkly_python_sdk.pydantic.member_teams_post_input import MemberTeamsPostInput as MemberTeamsPostInputPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.member import Member as MemberPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MemberTeamsPostInputSchema


request_body_member_teams_post_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MemberSchema
...
class BaseApi(api_client.Api):
    ...
    def _add_to_teams_mapped_args(
        self,
        team_keys: MemberTeamsPostInputTeamKeys,
        id: str,
    ...
    async def _aadd_to_teams_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/members/{id}/teams',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_member_teams_post_input.serialize(body, content_type)
...
class AddToTeamsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_teams(
        self,
        team_keys: MemberTeamsPostInputTeamKeys,
        id: str,
        **kwargs,
        ...
        args = self._add_to_teams_mapped_args(
            team_keys=team_keys,
            id=id,
        )
        return await self._aadd_to_teams_oapg(
            body=args.body,
    ...
    def add_to_teams(
        ...
        return self._add_to_teams_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddToTeams(BaseApi):
    ...
    async def aadd_to_teams(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_to_teams(
            team_keys=team_keys,
            id=id,
            **kwargs,
        )
        if validate:
            return MemberPydantic(**raw_response.body)
        return api_client.construct_model_instance(MemberPydantic, raw_response.body)
    ...
    def add_to_teams(
        ...
        raw_response = self.raw.add_to_teams(
            team_keys=team_keys,
            id=id,
        )
        if validate:
