...
class BaseApi(api_client.Api):
    ...
    def _delete_pipeline_mapped_args(
        self,
        project_key: str,
        pipeline_key: str,
    ...
    async def _adelete_pipeline_oapg(
        self,
...
class DeletePipelineRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_pipeline(
        self,
        project_key: str,
        pipeline_key: str,
        **kwargs,
        ...
        args = self._delete_pipeline_mapped_args(
            project_key=project_key,
            pipeline_key=pipeline_key,
        )
        return await self._adelete_pipeline_oapg(
...
class DeletePipeline(BaseApi):
    ...
    async def adelete_pipeline(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_pipeline(
            project_key=project_key,
            pipeline_key=pipeline_key,
            **kwargs,
        )
    ...
    def delete_pipeline(
        ...
        raw_response = self.raw.delete_pipeline(
            project_key=project_key,
            pipeline_key=pipeline_key,
        )
