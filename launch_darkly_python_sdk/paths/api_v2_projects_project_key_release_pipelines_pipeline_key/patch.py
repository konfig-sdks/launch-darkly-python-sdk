...
PipelineKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectKey': typing.Union[ProjectKeySchema, str, ],
        'pipelineKey': typing.Union[PipelineKeySchema, str, ],
    }
)
...
request_path_pipeline_key = api_client.PathParameter(
    name="pipelineKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PipelineKeySchema,
    required=True,
)
_auth = [
    'ApiKey',
]
SchemaFor200ResponseBodyApplicationJson = ReleasePipelineSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_pipeline_patch_mapped_args(
        self,
        project_key: str,
        pipeline_key: str,
        ...
        if pipeline_key is not None:
            _path_params["pipelineKey"] = pipeline_key
        args.path = _path_params
        return args

    async def _aupdate_pipeline_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_pipeline_patch_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdatePipelinePatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_pipeline_patch(
        self,
        project_key: str,
        pipeline_key: str,
        **kwargs,
        ...
        args = self._update_pipeline_patch_mapped_args(
            project_key=project_key,
            pipeline_key=pipeline_key,
        )
        return await self._aupdate_pipeline_patch_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def update_pipeline_patch(
        self,
        project_key: str,
        pipeline_key: str,
    ) -> typing.Union[
        ...
        return self._update_pipeline_patch_oapg(
            path_params=args.path,
        )

class UpdatePipelinePatch(BaseApi):
    ...
    async def aupdate_pipeline_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_pipeline_patch(
            project_key=project_key,
            pipeline_key=pipeline_key,
            **kwargs,
        )
    ...
    def update_pipeline_patch(
        ...
        raw_response = self.raw.update_pipeline_patch(
            project_key=project_key,
            pipeline_key=pipeline_key,
        )
        if validate:
