...
class BaseApi(api_client.Api):
    ...
    def _get_by_pipe_key_mapped_args(
        self,
        project_key: str,
        pipeline_key: str,
    ...
    async def _aget_by_pipe_key_oapg(
        self,
...
class GetByPipeKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_pipe_key(
        self,
        project_key: str,
        pipeline_key: str,
        **kwargs,
        ...
        args = self._get_by_pipe_key_mapped_args(
            project_key=project_key,
            pipeline_key=pipeline_key,
        )
        return await self._aget_by_pipe_key_oapg(
    ...
    def get_by_pipe_key(
        ...
        return self._get_by_pipe_key_oapg(
            path_params=args.path,
        )

class GetByPipeKey(BaseApi):
    ...
    async def aget_by_pipe_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_pipe_key(
            project_key=project_key,
            pipeline_key=pipeline_key,
            **kwargs,
        )
    ...
    def get_by_pipe_key(
        ...
        raw_response = self.raw.get_by_pipe_key(
            project_key=project_key,
            pipeline_key=pipeline_key,
        )
        if validate:
