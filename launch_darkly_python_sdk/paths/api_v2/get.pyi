...
from launch_darkly_python_sdk.model.root_response import RootResponse as RootResponseSchema

from launch_darkly_python_sdk.type.root_response import RootResponse
...
from launch_darkly_python_sdk.pydantic.root_response import RootResponse as RootResponsePydantic

SchemaFor200ResponseBodyApplicationJson = RootResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_resource_categories_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_resource_categories_oapg(
        self,
    ...
    def _get_resource_categories_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetResourceCategoriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_resource_categories(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_resource_categories_mapped_args(
        )
        return await self._aget_resource_categories_oapg(
            **kwargs,
        )
    ...
    def get_resource_categories(
        ...
        return self._get_resource_categories_oapg(
        )

class GetResourceCategories(BaseApi):

    async def aget_resource_categories(
        self,
        validate: bool = False,
        **kwargs,
    ) -> RootResponsePydantic:
        raw_response = await self.raw.aget_resource_categories(
            **kwargs,
        )
        if validate:
            return RootResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RootResponsePydantic, raw_response.body)
    ...
    def get_resource_categories(
        ...
        raw_response = self.raw.get_resource_categories(
        )
        if validate:
            return RootResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RootResponsePydantic, raw_response.body)
