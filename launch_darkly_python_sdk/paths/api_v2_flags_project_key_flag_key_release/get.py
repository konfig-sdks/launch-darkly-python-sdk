...
class BaseApi(api_client.Api):
    ...
    def _get_current_release_mapped_args(
        self,
        project_key: str,
        flag_key: str,
    ...
    async def _aget_current_release_oapg(
        self,
...
class GetCurrentReleaseRaw(BaseApi):
    ...
    async def aget_current_release(
        ...
        **kwargs,
        ...
        args = self._get_current_release_mapped_args(
            project_key=project_key,
            flag_key=flag_key,
        )
        return await self._aget_current_release_oapg(
    ...
    def get_current_release(
        ...
        return self._get_current_release_oapg(
            path_params=args.path,
        )

class GetCurrentRelease(BaseApi):
    ...
    async def aget_current_release(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_current_release(
            project_key=project_key,
            flag_key=flag_key,
            **kwargs,
        )
    ...
    def get_current_release(
        ...
        raw_response = self.raw.get_current_release(
            project_key=project_key,
            flag_key=flag_key,
        )
        if validate:
