...
from launch_darkly_python_sdk.model.release import Release as ReleaseSchema
...
from launch_darkly_python_sdk.type.release import Release

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.release import Release as ReleasePydantic
...
SchemaFor200ResponseBodyApplicationJson = ReleaseSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_active_release_patch_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
        flag_key: str,
    ...
    async def _aupdate_active_release_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{flagKey}/release',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_active_release_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateActiveReleasePatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_active_release_patch(
        self,
        body: JSONPatch,
        project_key: str,
        flag_key: str,
        **kwargs,
        ...
        args = self._update_active_release_patch_mapped_args(
            body=body,
            project_key=project_key,
            flag_key=flag_key,
        )
        return await self._aupdate_active_release_patch_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_active_release_patch(
        self,
        body: JSONPatch,
        project_key: str,
        flag_key: str,
        ...
        return self._update_active_release_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateActiveReleasePatch(BaseApi):
    ...
    async def aupdate_active_release_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_active_release_patch(
            body=body,
            project_key=project_key,
            flag_key=flag_key,
            **kwargs,
        ...
        if validate:
            return ReleasePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReleasePydantic, raw_response.body)
    ...
    def update_active_release_patch(
        ...
        raw_response = self.raw.update_active_release_patch(
            body=body,
            project_key=project_key,
            flag_key=flag_key,
        )
