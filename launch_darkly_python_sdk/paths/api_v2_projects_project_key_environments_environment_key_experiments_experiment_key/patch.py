...
from launch_darkly_python_sdk.model.experiment_patch_input import ExperimentPatchInput as ExperimentPatchInputSchema
...
from launch_darkly_python_sdk.model.experiment import Experiment as ExperimentSchema
...
from launch_darkly_python_sdk.type.experiment_patch_input import ExperimentPatchInput
from launch_darkly_python_sdk.type.experiment import Experiment

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.instructions import Instructions as InstructionsPydantic
from launch_darkly_python_sdk.pydantic.experiment import Experiment as ExperimentPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.experiment_patch_input import ExperimentPatchInput as ExperimentPatchInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ExperimentPatchInputSchema


request_body_experiment_patch_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ExperimentSchema
    ...
    async def _aupdate_semantic_patch_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_experiment_patch_input.serialize(body, content_type)
...
class UpdateSemanticPatch(BaseApi):
    ...
    async def aupdate_semantic_patch(
        ...
        **kwargs,
        ...
        if validate:
            return ExperimentPydantic(**raw_response.body)
        return api_client.construct_model_instance(ExperimentPydantic, raw_response.body)
