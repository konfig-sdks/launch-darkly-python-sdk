...
SchemaFor200ResponseBodyApplicationJson = FlagLinkRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_flag_link_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
    ...
    async def _aupdate_flag_link_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateFlagLinkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_flag_link(
        self,
        body: JSONPatch,
        project_key: str,
        feature_flag_key: str,
        ...
        **kwargs,
        ...
        args = self._update_flag_link_mapped_args(
            body=body,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            id=id,
        )
        return await self._aupdate_flag_link_oapg(
            body=args.body,
    ...
    def update_flag_link(
        ...
        return self._update_flag_link_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFlagLink(BaseApi):
    ...
    async def aupdate_flag_link(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_flag_link(
            body=body,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            id=id,
    ...
    def update_flag_link(
        ...
        raw_response = self.raw.update_flag_link(
            body=body,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            id=id,
