...
class BaseApi(api_client.Api):
    ...
    def _delete_flag_link_mapped_args(
        self,
        project_key: str,
    ...
    async def _adelete_flag_link_oapg(
        self,
...
class DeleteFlagLinkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_flag_link(
        self,
        project_key: str,
        feature_flag_key: str,
        id: str,
        **kwargs,
        ...
        args = self._delete_flag_link_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            id=id,
        )
        return await self._adelete_flag_link_oapg(
    ...
    def delete_flag_link(
        ...
        return self._delete_flag_link_oapg(
            path_params=args.path,
        )

class DeleteFlagLink(BaseApi):
    ...
    async def adelete_flag_link(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_flag_link(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            id=id,
            **kwargs,
    ...
    def delete_flag_link(
        ...
        raw_response = self.raw.delete_flag_link(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            id=id,
        )
