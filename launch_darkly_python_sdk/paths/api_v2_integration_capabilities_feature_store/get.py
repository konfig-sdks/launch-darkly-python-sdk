...
class BaseApi(api_client.Api):
    ...
    def _list_delivery_configurations_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_delivery_configurations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/featureStore',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_delivery_configurations_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class ListDeliveryConfigurationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_delivery_configurations(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_delivery_configurations_mapped_args(
        )
        return await self._alist_delivery_configurations_oapg(
            **kwargs,
        )
    ...
    def list_delivery_configurations(
        ...
        return self._list_delivery_configurations_oapg(
        )

class ListDeliveryConfigurations(BaseApi):
    ...
    async def alist_delivery_configurations(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_delivery_configurations(
            **kwargs,
        )
        if validate:
    ...
    def list_delivery_configurations(
        ...
        raw_response = self.raw.list_delivery_configurations(
        )
        if validate:
            return IntegrationDeliveryConfigurationCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationDeliveryConfigurationCollectionPydantic, raw_response.body)
