...
from launch_darkly_python_sdk.model.versions_rep import VersionsRep as VersionsRepSchema
...
from launch_darkly_python_sdk.type.versions_rep import VersionsRep
...
from launch_darkly_python_sdk.pydantic.versions_rep import VersionsRep as VersionsRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = VersionsRepSchema
...
class GetVersionInformation(BaseApi):
    ...
    async def aget_version_information(
        ...
        **kwargs,
        ...
        if validate:
            return VersionsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(VersionsRepPydantic, raw_response.body)
