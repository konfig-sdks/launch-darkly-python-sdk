...
from launch_darkly_python_sdk.model.application_collection_rep import ApplicationCollectionRep as ApplicationCollectionRepSchema
...
from launch_darkly_python_sdk.type.application_collection_rep import ApplicationCollectionRep
...
from launch_darkly_python_sdk.pydantic.application_collection_rep import ApplicationCollectionRep as ApplicationCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = ApplicationCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ApplicationCollectionRep
    ...
    async def _alist_applications_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/applications',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListApplications(BaseApi):
    ...
    async def alist_applications(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApplicationCollectionRepPydantic:
        ...
        if validate:
            return ApplicationCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ApplicationCollectionRepPydantic, raw_response.body)
