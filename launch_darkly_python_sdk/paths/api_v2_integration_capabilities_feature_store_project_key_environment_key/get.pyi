...
from launch_darkly_python_sdk.model.integration_delivery_configuration_collection import IntegrationDeliveryConfigurationCollection as IntegrationDeliveryConfigurationCollectionSchema
...
from launch_darkly_python_sdk.type.integration_delivery_configuration_collection import IntegrationDeliveryConfigurationCollection
...
from launch_darkly_python_sdk.pydantic.integration_delivery_configuration_collection import IntegrationDeliveryConfigurationCollection as IntegrationDeliveryConfigurationCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = IntegrationDeliveryConfigurationCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: IntegrationDeliveryConfigurationCollection
...
class BaseApi(api_client.Api):
    ...
    def _get_delivery_configurations_by_environment_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_delivery_configurations_by_environment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_delivery_configurations_by_environment_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDeliveryConfigurationsByEnvironmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_delivery_configurations_by_environment(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._get_delivery_configurations_by_environment_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._aget_delivery_configurations_by_environment_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_delivery_configurations_by_environment(
        self,
        project_key: str,
        environment_key: str,
    ) -> typing.Union[
        ...
        return self._get_delivery_configurations_by_environment_oapg(
            path_params=args.path,
        )

class GetDeliveryConfigurationsByEnvironment(BaseApi):
    ...
    async def aget_delivery_configurations_by_environment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IntegrationDeliveryConfigurationCollectionPydantic:
        raw_response = await self.raw.aget_delivery_configurations_by_environment(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
        if validate:
            return IntegrationDeliveryConfigurationCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationDeliveryConfigurationCollectionPydantic, raw_response.body)
    ...
    def get_delivery_configurations_by_environment(
        ...
        raw_response = self.raw.get_delivery_configurations_by_environment(
            project_key=project_key,
            environment_key=environment_key,
        )
        if validate:
