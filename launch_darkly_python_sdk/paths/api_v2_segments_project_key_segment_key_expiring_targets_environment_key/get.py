...
class BaseApi(api_client.Api):
    ...
    def _get_expiring_targets_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aget_expiring_targets_oapg(
        self,
    ...
    def _get_expiring_targets_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExpiringTargetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_expiring_targets(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        **kwargs,
        ...
        args = self._get_expiring_targets_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        )
        return await self._aget_expiring_targets_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_expiring_targets(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._get_expiring_targets_oapg(
            path_params=args.path,
        )

class GetExpiringTargets(BaseApi):
    ...
    async def aget_expiring_targets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_expiring_targets(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            **kwargs,
    ...
    def get_expiring_targets(
        ...
        raw_response = self.raw.get_expiring_targets(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        )
