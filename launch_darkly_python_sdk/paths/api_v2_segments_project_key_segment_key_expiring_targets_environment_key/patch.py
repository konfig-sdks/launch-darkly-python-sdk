...
from launch_darkly_python_sdk.model.patch_segment_expiring_target_instruction import PatchSegmentExpiringTargetInstruction as PatchSegmentExpiringTargetInstructionSchema
from launch_darkly_python_sdk.model.patch_segment_expiring_target_input_rep import PatchSegmentExpiringTargetInputRep as PatchSegmentExpiringTargetInputRepSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema
from launch_darkly_python_sdk.model.expiring_target_patch_response import ExpiringTargetPatchResponse as ExpiringTargetPatchResponseSchema

from launch_darkly_python_sdk.type.patch_segment_expiring_target_instruction import PatchSegmentExpiringTargetInstruction
from launch_darkly_python_sdk.type.expiring_target_patch_response import ExpiringTargetPatchResponse
from launch_darkly_python_sdk.type.patch_segment_expiring_target_input_rep import PatchSegmentExpiringTargetInputRep
...
from launch_darkly_python_sdk.pydantic.patch_segment_expiring_target_instruction import PatchSegmentExpiringTargetInstruction as PatchSegmentExpiringTargetInstructionPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.patch_segment_expiring_target_input_rep import PatchSegmentExpiringTargetInputRep as PatchSegmentExpiringTargetInputRepPydantic
...
from launch_darkly_python_sdk.pydantic.expiring_target_patch_response import ExpiringTargetPatchResponse as ExpiringTargetPatchResponsePydantic
...
request_path_segment_key = api_client.PathParameter(
    name="segmentKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SegmentKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = PatchSegmentExpiringTargetInputRepSchema


request_body_patch_segment_expiring_target_input_rep = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ExpiringTargetPatchResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExpiringTargetPatchResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_expiring_targets_for_segment_mapped_args(
        self,
        instructions: typing.List[PatchSegmentExpiringTargetInstruction],
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aupdate_expiring_targets_for_segment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{segmentKey}/expiring-targets/{environmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_patch_segment_expiring_target_input_rep.serialize(body, content_type)
    ...
    def _update_expiring_targets_for_segment_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExpiringTargetsForSegmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_expiring_targets_for_segment(
        self,
        instructions: typing.List[PatchSegmentExpiringTargetInstruction],
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_expiring_targets_for_segment_mapped_args(
        ...
        return await self._aupdate_expiring_targets_for_segment_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_expiring_targets_for_segment(
        self,
        instructions: typing.List[PatchSegmentExpiringTargetInstruction],
        project_key: str,
        environment_key: str,
        ...
        return self._update_expiring_targets_for_segment_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExpiringTargetsForSegment(BaseApi):
    ...
    async def aupdate_expiring_targets_for_segment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExpiringTargetPatchResponsePydantic:
        raw_response = await self.raw.aupdate_expiring_targets_for_segment(
            instructions=instructions,
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        ...
        if validate:
            return ExpiringTargetPatchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpiringTargetPatchResponsePydantic, raw_response.body)
    ...
    def update_expiring_targets_for_segment(
        ...
        raw_response = self.raw.update_expiring_targets_for_segment(
            instructions=instructions,
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
