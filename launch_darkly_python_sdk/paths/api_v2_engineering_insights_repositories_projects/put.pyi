...
from launch_darkly_python_sdk.model.insights_repository_project_mappings import InsightsRepositoryProjectMappings as InsightsRepositoryProjectMappingsSchema
...
from launch_darkly_python_sdk.model.insights_repository_project_collection import InsightsRepositoryProjectCollection as InsightsRepositoryProjectCollectionSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema
from launch_darkly_python_sdk.model.insights_repository_project import InsightsRepositoryProject as InsightsRepositoryProjectSchema

from launch_darkly_python_sdk.type.insights_repository_project import InsightsRepositoryProject
from launch_darkly_python_sdk.type.insights_repository_project_mappings import InsightsRepositoryProjectMappings
from launch_darkly_python_sdk.type.rate_limited_error_rep import RateLimitedErrorRep
from launch_darkly_python_sdk.type.insights_repository_project_collection import InsightsRepositoryProjectCollection
...
from launch_darkly_python_sdk.pydantic.insights_repository_project_collection import InsightsRepositoryProjectCollection as InsightsRepositoryProjectCollectionPydantic
from launch_darkly_python_sdk.pydantic.insights_repository_project import InsightsRepositoryProject as InsightsRepositoryProjectPydantic
from launch_darkly_python_sdk.pydantic.insights_repository_project_mappings import InsightsRepositoryProjectMappings as InsightsRepositoryProjectMappingsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = InsightsRepositoryProjectMappingsSchema


request_body_insights_repository_project_mappings = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = InsightsRepositoryProjectCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InsightsRepositoryProjectCollection
...
class BaseApi(api_client.Api):
    ...
    def _associate_repositories_and_projects_mapped_args(
        self,
        mappings: typing.List[InsightsRepositoryProject],
    ...
    async def _aassociate_repositories_and_projects_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/repositories/projects',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_insights_repository_project_mappings.serialize(body, content_type)
    ...
    def _associate_repositories_and_projects_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AssociateRepositoriesAndProjectsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassociate_repositories_and_projects(
        self,
        mappings: typing.List[InsightsRepositoryProject],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._associate_repositories_and_projects_mapped_args(
            mappings=mappings,
        )
        return await self._aassociate_repositories_and_projects_oapg(
            body=args.body,
            **kwargs,
        )
    
    def associate_repositories_and_projects(
        self,
        mappings: typing.List[InsightsRepositoryProject],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._associate_repositories_and_projects_oapg(
            body=args.body,
        )

class AssociateRepositoriesAndProjects(BaseApi):
    ...
    async def aassociate_repositories_and_projects(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InsightsRepositoryProjectCollectionPydantic:
        raw_response = await self.raw.aassociate_repositories_and_projects(
            mappings=mappings,
            **kwargs,
        )
        if validate:
            return InsightsRepositoryProjectCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(InsightsRepositoryProjectCollectionPydantic, raw_response.body)
    ...
    def associate_repositories_and_projects(
        ...
        raw_response = self.raw.associate_repositories_and_projects(
            mappings=mappings,
        )
        if validate:
            return InsightsRepositoryProjectCollectionPydantic(**raw_response.body)
