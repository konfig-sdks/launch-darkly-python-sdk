...
from launch_darkly_python_sdk.model.patch_failed_error_rep import PatchFailedErrorRep as PatchFailedErrorRepSchema
from launch_darkly_python_sdk.model.not_found_error_rep import NotFoundErrorRep as NotFoundErrorRepSchema
from launch_darkly_python_sdk.model.json_patch import JSONPatch as JSONPatchSchema
...
from launch_darkly_python_sdk.type.json_patch import JSONPatch
from launch_darkly_python_sdk.type.patch_failed_error_rep import PatchFailedErrorRep
...
from launch_darkly_python_sdk.pydantic.patch_failed_error_rep import PatchFailedErrorRep as PatchFailedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.json_patch import JSONPatch as JSONPatchPydantic
...
# Path params
InsightGroupKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'insightGroupKey': typing.Union[InsightGroupKeySchema, str, ],
    }
)
...
request_path_insight_group_key = api_client.PathParameter(
    name="insightGroupKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=InsightGroupKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = JSONPatchSchema


request_body_json_patch = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = InsightGroupSchema
...
SchemaFor422ResponseBodyApplicationJson = PatchFailedErrorRepSchema


@dataclass
class ApiResponseFor422(api_client.ApiResponse):
    body: PatchFailedErrorRep
...
class BaseApi(api_client.Api):
    ...
    def _update_insight_group_patch_mapped_args(
        self,
        body: JSONPatch,
        insight_group_key: str,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        args.body = body if body is not None else _body
        if insight_group_key is not None:
            _path_params["insightGroupKey"] = insight_group_key
        args.path = _path_params
        return args

    async def _aupdate_insight_group_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_insight_group_key,
        ):
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/insights/groups/{insightGroupKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_json_patch.serialize(body, content_type)
    ...
    def _update_insight_group_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateInsightGroupPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_insight_group_patch(
        self,
        body: JSONPatch,
        insight_group_key: str,
        **kwargs,
        ...
        args = self._update_insight_group_patch_mapped_args(
            body=body,
            insight_group_key=insight_group_key,
        )
        return await self._aupdate_insight_group_patch_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_insight_group_patch(
        self,
        body: JSONPatch,
        insight_group_key: str,
    ) -> typing.Union[
        ...
        return self._update_insight_group_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateInsightGroupPatch(BaseApi):
    ...
    async def aupdate_insight_group_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_insight_group_patch(
            body=body,
            insight_group_key=insight_group_key,
            **kwargs,
        )
    ...
    def update_insight_group_patch(
        ...
        raw_response = self.raw.update_insight_group_patch(
            body=body,
            insight_group_key=insight_group_key,
        )
        if validate:
