...
class BaseApi(api_client.Api):
    ...
    def _expand_group_insight_scores_mapped_args(
        self,
    ...
    async def _aexpand_group_insight_scores_oapg(
        self,
    ...
    def _expand_group_insight_scores_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ExpandGroupInsightScoresRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aexpand_group_insight_scores(
        self,
        insight_group_key: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._expand_group_insight_scores_mapped_args(
            insight_group_key=insight_group_key,
            expand=expand,
        )
        return await self._aexpand_group_insight_scores_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def expand_group_insight_scores(
        self,
        insight_group_key: str,
        expand: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._expand_group_insight_scores_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ExpandGroupInsightScores(BaseApi):
    ...
    async def aexpand_group_insight_scores(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aexpand_group_insight_scores(
            insight_group_key=insight_group_key,
            expand=expand,
            **kwargs,
        )
    ...
    def expand_group_insight_scores(
        ...
        raw_response = self.raw.expand_group_insight_scores(
            insight_group_key=insight_group_key,
            expand=expand,
        )
        if validate:
