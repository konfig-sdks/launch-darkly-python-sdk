...
class BaseApi(api_client.Api):
    ...
    def _delete_insight_group_mapped_args(
        self,
    ...
    async def _adelete_insight_group_oapg(
        self,
    ...
    def _delete_insight_group_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteInsightGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_insight_group(
        self,
        insight_group_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_insight_group_mapped_args(
            insight_group_key=insight_group_key,
        )
        return await self._adelete_insight_group_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_insight_group(
        self,
        insight_group_key: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_insight_group_oapg(
            path_params=args.path,
        )

class DeleteInsightGroup(BaseApi):
    ...
    async def adelete_insight_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_insight_group(
            insight_group_key=insight_group_key,
            **kwargs,
        )
    ...
    def delete_insight_group(
        ...
        raw_response = self.raw.delete_insight_group(
            insight_group_key=insight_group_key,
        )
