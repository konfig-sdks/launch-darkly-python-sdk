...
from launch_darkly_python_sdk.model.workflow_template_output import WorkflowTemplateOutput as WorkflowTemplateOutputSchema
from launch_darkly_python_sdk.model.create_workflow_template_input import CreateWorkflowTemplateInput as CreateWorkflowTemplateInputSchema
...
from launch_darkly_python_sdk.model.stage_input import StageInput as StageInputSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema

from launch_darkly_python_sdk.type.workflow_template_output import WorkflowTemplateOutput
...
from launch_darkly_python_sdk.type.create_workflow_template_input import CreateWorkflowTemplateInput
...
from launch_darkly_python_sdk.type.stage_input import StageInput

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.workflow_template_output import WorkflowTemplateOutput as WorkflowTemplateOutputPydantic
from launch_darkly_python_sdk.pydantic.stage_input import StageInput as StageInputPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.create_workflow_template_input import CreateWorkflowTemplateInput as CreateWorkflowTemplateInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateWorkflowTemplateInputSchema


request_body_create_workflow_template_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WorkflowTemplateOutputSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: WorkflowTemplateOutput
...
class BaseApi(api_client.Api):
    ...
    def _create_feature_flag_template_mapped_args(
        self,
        key: str,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        workflow_id: typing.Optional[str] = None,
        stages: typing.Optional[typing.List[StageInput]] = None,
        ...
        if flag_key is not None:
            _body["flagKey"] = flag_key
        args.body = _body
        return args

    async def _acreate_feature_flag_template_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/templates',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_workflow_template_input.serialize(body, content_type)
    ...
    def _create_feature_flag_template_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateFeatureFlagTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_feature_flag_template(
        self,
        key: str,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_feature_flag_template_mapped_args(
            key=key,
        ...
        return await self._acreate_feature_flag_template_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_feature_flag_template(
        self,
        key: str,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        ...
        return self._create_feature_flag_template_oapg(
            body=args.body,
        )

class CreateFeatureFlagTemplate(BaseApi):
    ...
    async def acreate_feature_flag_template(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkflowTemplateOutputPydantic:
        raw_response = await self.raw.acreate_feature_flag_template(
            key=key,
            description=description,
            name=name,
            workflow_id=workflow_id,
        ...
        if validate:
            return WorkflowTemplateOutputPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkflowTemplateOutputPydantic, raw_response.body)
    ...
    def create_feature_flag_template(
        ...
        raw_response = self.raw.create_feature_flag_template(
            key=key,
            description=description,
            name=name,
            workflow_id=workflow_id,
