...
from launch_darkly_python_sdk.model.workflow_templates_listing_output_rep import WorkflowTemplatesListingOutputRep as WorkflowTemplatesListingOutputRepSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema

from launch_darkly_python_sdk.type.workflow_templates_listing_output_rep import WorkflowTemplatesListingOutputRep
...
from launch_darkly_python_sdk.pydantic.workflow_templates_listing_output_rep import WorkflowTemplatesListingOutputRep as WorkflowTemplatesListingOutputRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkflowTemplatesListingOutputRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkflowTemplatesListingOutputRep
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkflowTemplatesListingOutputRepPydantic:
        ...
        if validate:
            return WorkflowTemplatesListingOutputRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkflowTemplatesListingOutputRepPydantic, raw_response.body)
