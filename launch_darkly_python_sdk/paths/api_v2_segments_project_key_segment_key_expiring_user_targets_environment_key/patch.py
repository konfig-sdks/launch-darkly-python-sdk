...
from launch_darkly_python_sdk.model.patch_segment_instruction import PatchSegmentInstruction as PatchSegmentInstructionSchema
...
from launch_darkly_python_sdk.model.patch_segment_request import PatchSegmentRequest as PatchSegmentRequestSchema
...
from launch_darkly_python_sdk.model.expiring_user_target_patch_response import ExpiringUserTargetPatchResponse as ExpiringUserTargetPatchResponseSchema
...
from launch_darkly_python_sdk.type.expiring_user_target_patch_response import ExpiringUserTargetPatchResponse
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep
from launch_darkly_python_sdk.type.patch_segment_instruction import PatchSegmentInstruction
from launch_darkly_python_sdk.type.patch_segment_request import PatchSegmentRequest

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.patch_segment_request import PatchSegmentRequest as PatchSegmentRequestPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.patch_segment_instruction import PatchSegmentInstruction as PatchSegmentInstructionPydantic
...
from launch_darkly_python_sdk.pydantic.expiring_user_target_patch_response import ExpiringUserTargetPatchResponse as ExpiringUserTargetPatchResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PatchSegmentRequestSchema


request_body_patch_segment_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ExpiringUserTargetPatchResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExpiringUserTargetPatchResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_expiring_targets_for_segment_0_mapped_args(
        self,
        instructions: typing.List[PatchSegmentInstruction],
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aupdate_expiring_targets_for_segment_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{segmentKey}/expiring-user-targets/{environmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_patch_segment_request.serialize(body, content_type)
    ...
    def _update_expiring_targets_for_segment_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExpiringTargetsForSegment0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_expiring_targets_for_segment_0(
        self,
        instructions: typing.List[PatchSegmentInstruction],
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_expiring_targets_for_segment_0_mapped_args(
        ...
        return await self._aupdate_expiring_targets_for_segment_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_expiring_targets_for_segment_0(
        self,
        instructions: typing.List[PatchSegmentInstruction],
        project_key: str,
        environment_key: str,
        ...
        return self._update_expiring_targets_for_segment_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExpiringTargetsForSegment0(BaseApi):
    ...
    async def aupdate_expiring_targets_for_segment_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExpiringUserTargetPatchResponsePydantic:
        raw_response = await self.raw.aupdate_expiring_targets_for_segment_0(
            instructions=instructions,
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        ...
        if validate:
            return ExpiringUserTargetPatchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpiringUserTargetPatchResponsePydantic, raw_response.body)
    ...
    def update_expiring_targets_for_segment_0(
        ...
        raw_response = self.raw.update_expiring_targets_for_segment_0(
            instructions=instructions,
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
