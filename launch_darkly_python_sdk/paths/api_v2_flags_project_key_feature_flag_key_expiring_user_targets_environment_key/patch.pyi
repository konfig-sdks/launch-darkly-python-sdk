...
from launch_darkly_python_sdk.model.patch_flags_request import PatchFlagsRequest as PatchFlagsRequestSchema
...
from launch_darkly_python_sdk.type.patch_flags_request import PatchFlagsRequest
...
from launch_darkly_python_sdk.pydantic.patch_flags_request import PatchFlagsRequest as PatchFlagsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PatchFlagsRequestSchema


request_body_patch_flags_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_expiring_user_targets_mapped_args(
        self,
    ...
    async def _aupdate_expiring_user_targets_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{featureFlagKey}/expiring-user-targets/{environmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_patch_flags_request.serialize(body, content_type)
    ...
    def _update_expiring_user_targets_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExpiringUserTargetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_expiring_user_targets(
        self,
        instructions: typing.List[Instruction],
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_expiring_user_targets_mapped_args(
        ...
        return await self._aupdate_expiring_user_targets_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_expiring_user_targets(
        self,
        instructions: typing.List[Instruction],
        project_key: str,
        environment_key: str,
        ...
        return self._update_expiring_user_targets_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExpiringUserTargets(BaseApi):
    ...
    async def aupdate_expiring_user_targets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_expiring_user_targets(
            instructions=instructions,
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
    ...
    def update_expiring_user_targets(
        ...
        raw_response = self.raw.update_expiring_user_targets(
            instructions=instructions,
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
