...
class BaseApi(api_client.Api):
    ...
    def _list_expiring_user_targets_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _alist_expiring_user_targets_oapg(
        self,
    ...
    def _list_expiring_user_targets_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListExpiringUserTargetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_expiring_user_targets(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        **kwargs,
        ...
        args = self._list_expiring_user_targets_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
        return await self._alist_expiring_user_targets_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_expiring_user_targets(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        ...
        return self._list_expiring_user_targets_oapg(
            path_params=args.path,
        )

class ListExpiringUserTargets(BaseApi):
    ...
    async def alist_expiring_user_targets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_expiring_user_targets(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            **kwargs,
    ...
    def list_expiring_user_targets(
        ...
        raw_response = self.raw.list_expiring_user_targets(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
