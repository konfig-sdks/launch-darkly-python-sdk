...
from launch_darkly_python_sdk.model.segment_user_state import SegmentUserState as SegmentUserStateSchema
...
from launch_darkly_python_sdk.model.segment_user_list import SegmentUserList as SegmentUserListSchema

from launch_darkly_python_sdk.type.segment_user_state import SegmentUserState
from launch_darkly_python_sdk.type.segment_user_list import SegmentUserList
...
from launch_darkly_python_sdk.pydantic.segment_user_list import SegmentUserList as SegmentUserListPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.segment_user_state import SegmentUserState as SegmentUserStatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = SegmentUserStateSchema


request_body_segment_user_state = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_user_context_targets_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        included: typing.Optional[SegmentUserList] = None,
        excluded: typing.Optional[SegmentUserList] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if included is not None:
            _body["included"] = included
        if excluded is not None:
            _body["excluded"] = excluded
        args.body = _body
    ...
    async def _aupdate_user_context_targets_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/users',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_segment_user_state.serialize(body, content_type)
    ...
    def _update_user_context_targets_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateUserContextTargetsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_user_context_targets(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_user_context_targets_mapped_args(
        ...
        return await self._aupdate_user_context_targets_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_user_context_targets(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._update_user_context_targets_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateUserContextTargets(BaseApi):
    ...
    async def aupdate_user_context_targets(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_user_context_targets(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            included=included,
    ...
    def update_user_context_targets(
        ...
        raw_response = self.raw.update_user_context_targets(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            included=included,
