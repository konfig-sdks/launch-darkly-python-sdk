...
class BaseApi(api_client.Api):
    ...
    def _get_mau_usage_by_category_mapped_args(
        self,
    ...
    async def _aget_mau_usage_by_category_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/mau/bycategory',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_mau_usage_by_category_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMauUsageByCategoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_mau_usage_by_category(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_mau_usage_by_category_mapped_args(
            _from=_from,
            to=to,
        )
        return await self._aget_mau_usage_by_category_oapg(
    ...
    def get_mau_usage_by_category(
        ...
        return self._get_mau_usage_by_category_oapg(
            query_params=args.query,
        )

class GetMauUsageByCategory(BaseApi):
    ...
    async def aget_mau_usage_by_category(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_mau_usage_by_category(
            _from=_from,
            to=to,
            **kwargs,
        )
    ...
    def get_mau_usage_by_category(
        ...
        raw_response = self.raw.get_mau_usage_by_category(
            _from=_from,
            to=to,
        )
        if validate:
