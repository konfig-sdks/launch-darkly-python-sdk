...
from launch_darkly_python_sdk.model.destinations import Destinations as DestinationsSchema

from launch_darkly_python_sdk.type.destinations import Destinations
...
from launch_darkly_python_sdk.pydantic.destinations import Destinations as DestinationsPydantic
...
SchemaFor200ResponseBodyApplicationJson = DestinationsSchema
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/destinations',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DestinationsPydantic:
        raw_response = await self.raw.aget_all(
            **kwargs,
        )
        if validate:
            return DestinationsPydantic(**raw_response.body)
        return api_client.construct_model_instance(DestinationsPydantic, raw_response.body)
