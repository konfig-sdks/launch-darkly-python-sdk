...
from launch_darkly_python_sdk.model.experiment_bayesian_results_rep import ExperimentBayesianResultsRep as ExperimentBayesianResultsRepSchema

from launch_darkly_python_sdk.type.experiment_bayesian_results_rep import ExperimentBayesianResultsRep
...
from launch_darkly_python_sdk.pydantic.experiment_bayesian_results_rep import ExperimentBayesianResultsRep as ExperimentBayesianResultsRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = ExperimentBayesianResultsRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExperimentBayesianResultsRep
...
class BaseApi(api_client.Api):
    ...
    def _get_experiment_metric_results_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        experiment_key: str,
    ...
    async def _aget_experiment_metric_results_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}/metrics/{metricKey}/results',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_experiment_metric_results_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetExperimentMetricResultsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_experiment_metric_results(
        self,
        project_key: str,
        environment_key: str,
        experiment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_experiment_metric_results_mapped_args(
        ...
        return await self._aget_experiment_metric_results_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_experiment_metric_results(
        self,
        project_key: str,
        environment_key: str,
        experiment_key: str,
        ...
        return self._get_experiment_metric_results_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetExperimentMetricResults(BaseApi):
    ...
    async def aget_experiment_metric_results(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExperimentBayesianResultsRepPydantic:
        raw_response = await self.raw.aget_experiment_metric_results(
            project_key=project_key,
            environment_key=environment_key,
            experiment_key=experiment_key,
            metric_key=metric_key,
        ...
        if validate:
            return ExperimentBayesianResultsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ExperimentBayesianResultsRepPydantic, raw_response.body)
    ...
    def get_experiment_metric_results(
        ...
        raw_response = self.raw.get_experiment_metric_results(
            project_key=project_key,
            environment_key=environment_key,
            experiment_key=experiment_key,
            metric_key=metric_key,
