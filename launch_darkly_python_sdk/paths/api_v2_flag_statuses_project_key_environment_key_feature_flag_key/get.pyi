...
from launch_darkly_python_sdk.model.flag_status_rep import FlagStatusRep as FlagStatusRepSchema

from launch_darkly_python_sdk.type.rate_limited_error_rep import RateLimitedErrorRep
from launch_darkly_python_sdk.type.flag_status_rep import FlagStatusRep
...
from launch_darkly_python_sdk.pydantic.flag_status_rep import FlagStatusRep as FlagStatusRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = FlagStatusRepSchema
    ...
    async def _aget_status_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flag-statuses/{projectKey}/{environmentKey}/{featureFlagKey}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetStatus(BaseApi):
    ...
    async def aget_status(
        ...
        **kwargs,
        ...
        if validate:
            return FlagStatusRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagStatusRepPydantic, raw_response.body)
