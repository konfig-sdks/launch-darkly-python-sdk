...
from launch_darkly_python_sdk.model.users import Users as UsersSchema
...
from launch_darkly_python_sdk.type.users import Users
...
from launch_darkly_python_sdk.pydantic.users import Users as UsersPydantic
    ...
    async def _asearch_users_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/user-search/{projectKey}/{environmentKey}',
            auth_settings=_auth,
            headers=_headers,
        )
