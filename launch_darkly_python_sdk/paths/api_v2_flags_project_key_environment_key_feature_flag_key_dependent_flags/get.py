...
from launch_darkly_python_sdk.model.dependent_flags_by_environment import DependentFlagsByEnvironment as DependentFlagsByEnvironmentSchema
...
from launch_darkly_python_sdk.type.dependent_flags_by_environment import DependentFlagsByEnvironment
...
from launch_darkly_python_sdk.pydantic.dependent_flags_by_environment import DependentFlagsByEnvironment as DependentFlagsByEnvironmentPydantic
...
SchemaFor200ResponseBodyApplicationJson = DependentFlagsByEnvironmentSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DependentFlagsByEnvironment
...
class BaseApi(api_client.Api):
    ...
    def _list_dependent_flags_by_env_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _alist_dependent_flags_by_env_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{environmentKey}/{featureFlagKey}/dependent-flags',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_dependent_flags_by_env_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListDependentFlagsByEnvRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_dependent_flags_by_env(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        **kwargs,
        ...
        args = self._list_dependent_flags_by_env_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
        return await self._alist_dependent_flags_by_env_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_dependent_flags_by_env(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        ...
        return self._list_dependent_flags_by_env_oapg(
            path_params=args.path,
        )

class ListDependentFlagsByEnv(BaseApi):
    ...
    async def alist_dependent_flags_by_env(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DependentFlagsByEnvironmentPydantic:
        raw_response = await self.raw.alist_dependent_flags_by_env(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            **kwargs,
        ...
        if validate:
            return DependentFlagsByEnvironmentPydantic(**raw_response.body)
        return api_client.construct_model_instance(DependentFlagsByEnvironmentPydantic, raw_response.body)
    ...
    def list_dependent_flags_by_env(
        ...
        raw_response = self.raw.list_dependent_flags_by_env(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
