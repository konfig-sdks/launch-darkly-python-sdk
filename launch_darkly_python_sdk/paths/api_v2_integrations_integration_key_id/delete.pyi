...
class BaseApi(api_client.Api):
    ...
    def _delete_subscription_mapped_args(
        self,
        integration_key: str,
        id: str,
    ...
    async def _adelete_subscription_oapg(
        self,
...
class DeleteSubscriptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_subscription(
        self,
        integration_key: str,
        id: str,
        **kwargs,
        ...
        args = self._delete_subscription_mapped_args(
            integration_key=integration_key,
            id=id,
        )
        return await self._adelete_subscription_oapg(
...
class DeleteSubscription(BaseApi):
    ...
    async def adelete_subscription(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_subscription(
            integration_key=integration_key,
            id=id,
            **kwargs,
        )
    ...
    def delete_subscription(
        ...
        raw_response = self.raw.delete_subscription(
            integration_key=integration_key,
            id=id,
        )
