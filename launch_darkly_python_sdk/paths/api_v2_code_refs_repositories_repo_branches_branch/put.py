...
from launch_darkly_python_sdk.model.reference_rep import ReferenceRep as ReferenceRepSchema
...
from launch_darkly_python_sdk.model.put_branch import PutBranch as PutBranchSchema

from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.reference_rep import ReferenceRep
...
from launch_darkly_python_sdk.type.put_branch import PutBranch
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.reference_rep import ReferenceRep as ReferenceRepPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.put_branch import PutBranch as PutBranchPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutBranchSchema


request_body_put_branch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _upsert_branch_mapped_args(
        self,
        name: str,
        head: str,
        sync_time: int,
        repo: str,
        branch: str,
        update_sequence_id: typing.Optional[int] = None,
        references: typing.Optional[typing.List[ReferenceRep]] = None,
        commit_time: typing.Optional[int] = None,
        ...
        if update_sequence_id is not None:
            _body["updateSequenceId"] = update_sequence_id
        if sync_time is not None:
            _body["syncTime"] = sync_time
        if references is not None:
            _body["references"] = references
        if commit_time is not None:
            _body["commitTime"] = commit_time
        args.body = _body
        if repo is not None:
    ...
    async def _aupsert_branch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/repositories/{repo}/branches/{branch}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_put_branch.serialize(body, content_type)
...
class UpsertBranchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupsert_branch(
        self,
        name: str,
        head: str,
        sync_time: int,
        ...
        **kwargs,
        ...
        args = self._upsert_branch_mapped_args(
            name=name,
            head=head,
            sync_time=sync_time,
            repo=repo,
        ...
        return await self._aupsert_branch_oapg(
            body=args.body,
    ...
    def upsert_branch(
        ...
        return self._upsert_branch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpsertBranch(BaseApi):
    ...
    async def aupsert_branch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupsert_branch(
            name=name,
            head=head,
            sync_time=sync_time,
            repo=repo,
    ...
    def upsert_branch(
        ...
        raw_response = self.raw.upsert_branch(
            name=name,
            head=head,
            sync_time=sync_time,
            repo=repo,
