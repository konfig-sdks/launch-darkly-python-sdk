...
from launch_darkly_python_sdk.model.branch_rep import BranchRep as BranchRepSchema
...
from launch_darkly_python_sdk.type.branch_rep import BranchRep
...
from launch_darkly_python_sdk.pydantic.branch_rep import BranchRep as BranchRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = BranchRepSchema
...
class GetBranchRaw(BaseApi):
    ...
    async def aget_branch(
        ...
        **kwargs,
        ...
        args = self._get_branch_mapped_args(
            repo=repo,
            branch=branch,
            proj_key=proj_key,
            flag_key=flag_key,
        )
        return await self._aget_branch_oapg(
...
class GetBranch(BaseApi):
    ...
    async def aget_branch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_branch(
            repo=repo,
            branch=branch,
            proj_key=proj_key,
            flag_key=flag_key,
        ...
        if validate:
            return BranchRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(BranchRepPydantic, raw_response.body)
    ...
    def get_branch(
        ...
        raw_response = self.raw.get_branch(
            repo=repo,
            branch=branch,
            proj_key=proj_key,
            flag_key=flag_key,
