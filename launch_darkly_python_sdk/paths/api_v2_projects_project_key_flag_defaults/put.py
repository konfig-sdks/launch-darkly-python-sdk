...
from launch_darkly_python_sdk.model.default_client_side_availability import DefaultClientSideAvailability as DefaultClientSideAvailabilitySchema
...
from launch_darkly_python_sdk.model.upsert_payload_rep import UpsertPayloadRep as UpsertPayloadRepSchema
from launch_darkly_python_sdk.model.not_found_error_rep import NotFoundErrorRep as NotFoundErrorRepSchema
from launch_darkly_python_sdk.model.boolean_flag_defaults import BooleanFlagDefaults as BooleanFlagDefaultsSchema
...
from launch_darkly_python_sdk.model.upsert_flag_defaults_payload import UpsertFlagDefaultsPayload as UpsertFlagDefaultsPayloadSchema
from launch_darkly_python_sdk.model.upsert_flag_defaults_payload_tags import UpsertFlagDefaultsPayloadTags as UpsertFlagDefaultsPayloadTagsSchema

from launch_darkly_python_sdk.type.default_client_side_availability import DefaultClientSideAvailability
from launch_darkly_python_sdk.type.upsert_payload_rep import UpsertPayloadRep
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.upsert_flag_defaults_payload import UpsertFlagDefaultsPayload
from launch_darkly_python_sdk.type.rate_limited_error_rep import RateLimitedErrorRep
from launch_darkly_python_sdk.type.boolean_flag_defaults import BooleanFlagDefaults
from launch_darkly_python_sdk.type.not_found_error_rep import NotFoundErrorRep
from launch_darkly_python_sdk.type.upsert_flag_defaults_payload_tags import UpsertFlagDefaultsPayloadTags
...
from launch_darkly_python_sdk.pydantic.upsert_flag_defaults_payload_tags import UpsertFlagDefaultsPayloadTags as UpsertFlagDefaultsPayloadTagsPydantic
from launch_darkly_python_sdk.pydantic.boolean_flag_defaults import BooleanFlagDefaults as BooleanFlagDefaultsPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.upsert_payload_rep import UpsertPayloadRep as UpsertPayloadRepPydantic
from launch_darkly_python_sdk.pydantic.upsert_flag_defaults_payload import UpsertFlagDefaultsPayload as UpsertFlagDefaultsPayloadPydantic
...
from launch_darkly_python_sdk.pydantic.default_client_side_availability import DefaultClientSideAvailability as DefaultClientSideAvailabilityPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpsertFlagDefaultsPayloadSchema


request_body_upsert_flag_defaults_payload = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UpsertPayloadRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UpsertPayloadRep
...
class BaseApi(api_client.Api):
    ...
    def _update_flag_defaults_for_project_mapped_args(
        self,
        tags: UpsertFlagDefaultsPayloadTags,
        temporary: bool,
        ...
        if boolean_defaults is not None:
            _body["booleanDefaults"] = boolean_defaults
        if default_client_side_availability is not None:
            _body["defaultClientSideAvailability"] = default_client_side_availability
        args.body = _body
    ...
    async def _aupdate_flag_defaults_for_project_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flag-defaults',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_upsert_flag_defaults_payload.serialize(body, content_type)
    ...
    def _update_flag_defaults_for_project_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFlagDefaultsForProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_flag_defaults_for_project(
        self,
        tags: UpsertFlagDefaultsPayloadTags,
        temporary: bool,
        boolean_defaults: BooleanFlagDefaults,
        ...
        **kwargs,
        ...
        args = self._update_flag_defaults_for_project_mapped_args(
            tags=tags,
            temporary=temporary,
        ...
        return await self._aupdate_flag_defaults_for_project_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_flag_defaults_for_project(
        self,
        tags: UpsertFlagDefaultsPayloadTags,
        temporary: bool,
        boolean_defaults: BooleanFlagDefaults,
        ...
        return self._update_flag_defaults_for_project_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFlagDefaultsForProject(BaseApi):
    ...
    async def aupdate_flag_defaults_for_project(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UpsertPayloadRepPydantic:
        raw_response = await self.raw.aupdate_flag_defaults_for_project(
            tags=tags,
            temporary=temporary,
            boolean_defaults=boolean_defaults,
            default_client_side_availability=default_client_side_availability,
        ...
        if validate:
            return UpsertPayloadRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(UpsertPayloadRepPydantic, raw_response.body)
    ...
    def update_flag_defaults_for_project(
        ...
        raw_response = self.raw.update_flag_defaults_for_project(
            tags=tags,
            temporary=temporary,
            boolean_defaults=boolean_defaults,
            default_client_side_availability=default_client_side_availability,
