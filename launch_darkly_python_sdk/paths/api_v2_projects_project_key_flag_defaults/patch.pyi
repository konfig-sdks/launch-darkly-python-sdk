...
class BaseApi(api_client.Api):
    ...
    def _update_flag_default_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
    ...
    async def _aupdate_flag_default_oapg(
        self,
...
class UpdateFlagDefaultRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_flag_default(
        self,
        body: JSONPatch,
        project_key: str,
        **kwargs,
        ...
        args = self._update_flag_default_mapped_args(
            body=body,
            project_key=project_key,
        )
        return await self._aupdate_flag_default_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_flag_default(
        self,
        body: JSONPatch,
        project_key: str,
    ) -> typing.Union[
        ...
        return self._update_flag_default_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFlagDefault(BaseApi):
    ...
    async def aupdate_flag_default(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_flag_default(
            body=body,
            project_key=project_key,
            **kwargs,
        )
    ...
    def update_flag_default(
        ...
        raw_response = self.raw.update_flag_default(
            body=body,
            project_key=project_key,
        )
        if validate:
