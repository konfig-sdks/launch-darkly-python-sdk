...
from launch_darkly_python_sdk.model.flag_defaults_rep import FlagDefaultsRep as FlagDefaultsRepSchema

from launch_darkly_python_sdk.type.flag_defaults_rep import FlagDefaultsRep
...
from launch_darkly_python_sdk.pydantic.flag_defaults_rep import FlagDefaultsRep as FlagDefaultsRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = FlagDefaultsRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FlagDefaultsRep
...
class BaseApi(api_client.Api):
    ...
    def _get_flag_defaults_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_flag_defaults_oapg(
        self,
...
class GetFlagDefaultsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_flag_defaults(
        self,
        project_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_flag_defaults_mapped_args(
            project_key=project_key,
        )
        return await self._aget_flag_defaults_oapg(
    ...
    def get_flag_defaults(
        ...
        return self._get_flag_defaults_oapg(
            path_params=args.path,
        )

class GetFlagDefaults(BaseApi):
    ...
    async def aget_flag_defaults(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FlagDefaultsRepPydantic:
        raw_response = await self.raw.aget_flag_defaults(
            project_key=project_key,
            **kwargs,
        )
        if validate:
            return FlagDefaultsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagDefaultsRepPydantic, raw_response.body)
    ...
    def get_flag_defaults(
        ...
        raw_response = self.raw.get_flag_defaults(
            project_key=project_key,
        )
        if validate:
            return FlagDefaultsRepPydantic(**raw_response.body)
