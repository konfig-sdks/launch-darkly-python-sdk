...
from launch_darkly_python_sdk.model.webhook import Webhook as WebhookSchema
...
from launch_darkly_python_sdk.model.webhook_post import WebhookPost as WebhookPostSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema
from launch_darkly_python_sdk.model.webhook_post_tags import WebhookPostTags as WebhookPostTagsSchema
...
from launch_darkly_python_sdk.type.webhook import Webhook
from launch_darkly_python_sdk.type.webhook_post import WebhookPost
...
from launch_darkly_python_sdk.type.webhook_post_tags import WebhookPostTags

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.webhook_post_tags import WebhookPostTags as WebhookPostTagsPydantic
from launch_darkly_python_sdk.pydantic.webhook import Webhook as WebhookPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.webhook_post import WebhookPost as WebhookPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = WebhookPostSchema


request_body_webhook_post = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_webhook_mapped_args(
        self,
        url: str,
        sign: bool,
        tags: typing.Optional[WebhookPostTags] = None,
    ...
    async def _acreate_new_webhook_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/webhooks',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_webhook_post.serialize(body, content_type)
...
class CreateNewWebhookRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_webhook(
        self,
        url: str,
        sign: bool,
        tags: typing.Optional[WebhookPostTags] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_webhook_mapped_args(
            url=url,
            sign=sign,
            tags=tags,
            name=name,
        ...
        return await self._acreate_new_webhook_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_webhook(
        ...
        return self._create_new_webhook_oapg(
            body=args.body,
        )

class CreateNewWebhook(BaseApi):
    ...
    async def acreate_new_webhook(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_webhook(
            url=url,
            sign=sign,
            tags=tags,
            name=name,
    ...
    def create_new_webhook(
        ...
        raw_response = self.raw.create_new_webhook(
            url=url,
            sign=sign,
            tags=tags,
            name=name,
