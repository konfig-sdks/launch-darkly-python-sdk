...
from launch_darkly_python_sdk.model.webhooks import Webhooks as WebhooksSchema
...
from launch_darkly_python_sdk.type.webhooks import Webhooks
...
from launch_darkly_python_sdk.pydantic.webhooks import Webhooks as WebhooksPydantic
...
class ListWebhooks(BaseApi):
    ...
    async def alist_webhooks(
        ...
        **kwargs,
        ...
        if validate:
            return WebhooksPydantic(**raw_response.body)
