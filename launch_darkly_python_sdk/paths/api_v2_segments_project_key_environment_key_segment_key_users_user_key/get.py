...
class BaseApi(api_client.Api):
    ...
    def _get_user_membership_status_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aget_user_membership_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/users/{userKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_user_membership_status_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserMembershipStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_membership_status(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_user_membership_status_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            user_key=user_key,
        )
        return await self._aget_user_membership_status_oapg(
    ...
    def get_user_membership_status(
        ...
        return self._get_user_membership_status_oapg(
            path_params=args.path,
        )

class GetUserMembershipStatus(BaseApi):
    ...
    async def aget_user_membership_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_membership_status(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            user_key=user_key,
    ...
    def get_user_membership_status(
        ...
        raw_response = self.raw.get_user_membership_status(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            user_key=user_key,
