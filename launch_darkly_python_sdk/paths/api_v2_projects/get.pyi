...
from launch_darkly_python_sdk.model.projects import Projects as ProjectsSchema

from launch_darkly_python_sdk.type.projects import Projects
...
from launch_darkly_python_sdk.pydantic.projects import Projects as ProjectsPydantic
...
class BaseApi(api_client.Api):
    ...
    def _list_projects_default_mapped_args(
        self,
    ...
    async def _alist_projects_default_oapg(
        self,
    ...
    def _list_projects_default_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListProjectsDefaultRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_projects_default(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_projects_default_mapped_args(
            limit=limit,
            offset=offset,
            filter=filter,
            sort=sort,
        ...
        return await self._alist_projects_default_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_projects_default(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        filter: typing.Optional[str] = None,
        ...
        return self._list_projects_default_oapg(
            query_params=args.query,
        )

class ListProjectsDefault(BaseApi):
    ...
    async def alist_projects_default(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_projects_default(
            limit=limit,
            offset=offset,
            filter=filter,
            sort=sort,
    ...
    def list_projects_default(
        ...
        raw_response = self.raw.list_projects_default(
            limit=limit,
            offset=offset,
            filter=filter,
            sort=sort,
