...
class BaseApi(api_client.Api):
    ...
    def _deployment_frequency_chart_data_mapped_args(
        self,
    ...
    async def _adeployment_frequency_chart_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/charts/deployments/frequency',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _deployment_frequency_chart_data_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeploymentFrequencyChartDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeployment_frequency_chart_data(
        self,
        project_key: typing.Optional[str] = None,
        environment_key: typing.Optional[str] = None,
        application_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._deployment_frequency_chart_data_mapped_args(
        ...
        return await self._adeployment_frequency_chart_data_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def deployment_frequency_chart_data(
        self,
        project_key: typing.Optional[str] = None,
        environment_key: typing.Optional[str] = None,
        application_key: typing.Optional[str] = None,
        ...
        return self._deployment_frequency_chart_data_oapg(
            query_params=args.query,
        )

class DeploymentFrequencyChartData(BaseApi):
    ...
    async def adeployment_frequency_chart_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adeployment_frequency_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            _from=_from,
    ...
    def deployment_frequency_chart_data(
        ...
        raw_response = self.raw.deployment_frequency_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            _from=_from,
