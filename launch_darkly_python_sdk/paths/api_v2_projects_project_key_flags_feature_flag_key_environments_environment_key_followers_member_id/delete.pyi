...
class BaseApi(api_client.Api):
    ...
    def _remove_follower_mapped_args(
        self,
        project_key: str,
    ...
    async def _aremove_follower_oapg(
        self,
...
class RemoveFollowerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_follower(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._remove_follower_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            member_id=member_id,
        )
        return await self._aremove_follower_oapg(
    ...
    def remove_follower(
        ...
        return self._remove_follower_oapg(
            path_params=args.path,
        )

class RemoveFollower(BaseApi):
    ...
    async def aremove_follower(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_follower(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            member_id=member_id,
    ...
    def remove_follower(
        ...
        raw_response = self.raw.remove_follower(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            member_id=member_id,
