...
class BaseApi(api_client.Api):
    ...
    def _member_follower_mapped_args(
        self,
        project_key: str,
    ...
    async def _amember_follower_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers/{memberId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class MemberFollowerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amember_follower(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._member_follower_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            member_id=member_id,
        )
        return await self._amember_follower_oapg(
    ...
    def member_follower(
        ...
        return self._member_follower_oapg(
            path_params=args.path,
        )

class MemberFollower(BaseApi):
    ...
    async def amember_follower(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amember_follower(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            member_id=member_id,
    ...
    def member_follower(
        ...
        raw_response = self.raw.member_follower(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            member_id=member_id,
