...
from launch_darkly_python_sdk.model.user_record import UserRecord as UserRecordSchema

from launch_darkly_python_sdk.type.user_record import UserRecord
...
from launch_darkly_python_sdk.pydantic.user_record import UserRecord as UserRecordPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserRecordSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_user_by_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
    ...
    async def _aget_user_by_key_oapg(
        self,
...
class GetUserByKeyRaw(BaseApi):
    ...
    async def aget_user_by_key(
        ...
        **kwargs,
        ...
        args = self._get_user_by_key_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
        )
        return await self._aget_user_by_key_oapg(
    ...
    def get_user_by_key(
        ...
        return self._get_user_by_key_oapg(
            path_params=args.path,
        )

class GetUserByKey(BaseApi):
    ...
    async def aget_user_by_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_by_key(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            **kwargs,
        ...
        if validate:
            return UserRecordPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserRecordPydantic, raw_response.body)
    ...
    def get_user_by_key(
        ...
        raw_response = self.raw.get_user_by_key(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
        )
