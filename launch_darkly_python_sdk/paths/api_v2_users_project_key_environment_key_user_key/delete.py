...
class BaseApi(api_client.Api):
    ...
    def _delete_by_project_environment_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
    ...
    async def _adelete_by_project_environment_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/users/{projectKey}/{environmentKey}/{userKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_by_project_environment_key_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteByProjectEnvironmentKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="users")
    async def adelete_by_project_environment_key(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
        **kwargs,
        ...
        args = self._delete_by_project_environment_key_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
        )
        return await self._adelete_by_project_environment_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="users")
    def delete_by_project_environment_key(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
        ...
        return self._delete_by_project_environment_key_oapg(
            path_params=args.path,
        )

class DeleteByProjectEnvironmentKey(BaseApi):
    ...
    async def adelete_by_project_environment_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_by_project_environment_key(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            **kwargs,
    ...
    def delete_by_project_environment_key(
        ...
        raw_response = self.raw.delete_by_project_environment_key(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
        )
