...
from launch_darkly_python_sdk.model.context_search import ContextSearch as ContextSearchSchema
from launch_darkly_python_sdk.model.contexts import Contexts as ContextsSchema
...
from launch_darkly_python_sdk.type.context_search import ContextSearch
...
from launch_darkly_python_sdk.type.contexts import Contexts
...
from launch_darkly_python_sdk.pydantic.context_search import ContextSearch as ContextSearchPydantic
...
from launch_darkly_python_sdk.pydantic.contexts import Contexts as ContextsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ContextSearchSchema


request_body_context_search = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContextsSchema
...
class BaseApi(api_client.Api):
    ...
    def _search_contexts_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _asearch_contexts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/search',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_context_search.serialize(body, content_type)
...
class SearchContextsRaw(BaseApi):
    ...
    async def asearch_contexts(
        ...
        **kwargs,
        ...
        args = self._search_contexts_mapped_args(
        ...
        return await self._asearch_contexts_oapg(
            body=args.body,
    ...
    def search_contexts(
        ...
        return self._search_contexts_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class SearchContexts(BaseApi):
    ...
    async def asearch_contexts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asearch_contexts(
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
            sort=sort,
        ...
        if validate:
            return ContextsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContextsPydantic, raw_response.body)
    ...
    def search_contexts(
        ...
        raw_response = self.raw.search_contexts(
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
            sort=sort,
