...
class BaseApi(api_client.Api):
    ...
    def _get_flag_status_chart_data_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_flag_status_chart_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/charts/flags/status',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_flag_status_chart_data_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetFlagStatusChartDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_flag_status_chart_data(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_flag_status_chart_data_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
        )
        return await self._aget_flag_status_chart_data_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_flag_status_chart_data(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        ...
        return self._get_flag_status_chart_data_oapg(
            query_params=args.query,
        )

class GetFlagStatusChartData(BaseApi):
    ...
    async def aget_flag_status_chart_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_flag_status_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            **kwargs,
    ...
    def get_flag_status_chart_data(
        ...
        raw_response = self.raw.get_flag_status_chart_data(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
        )
