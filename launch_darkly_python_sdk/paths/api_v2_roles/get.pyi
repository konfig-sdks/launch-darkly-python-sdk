...
from launch_darkly_python_sdk.model.custom_roles import CustomRoles as CustomRolesSchema

from launch_darkly_python_sdk.type.custom_roles import CustomRoles
...
from launch_darkly_python_sdk.pydantic.custom_roles import CustomRoles as CustomRolesPydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomRolesSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_custom_roles_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_custom_roles_oapg(
        self,
...
class ListCustomRolesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_custom_roles(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_custom_roles_mapped_args(
        )
        return await self._alist_custom_roles_oapg(
            **kwargs,
        )
    ...
    def list_custom_roles(
        ...
        return self._list_custom_roles_oapg(
        )

class ListCustomRoles(BaseApi):
    ...
    async def alist_custom_roles(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_custom_roles(
            **kwargs,
        )
        if validate:
            return CustomRolesPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomRolesPydantic, raw_response.body)
    ...
    def list_custom_roles(
        ...
        raw_response = self.raw.list_custom_roles(
        )
        if validate:
            return CustomRolesPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomRolesPydantic, raw_response.body)
