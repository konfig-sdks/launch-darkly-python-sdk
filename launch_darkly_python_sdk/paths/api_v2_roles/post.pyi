...
from launch_darkly_python_sdk.model.custom_role_post import CustomRolePost as CustomRolePostSchema
...
from launch_darkly_python_sdk.type.custom_role_post import CustomRolePost
...
from launch_darkly_python_sdk.pydantic.custom_role_post import CustomRolePost as CustomRolePostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CustomRolePostSchema


request_body_custom_role_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CustomRoleSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_role_mapped_args(
        self,
        name: str,
        key: str,
        policy: StatementPostList,
        description: typing.Optional[str] = None,
        base_permissions: typing.Optional[str] = None,
        ...
        if base_permissions is not None:
            _body["basePermissions"] = base_permissions
        args.body = _body
        return args

    async def _acreate_new_role_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/roles',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_custom_role_post.serialize(body, content_type)
...
class CreateNewRoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_role(
        self,
        name: str,
        key: str,
        policy: StatementPostList,
        ...
        **kwargs,
        ...
        args = self._create_new_role_mapped_args(
            name=name,
            key=key,
            policy=policy,
        ...
        return await self._acreate_new_role_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_role(
        ...
        return self._create_new_role_oapg(
            body=args.body,
        )

class CreateNewRole(BaseApi):
    ...
    async def acreate_new_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_role(
            name=name,
            key=key,
            policy=policy,
            description=description,
    ...
    def create_new_role(
        ...
        raw_response = self.raw.create_new_role(
            name=name,
            key=key,
            policy=policy,
            description=description,
