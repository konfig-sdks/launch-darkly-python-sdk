...
from launch_darkly_python_sdk.model.extinction_list_post import ExtinctionListPost as ExtinctionListPostSchema
...
from launch_darkly_python_sdk.type.extinction_list_post import ExtinctionListPost
...
from launch_darkly_python_sdk.pydantic.extinction_list_post import ExtinctionListPost as ExtinctionListPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ExtinctionListPostSchema


request_body_extinction_list_post = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_extinction_mapped_args(
        self,
    ...
    async def _acreate_extinction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/repositories/{repo}/branches/{branch}/extinction-events',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_extinction_list_post.serialize(body, content_type)
...
class CreateExtinctionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_extinction(
        self,
        body: ExtinctionListPost,
        repo: str,
        branch: str,
        **kwargs,
        ...
        args = self._create_extinction_mapped_args(
            body=body,
            repo=repo,
            branch=branch,
        )
        return await self._acreate_extinction_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_extinction(
        self,
        body: ExtinctionListPost,
        repo: str,
        branch: str,
        ...
        return self._create_extinction_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateExtinction(BaseApi):
    ...
    async def acreate_extinction(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_extinction(
            body=body,
            repo=repo,
            branch=branch,
            **kwargs,
    ...
    def create_extinction(
        ...
        raw_response = self.raw.create_extinction(
            body=body,
            repo=repo,
            branch=branch,
        )
