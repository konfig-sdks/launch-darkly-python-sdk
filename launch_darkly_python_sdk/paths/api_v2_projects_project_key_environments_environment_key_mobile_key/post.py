...
class BaseApi(api_client.Api):
    ...
    def _reset_mobile_sdk_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _areset_mobile_sdk_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/mobileKey',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _reset_mobile_sdk_key_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ResetMobileSdkKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_mobile_sdk_key(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._reset_mobile_sdk_key_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._areset_mobile_sdk_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def reset_mobile_sdk_key(
        self,
        project_key: str,
        environment_key: str,
    ) -> typing.Union[
        ...
        return self._reset_mobile_sdk_key_oapg(
            path_params=args.path,
        )

class ResetMobileSdkKey(BaseApi):
    ...
    async def areset_mobile_sdk_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areset_mobile_sdk_key(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
    ...
    def reset_mobile_sdk_key(
        ...
        raw_response = self.raw.reset_mobile_sdk_key(
            project_key=project_key,
            environment_key=environment_key,
        )
        if validate:
