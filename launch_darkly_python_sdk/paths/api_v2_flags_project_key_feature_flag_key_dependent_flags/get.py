...
from launch_darkly_python_sdk.model.multi_environment_dependent_flags import MultiEnvironmentDependentFlags as MultiEnvironmentDependentFlagsSchema
...
from launch_darkly_python_sdk.type.multi_environment_dependent_flags import MultiEnvironmentDependentFlags
...
from launch_darkly_python_sdk.pydantic.multi_environment_dependent_flags import MultiEnvironmentDependentFlags as MultiEnvironmentDependentFlagsPydantic
...
SchemaFor200ResponseBodyApplicationJson = MultiEnvironmentDependentFlagsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MultiEnvironmentDependentFlags
...
class BaseApi(api_client.Api):
    ...
    def _list_dependent_flags_mapped_args(
        self,
        project_key: str,
    ...
    async def _alist_dependent_flags_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{featureFlagKey}/dependent-flags',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_dependent_flags_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListDependentFlagsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_dependent_flags(
        self,
        project_key: str,
        feature_flag_key: str,
        **kwargs,
        ...
        args = self._list_dependent_flags_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
        )
        return await self._alist_dependent_flags_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_dependent_flags(
        self,
        project_key: str,
        feature_flag_key: str,
    ) -> typing.Union[
        ...
        return self._list_dependent_flags_oapg(
            path_params=args.path,
        )

class ListDependentFlags(BaseApi):
    ...
    async def alist_dependent_flags(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MultiEnvironmentDependentFlagsPydantic:
        raw_response = await self.raw.alist_dependent_flags(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            **kwargs,
        )
        if validate:
            return MultiEnvironmentDependentFlagsPydantic(**raw_response.body)
        return api_client.construct_model_instance(MultiEnvironmentDependentFlagsPydantic, raw_response.body)
    ...
    def list_dependent_flags(
        ...
        raw_response = self.raw.list_dependent_flags(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
        )
        if validate:
