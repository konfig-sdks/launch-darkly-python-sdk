...
from launch_darkly_python_sdk.model.feature_flag_statuses import FeatureFlagStatuses as FeatureFlagStatusesSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema

from launch_darkly_python_sdk.type.feature_flag_statuses import FeatureFlagStatuses
...
from launch_darkly_python_sdk.pydantic.feature_flag_statuses import FeatureFlagStatuses as FeatureFlagStatusesPydantic
...
SchemaFor200ResponseBodyApplicationJson = FeatureFlagStatusesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeatureFlagStatuses
...
class BaseApi(api_client.Api):
    ...
    def _list_flag_statuses_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _alist_flag_statuses_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flag-statuses/{projectKey}/{environmentKey}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListFlagStatusesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_flag_statuses(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._list_flag_statuses_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._alist_flag_statuses_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_flag_statuses(
        self,
        project_key: str,
        environment_key: str,
    ) -> typing.Union[
        ...
        return self._list_flag_statuses_oapg(
            path_params=args.path,
        )

class ListFlagStatuses(BaseApi):
    ...
    async def alist_flag_statuses(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeatureFlagStatusesPydantic:
        raw_response = await self.raw.alist_flag_statuses(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
        if validate:
            return FeatureFlagStatusesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FeatureFlagStatusesPydantic, raw_response.body)
    ...
    def list_flag_statuses(
        ...
        raw_response = self.raw.list_flag_statuses(
            project_key=project_key,
            environment_key=environment_key,
        )
        if validate:
