...
from launch_darkly_python_sdk.model.team_custom_roles import TeamCustomRoles as TeamCustomRolesSchema

from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.team_custom_roles import TeamCustomRoles
...
from launch_darkly_python_sdk.pydantic.team_custom_roles import TeamCustomRoles as TeamCustomRolesPydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamCustomRolesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamCustomRoles
...
class BaseApi(api_client.Api):
    ...
    def _get_custom_roles_mapped_args(
        self,
        team_key: str,
    ...
    async def _aget_custom_roles_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/teams/{teamKey}/roles',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetCustomRolesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_custom_roles(
        self,
        team_key: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_custom_roles_mapped_args(
            team_key=team_key,
            limit=limit,
            offset=offset,
        )
        return await self._aget_custom_roles_oapg(
    ...
    def get_custom_roles(
        ...
        return self._get_custom_roles_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCustomRoles(BaseApi):
    ...
    async def aget_custom_roles(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamCustomRolesPydantic:
        raw_response = await self.raw.aget_custom_roles(
            team_key=team_key,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return TeamCustomRolesPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamCustomRolesPydantic, raw_response.body)
    ...
    def get_custom_roles(
        ...
        raw_response = self.raw.get_custom_roles(
            team_key=team_key,
            limit=limit,
            offset=offset,
        )
