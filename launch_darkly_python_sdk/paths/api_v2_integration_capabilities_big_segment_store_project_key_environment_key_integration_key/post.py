...
from launch_darkly_python_sdk.model.big_segment_store_integration import BigSegmentStoreIntegration as BigSegmentStoreIntegrationSchema
from launch_darkly_python_sdk.model.integration_delivery_configuration_post import IntegrationDeliveryConfigurationPost as IntegrationDeliveryConfigurationPostSchema
...
from launch_darkly_python_sdk.model.integration_delivery_configuration_post_tags import IntegrationDeliveryConfigurationPostTags as IntegrationDeliveryConfigurationPostTagsSchema
...
from launch_darkly_python_sdk.type.integration_delivery_configuration_post import IntegrationDeliveryConfigurationPost
...
from launch_darkly_python_sdk.type.integration_delivery_configuration_post_tags import IntegrationDeliveryConfigurationPostTags
from launch_darkly_python_sdk.type.status_conflict_error_rep import StatusConflictErrorRep
from launch_darkly_python_sdk.type.big_segment_store_integration import BigSegmentStoreIntegration
...
from launch_darkly_python_sdk.pydantic.big_segment_store_integration import BigSegmentStoreIntegration as BigSegmentStoreIntegrationPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.integration_delivery_configuration_post import IntegrationDeliveryConfigurationPost as IntegrationDeliveryConfigurationPostPydantic
...
from launch_darkly_python_sdk.pydantic.integration_delivery_configuration_post_tags import IntegrationDeliveryConfigurationPostTags as IntegrationDeliveryConfigurationPostTagsPydantic
...
request_path_integration_key = api_client.PathParameter(
    name="integrationKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=IntegrationKeySchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = IntegrationDeliveryConfigurationPostSchema


request_body_integration_delivery_configuration_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = BigSegmentStoreIntegrationSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: BigSegmentStoreIntegration
...
class BaseApi(api_client.Api):
    ...
    def _create_persistent_store_integration_mapped_args(
        self,
        config: FormVariableConfig,
        project_key: str,
        environment_key: str,
        integration_key: str,
        tags: typing.Optional[IntegrationDeliveryConfigurationPostTags] = None,
        _true: typing.Optional[bool] = None,
        ...
        if integration_key is not None:
            _path_params["integrationKey"] = integration_key
        args.path = _path_params
        return args

    async def _acreate_persistent_store_integration_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_integration_delivery_configuration_post.serialize(body, content_type)
    ...
    def _create_persistent_store_integration_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreatePersistentStoreIntegrationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_persistent_store_integration(
        self,
        config: FormVariableConfig,
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._create_persistent_store_integration_mapped_args(
            config=config,
        ...
        return await self._acreate_persistent_store_integration_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_persistent_store_integration(
        self,
        config: FormVariableConfig,
        project_key: str,
        environment_key: str,
        ...
        return self._create_persistent_store_integration_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreatePersistentStoreIntegration(BaseApi):
    ...
    async def acreate_persistent_store_integration(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BigSegmentStoreIntegrationPydantic:
        raw_response = await self.raw.acreate_persistent_store_integration(
            config=config,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
        ...
        if validate:
            return BigSegmentStoreIntegrationPydantic(**raw_response.body)
        return api_client.construct_model_instance(BigSegmentStoreIntegrationPydantic, raw_response.body)
    ...
    def create_persistent_store_integration(
        ...
        raw_response = self.raw.create_persistent_store_integration(
            config=config,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
