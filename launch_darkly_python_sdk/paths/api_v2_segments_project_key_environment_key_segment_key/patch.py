...
from launch_darkly_python_sdk.model.user_segment import UserSegment as UserSegmentSchema
...
from launch_darkly_python_sdk.type.user_segment import UserSegment
...
from launch_darkly_python_sdk.pydantic.user_segment import UserSegment as UserSegmentPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserSegmentSchema
    ...
    async def _aupdate_semantic_patch_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateSemanticPatch(BaseApi):
    ...
    async def aupdate_semantic_patch(
        ...
        **kwargs,
        ...
        if validate:
            return UserSegmentPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserSegmentPydantic, raw_response.body)
