...
class BaseApi(api_client.Api):
    ...
    def _single_segment_by_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _asingle_segment_by_key_oapg(
        self,
    ...
    def _single_segment_by_key_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SingleSegmentByKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asingle_segment_by_key(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        **kwargs,
        ...
        args = self._single_segment_by_key_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        )
        return await self._asingle_segment_by_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def single_segment_by_key(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        return self._single_segment_by_key_oapg(
            path_params=args.path,
        )

class SingleSegmentByKey(BaseApi):
    ...
    async def asingle_segment_by_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asingle_segment_by_key(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            **kwargs,
    ...
    def single_segment_by_key(
        ...
        raw_response = self.raw.single_segment_by_key(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
        )
