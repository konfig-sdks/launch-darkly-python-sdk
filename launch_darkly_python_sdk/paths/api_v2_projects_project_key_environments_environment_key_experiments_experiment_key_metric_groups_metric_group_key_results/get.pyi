...
from launch_darkly_python_sdk.model.metric_group_results_rep import MetricGroupResultsRep as MetricGroupResultsRepSchema
...
from launch_darkly_python_sdk.type.metric_group_results_rep import MetricGroupResultsRep
...
from launch_darkly_python_sdk.pydantic.metric_group_results_rep import MetricGroupResultsRep as MetricGroupResultsRepPydantic
...
# Query params
IterationIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'iterationId': typing.Union[IterationIdSchema, str, ],
    },
    total=False
)
...
request_query_iteration_id = api_client.QueryParameter(
    name="iterationId",
    style=api_client.ParameterStyle.FORM,
    schema=IterationIdSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = MetricGroupResultsRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MetricGroupResultsRep
...
class BaseApi(api_client.Api):
    ...
    def _get_results_for_metric_group_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        experiment_key: str,
        metric_group_key: str,
        iteration_id: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _path_params = {}
        if iteration_id is not None:
            _query_params["iterationId"] = iteration_id
    ...
    async def _aget_results_for_metric_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}/metric-groups/{metricGroupKey}/results',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_results_for_metric_group_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetResultsForMetricGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_results_for_metric_group(
        self,
        project_key: str,
        environment_key: str,
        experiment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_results_for_metric_group_mapped_args(
        ...
        return await self._aget_results_for_metric_group_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_results_for_metric_group(
        self,
        project_key: str,
        environment_key: str,
        experiment_key: str,
        ...
        return self._get_results_for_metric_group_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetResultsForMetricGroup(BaseApi):
    ...
    async def aget_results_for_metric_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MetricGroupResultsRepPydantic:
        raw_response = await self.raw.aget_results_for_metric_group(
            project_key=project_key,
            environment_key=environment_key,
            experiment_key=experiment_key,
            metric_group_key=metric_group_key,
        ...
        if validate:
            return MetricGroupResultsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(MetricGroupResultsRepPydantic, raw_response.body)
    ...
    def get_results_for_metric_group(
        ...
        raw_response = self.raw.get_results_for_metric_group(
            project_key=project_key,
            environment_key=environment_key,
            experiment_key=experiment_key,
            metric_group_key=metric_group_key,
