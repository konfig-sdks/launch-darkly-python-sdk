...
from launch_darkly_python_sdk.model.pull_request_collection_rep import PullRequestCollectionRep as PullRequestCollectionRepSchema
...
from launch_darkly_python_sdk.type.pull_request_collection_rep import PullRequestCollectionRep
...
from launch_darkly_python_sdk.pydantic.pull_request_collection_rep import PullRequestCollectionRep as PullRequestCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = PullRequestCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PullRequestCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_pull_requests_mapped_args(
        self,
        project_key: str,
    ...
    async def _alist_pull_requests_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/pull-requests',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListPullRequestsRaw(BaseApi):
    ...
    async def alist_pull_requests(
        ...
        **kwargs,
        ...
        args = self._list_pull_requests_mapped_args(
        ...
        return await self._alist_pull_requests_oapg(
    ...
    def list_pull_requests(
        ...
        return self._list_pull_requests_oapg(
            query_params=args.query,
        )

class ListPullRequests(BaseApi):
    ...
    async def alist_pull_requests(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PullRequestCollectionRepPydantic:
        raw_response = await self.raw.alist_pull_requests(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            status=status,
        ...
        if validate:
            return PullRequestCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(PullRequestCollectionRepPydantic, raw_response.body)
    ...
    def list_pull_requests(
        ...
        raw_response = self.raw.list_pull_requests(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            status=status,
