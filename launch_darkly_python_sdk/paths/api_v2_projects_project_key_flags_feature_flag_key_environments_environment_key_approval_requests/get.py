...
from launch_darkly_python_sdk.model.flag_config_approval_requests_response import FlagConfigApprovalRequestsResponse as FlagConfigApprovalRequestsResponseSchema

from launch_darkly_python_sdk.type.flag_config_approval_requests_response import FlagConfigApprovalRequestsResponse
...
from launch_darkly_python_sdk.pydantic.flag_config_approval_requests_response import FlagConfigApprovalRequestsResponse as FlagConfigApprovalRequestsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FlagConfigApprovalRequestsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FlagConfigApprovalRequestsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_requests_for_flag_mapped_args(
        self,
        project_key: str,
    ...
    async def _alist_requests_for_flag_oapg(
        self,
    ...
    def _list_requests_for_flag_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListRequestsForFlagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_requests_for_flag(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._list_requests_for_flag_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        )
        return await self._alist_requests_for_flag_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_requests_for_flag(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        return self._list_requests_for_flag_oapg(
            path_params=args.path,
        )

class ListRequestsForFlag(BaseApi):
    ...
    async def alist_requests_for_flag(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FlagConfigApprovalRequestsResponsePydantic:
        raw_response = await self.raw.alist_requests_for_flag(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            **kwargs,
        ...
        if validate:
            return FlagConfigApprovalRequestsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagConfigApprovalRequestsResponsePydantic, raw_response.body)
    ...
    def list_requests_for_flag(
        ...
        raw_response = self.raw.list_requests_for_flag(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        )
