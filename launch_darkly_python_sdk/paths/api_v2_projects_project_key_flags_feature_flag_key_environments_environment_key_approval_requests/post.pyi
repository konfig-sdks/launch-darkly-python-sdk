...
from launch_darkly_python_sdk.model.create_flag_config_approval_request_request import CreateFlagConfigApprovalRequestRequest as CreateFlagConfigApprovalRequestRequestSchema
from launch_darkly_python_sdk.model.instructions import Instructions as InstructionsSchema
...
from launch_darkly_python_sdk.model.create_flag_config_approval_request_request_notify_member_ids import CreateFlagConfigApprovalRequestRequestNotifyMemberIds as CreateFlagConfigApprovalRequestRequestNotifyMemberIdsSchema
...
from launch_darkly_python_sdk.model.form_variable_config import FormVariableConfig as FormVariableConfigSchema
from launch_darkly_python_sdk.model.create_flag_config_approval_request_request_notify_team_keys import CreateFlagConfigApprovalRequestRequestNotifyTeamKeys as CreateFlagConfigApprovalRequestRequestNotifyTeamKeysSchema

from launch_darkly_python_sdk.type.create_flag_config_approval_request_request import CreateFlagConfigApprovalRequestRequest
...
from launch_darkly_python_sdk.type.create_flag_config_approval_request_request_notify_team_keys import CreateFlagConfigApprovalRequestRequestNotifyTeamKeys
from launch_darkly_python_sdk.type.unauthorized_error_rep import UnauthorizedErrorRep
from launch_darkly_python_sdk.type.instructions import Instructions
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep
from launch_darkly_python_sdk.type.create_flag_config_approval_request_request_notify_member_ids import CreateFlagConfigApprovalRequestRequestNotifyMemberIds
from launch_darkly_python_sdk.type.form_variable_config import FormVariableConfig

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.instructions import Instructions as InstructionsPydantic
from launch_darkly_python_sdk.pydantic.create_flag_config_approval_request_request import CreateFlagConfigApprovalRequestRequest as CreateFlagConfigApprovalRequestRequestPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.form_variable_config import FormVariableConfig as FormVariableConfigPydantic
from launch_darkly_python_sdk.pydantic.create_flag_config_approval_request_request_notify_member_ids import CreateFlagConfigApprovalRequestRequestNotifyMemberIds as CreateFlagConfigApprovalRequestRequestNotifyMemberIdsPydantic
...
from launch_darkly_python_sdk.pydantic.create_flag_config_approval_request_request_notify_team_keys import CreateFlagConfigApprovalRequestRequestNotifyTeamKeys as CreateFlagConfigApprovalRequestRequestNotifyTeamKeysPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateFlagConfigApprovalRequestRequestSchema


request_body_create_flag_config_approval_request_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_request_flag_0_mapped_args(
        self,
        description: str,
        ...
        notify_member_ids: typing.Optional[CreateFlagConfigApprovalRequestRequestNotifyMemberIds] = None,
        notify_team_keys: typing.Optional[CreateFlagConfigApprovalRequestRequestNotifyTeamKeys] = None,
        execution_date: typing.Optional[int] = None,
        operating_on_id: typing.Optional[str] = None,
        integration_config: typing.Optional[FormVariableConfig] = None,
        ...
        if operating_on_id is not None:
            _body["operatingOnId"] = operating_on_id
        if integration_config is not None:
            _body["integrationConfig"] = integration_config
        args.body = _body
    ...
    async def _acreate_request_flag_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_flag_config_approval_request_request.serialize(body, content_type)
    ...
    def _create_request_flag_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateRequestFlag0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_request_flag_0(
        self,
        description: str,
        instructions: Instructions,
        project_key: str,
        ...
        **kwargs,
        ...
        args = self._create_request_flag_0_mapped_args(
            ...
            operating_on_id=operating_on_id,
            integration_config=integration_config,
        )
        return await self._acreate_request_flag_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_request_flag_0(
        self,
        description: str,
        instructions: Instructions,
        project_key: str,
        ...
        return self._create_request_flag_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateRequestFlag0(BaseApi):
    ...
    async def acreate_request_flag_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_request_flag_0(
            description=description,
            instructions=instructions,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
    ...
    def create_request_flag_0(
        ...
        raw_response = self.raw.create_request_flag_0(
            description=description,
            instructions=instructions,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
