...
class BaseApi(api_client.Api):
    ...
    def _delete_workflow_mapped_args(
        self,
        project_key: str,
    ...
    async def _adelete_workflow_oapg(
        self,
...
class DeleteWorkflowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_workflow(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._delete_workflow_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
        )
        return await self._adelete_workflow_oapg(
    ...
    def delete_workflow(
        ...
        return self._delete_workflow_oapg(
            path_params=args.path,
        )

class DeleteWorkflow(BaseApi):
    ...
    async def adelete_workflow(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_workflow(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    def delete_workflow(
        ...
        raw_response = self.raw.delete_workflow(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
