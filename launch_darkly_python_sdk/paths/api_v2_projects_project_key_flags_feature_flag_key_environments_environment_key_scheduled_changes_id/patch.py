...
from launch_darkly_python_sdk.model.feature_flag_scheduled_change import FeatureFlagScheduledChange as FeatureFlagScheduledChangeSchema
...
from launch_darkly_python_sdk.model.flag_scheduled_changes_input import FlagScheduledChangesInput as FlagScheduledChangesInputSchema
...
from launch_darkly_python_sdk.type.feature_flag_scheduled_change import FeatureFlagScheduledChange
from launch_darkly_python_sdk.type.flag_scheduled_changes_input import FlagScheduledChangesInput
...
from launch_darkly_python_sdk.pydantic.flag_scheduled_changes_input import FlagScheduledChangesInput as FlagScheduledChangesInputPydantic
from launch_darkly_python_sdk.pydantic.feature_flag_scheduled_change import FeatureFlagScheduledChange as FeatureFlagScheduledChangePydantic
...
# Query params
IgnoreConflictsSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'ignoreConflicts': typing.Union[IgnoreConflictsSchema, bool, ],
    },
    total=False
)
...
request_query_ignore_conflicts = api_client.QueryParameter(
    name="ignoreConflicts",
    style=api_client.ParameterStyle.FORM,
    schema=IgnoreConflictsSchema,
    explode=True,
)
# Path params
...
# body param
SchemaForRequestBodyApplicationJson = FlagScheduledChangesInputSchema


request_body_flag_scheduled_changes_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FeatureFlagScheduledChangeSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeatureFlagScheduledChange
...
class BaseApi(api_client.Api):
    ...
    def _update_workflow_mapped_args(
        self,
        ...
        ignore_conflicts: typing.Optional[bool] = None,
        ...
        if ignore_conflicts is not None:
            _query_params["ignoreConflicts"] = ignore_conflicts
    ...
    async def _aupdate_workflow_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_ignore_conflicts,
        ):
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_flag_scheduled_changes_input.serialize(body, content_type)
...
class UpdateWorkflowRaw(BaseApi):
    ...
    async def aupdate_workflow(
        ...
        **kwargs,
        ...
        args = self._update_workflow_mapped_args(
            instructions=instructions,
        ...
        return await self._aupdate_workflow_oapg(
            body=args.body,
    ...
    def update_workflow(
        ...
        return self._update_workflow_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateWorkflow(BaseApi):
    ...
    async def aupdate_workflow(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeatureFlagScheduledChangePydantic:
        raw_response = await self.raw.aupdate_workflow(
            instructions=instructions,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        ...
        if validate:
            return FeatureFlagScheduledChangePydantic(**raw_response.body)
        return api_client.construct_model_instance(FeatureFlagScheduledChangePydantic, raw_response.body)
    ...
    def update_workflow(
        ...
        raw_response = self.raw.update_workflow(
            instructions=instructions,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
