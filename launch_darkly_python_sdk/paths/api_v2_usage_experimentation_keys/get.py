...
class BaseApi(api_client.Api):
    ...
    def _get_experimentation_keys_usage_mapped_args(
        self,
    ...
    async def _aget_experimentation_keys_usage_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/experimentation-keys',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_experimentation_keys_usage_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExperimentationKeysUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_experimentation_keys_usage(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_experimentation_keys_usage_mapped_args(
            _from=_from,
            to=to,
        )
        return await self._aget_experimentation_keys_usage_oapg(
    ...
    def get_experimentation_keys_usage(
        ...
        return self._get_experimentation_keys_usage_oapg(
            query_params=args.query,
        )

class GetExperimentationKeysUsage(BaseApi):
    ...
    async def aget_experimentation_keys_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_experimentation_keys_usage(
            _from=_from,
            to=to,
            **kwargs,
        )
    ...
    def get_experimentation_keys_usage(
        ...
        raw_response = self.raw.get_experimentation_keys_usage(
            _from=_from,
            to=to,
        )
        if validate:
