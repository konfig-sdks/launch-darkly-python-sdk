...
from launch_darkly_python_sdk.model.feature_flag_body import FeatureFlagBody as FeatureFlagBodySchema
...
from launch_darkly_python_sdk.model.feature_flag import FeatureFlag as FeatureFlagSchema
from launch_darkly_python_sdk.model.unauthorized_error_rep import UnauthorizedErrorRep as UnauthorizedErrorRepSchema
from launch_darkly_python_sdk.model.migration_settings_post import MigrationSettingsPost as MigrationSettingsPostSchema
...
from launch_darkly_python_sdk.model.variation import Variation as VariationSchema
from launch_darkly_python_sdk.model.defaults import Defaults as DefaultsSchema
from launch_darkly_python_sdk.model.feature_flag_body_tags import FeatureFlagBodyTags as FeatureFlagBodyTagsSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema
from launch_darkly_python_sdk.model.custom_properties import CustomProperties as CustomPropertiesSchema
from launch_darkly_python_sdk.model.client_side_availability_post import ClientSideAvailabilityPost as ClientSideAvailabilityPostSchema

from launch_darkly_python_sdk.type.migration_settings_post import MigrationSettingsPost
from launch_darkly_python_sdk.type.custom_properties import CustomProperties
from launch_darkly_python_sdk.type.defaults import Defaults
from launch_darkly_python_sdk.type.feature_flag import FeatureFlag
from launch_darkly_python_sdk.type.variation import Variation
...
from launch_darkly_python_sdk.type.feature_flag_body import FeatureFlagBody
...
from launch_darkly_python_sdk.type.feature_flag_body_tags import FeatureFlagBodyTags
from launch_darkly_python_sdk.type.client_side_availability_post import ClientSideAvailabilityPost

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.migration_settings_post import MigrationSettingsPost as MigrationSettingsPostPydantic
from launch_darkly_python_sdk.pydantic.feature_flag_body import FeatureFlagBody as FeatureFlagBodyPydantic
from launch_darkly_python_sdk.pydantic.variation import Variation as VariationPydantic
from launch_darkly_python_sdk.pydantic.feature_flag_body_tags import FeatureFlagBodyTags as FeatureFlagBodyTagsPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.client_side_availability_post import ClientSideAvailabilityPost as ClientSideAvailabilityPostPydantic
from launch_darkly_python_sdk.pydantic.custom_properties import CustomProperties as CustomPropertiesPydantic
from launch_darkly_python_sdk.pydantic.defaults import Defaults as DefaultsPydantic
...
from launch_darkly_python_sdk.pydantic.feature_flag import FeatureFlag as FeatureFlagPydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'clone': typing.Union[CloneSchema, str, ],
    },
    total=False
)
...
request_query_clone = api_client.QueryParameter(
    name="clone",
...
# body param
SchemaForRequestBodyApplicationJson = FeatureFlagBodySchema


request_body_feature_flag_body = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FeatureFlagSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_feature_flag_mapped_args(
        self,
        name: str,
        key: str,
        project_key: str,
        tags: typing.Optional[FeatureFlagBodyTags] = None,
        description: typing.Optional[str] = None,
        include_in_snippet: typing.Optional[bool] = None,
        client_side_availability: typing.Optional[ClientSideAvailabilityPost] = None,
        variations: typing.Optional[typing.List[Variation]] = None,
        temporary: typing.Optional[bool] = None,
        custom_properties: typing.Optional[CustomProperties] = None,
        defaults: typing.Optional[Defaults] = None,
        purpose: typing.Optional[str] = None,
        migration_settings: typing.Optional[MigrationSettingsPost] = None,
        clone: typing.Optional[str] = None,
        ...
        if include_in_snippet is not None:
            _body["includeInSnippet"] = include_in_snippet
        if client_side_availability is not None:
            _body["clientSideAvailability"] = client_side_availability
        if variations is not None:
            _body["variations"] = variations
        if temporary is not None:
            _body["temporary"] = temporary
        if custom_properties is not None:
            _body["customProperties"] = custom_properties
        if defaults is not None:
            _body["defaults"] = defaults
        if purpose is not None:
            _body["purpose"] = purpose
        if migration_settings is not None:
            _body["migrationSettings"] = migration_settings
        args.body = _body
        if clone is not None:
            _query_params["clone"] = clone
    ...
    async def _acreate_feature_flag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_feature_flag_body.serialize(body, content_type)
...
class CreateFeatureFlagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_feature_flag(
        self,
        name: str,
        key: str,
        project_key: str,
        ...
        **kwargs,
        ...
        args = self._create_feature_flag_mapped_args(
            name=name,
            key=key,
        ...
        return await self._acreate_feature_flag_oapg(
            body=args.body,
...
class CreateFeatureFlag(BaseApi):
    ...
    async def acreate_feature_flag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_feature_flag(
            name=name,
            key=key,
            project_key=project_key,
            tags=tags,
        ...
        if validate:
            return FeatureFlagPydantic(**raw_response.body)
        return api_client.construct_model_instance(FeatureFlagPydantic, raw_response.body)
    ...
    def create_feature_flag(
        ...
        raw_response = self.raw.create_feature_flag(
            name=name,
            key=key,
            project_key=project_key,
            tags=tags,
