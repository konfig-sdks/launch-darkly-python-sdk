...
from launch_darkly_python_sdk.model.feature_flags import FeatureFlags as FeatureFlagsSchema
...
from launch_darkly_python_sdk.type.feature_flags import FeatureFlags
...
from launch_darkly_python_sdk.pydantic.feature_flags import FeatureFlags as FeatureFlagsPydantic
...
CompareSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'compare': typing.Union[CompareSchema, bool, ],
...
request_query_compare = api_client.QueryParameter(
    name="compare",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = FeatureFlagsSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return FeatureFlagsPydantic(**raw_response.body)
        return api_client.construct_model_instance(FeatureFlagsPydantic, raw_response.body)
