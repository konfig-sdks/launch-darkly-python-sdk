...
class BaseApi(api_client.Api):
    ...
    def _get_client_by_id_mapped_args(
        self,
        client_id: str,
    ...
    async def _aget_client_by_id_oapg(
        self,
...
class GetClientByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_client_by_id(
        self,
        client_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_client_by_id_mapped_args(
            client_id=client_id,
        )
        return await self._aget_client_by_id_oapg(
    ...
    def get_client_by_id(
        ...
        return self._get_client_by_id_oapg(
            path_params=args.path,
        )

class GetClientById(BaseApi):
    ...
    async def aget_client_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_client_by_id(
            client_id=client_id,
            **kwargs,
        )
        if validate:
    ...
    def get_client_by_id(
        ...
        raw_response = self.raw.get_client_by_id(
            client_id=client_id,
        )
        if validate:
            return ClientPydantic(**raw_response.body)
