...
class BaseApi(api_client.Api):
    ...
    def _delete_client_by_id_mapped_args(
        self,
        client_id: str,
    ...
    async def _adelete_client_by_id_oapg(
        self,
...
class DeleteClientByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_client_by_id(
        self,
        client_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_client_by_id_mapped_args(
            client_id=client_id,
        )
        return await self._adelete_client_by_id_oapg(
    ...
    def delete_client_by_id(
        ...
        return self._delete_client_by_id_oapg(
            path_params=args.path,
        )

class DeleteClientById(BaseApi):
    ...
    async def adelete_client_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_client_by_id(
            client_id=client_id,
            **kwargs,
        )
    ...
    def delete_client_by_id(
        ...
        raw_response = self.raw.delete_client_by_id(
            client_id=client_id,
        )
