...
from launch_darkly_python_sdk.model.client import Client as ClientSchema
...
from launch_darkly_python_sdk.type.client import Client

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.json_patch import JSONPatch as JSONPatchPydantic
from launch_darkly_python_sdk.pydantic.client import Client as ClientPydantic
...
SchemaFor200ResponseBodyApplicationJson = ClientSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_client_by_id_mapped_args(
        self,
        body: JSONPatch,
        client_id: str,
    ...
    async def _aupdate_client_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/oauth/clients/{clientId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateClientByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_client_by_id(
        self,
        body: JSONPatch,
        client_id: str,
        **kwargs,
        ...
        args = self._update_client_by_id_mapped_args(
            body=body,
            client_id=client_id,
        )
        return await self._aupdate_client_by_id_oapg(
            body=args.body,
    ...
    def update_client_by_id(
        ...
        return self._update_client_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateClientById(BaseApi):
    ...
    async def aupdate_client_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_client_by_id(
            body=body,
            client_id=client_id,
            **kwargs,
        )
        if validate:
            return ClientPydantic(**raw_response.body)
        return api_client.construct_model_instance(ClientPydantic, raw_response.body)
    ...
    def update_client_by_id(
        ...
        raw_response = self.raw.update_client_by_id(
            body=body,
            client_id=client_id,
        )
        if validate:
