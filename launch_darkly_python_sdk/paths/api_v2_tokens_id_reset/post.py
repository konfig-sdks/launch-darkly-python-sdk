...
class BaseApi(api_client.Api):
    ...
    def _reset_secret_key_mapped_args(
        self,
        id: str,
    ...
    async def _areset_secret_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/tokens/{id}/reset',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ResetSecretKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_secret_key(
        self,
        id: str,
        expiry: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._reset_secret_key_mapped_args(
            id=id,
            expiry=expiry,
        )
        return await self._areset_secret_key_oapg(
    ...
    def reset_secret_key(
        ...
        return self._reset_secret_key_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ResetSecretKey(BaseApi):
    ...
    async def areset_secret_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areset_secret_key(
            id=id,
            expiry=expiry,
            **kwargs,
        )
    ...
    def reset_secret_key(
        ...
        raw_response = self.raw.reset_secret_key(
            id=id,
            expiry=expiry,
        )
        if validate:
