...
from launch_darkly_python_sdk.model.series_intervals_rep import SeriesIntervalsRep as SeriesIntervalsRepSchema
...
from launch_darkly_python_sdk.type.series_intervals_rep import SeriesIntervalsRep
...
from launch_darkly_python_sdk.pydantic.series_intervals_rep import SeriesIntervalsRep as SeriesIntervalsRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = SeriesIntervalsRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SeriesIntervalsRep
...
class BaseApi(api_client.Api):
    ...
    def _get_experimentation_units_usage_mapped_args(
        self,
    ...
    async def _aget_experimentation_units_usage_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/experimentation-units',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_experimentation_units_usage_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetExperimentationUnitsUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_experimentation_units_usage(
        self,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_experimentation_units_usage_mapped_args(
            _from=_from,
            to=to,
        )
        return await self._aget_experimentation_units_usage_oapg(
    ...
    def get_experimentation_units_usage(
        ...
        return self._get_experimentation_units_usage_oapg(
            query_params=args.query,
        )

class GetExperimentationUnitsUsage(BaseApi):
    ...
    async def aget_experimentation_units_usage(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SeriesIntervalsRepPydantic:
        raw_response = await self.raw.aget_experimentation_units_usage(
            _from=_from,
            to=to,
            **kwargs,
        )
        if validate:
            return SeriesIntervalsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(SeriesIntervalsRepPydantic, raw_response.body)
    ...
    def get_experimentation_units_usage(
        ...
        raw_response = self.raw.get_experimentation_units_usage(
            _from=_from,
            to=to,
        )
        if validate:
