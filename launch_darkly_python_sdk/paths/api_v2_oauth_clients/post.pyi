...
from launch_darkly_python_sdk.model.oauth_client_post import OauthClientPost as OauthClientPostSchema
...
from launch_darkly_python_sdk.type.oauth_client_post import OauthClientPost
...
from launch_darkly_python_sdk.pydantic.oauth_client_post import OauthClientPost as OauthClientPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = OauthClientPostSchema


request_body_oauth_client_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ClientSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_client_mapped_args(
        self,
    ...
    async def _acreate_client_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/oauth/clients',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_oauth_client_post.serialize(body, content_type)
...
class CreateClientRaw(BaseApi):
    ...
    async def acreate_client(
        ...
        **kwargs,
        ...
        args = self._create_client_mapped_args(
            description=description,
            name=name,
            redirect_uri=redirect_uri,
        )
        return await self._acreate_client_oapg(
            body=args.body,
            **kwargs,
        )
...
class CreateClient(BaseApi):
    ...
    async def acreate_client(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_client(
            description=description,
            name=name,
            redirect_uri=redirect_uri,
            **kwargs,
    ...
    def create_client(
        ...
        raw_response = self.raw.create_client(
            description=description,
            name=name,
            redirect_uri=redirect_uri,
        )
