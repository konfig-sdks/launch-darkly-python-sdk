...
from launch_darkly_python_sdk.model.client_collection import ClientCollection as ClientCollectionSchema
...
from launch_darkly_python_sdk.type.client_collection import ClientCollection

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.client_collection import ClientCollection as ClientCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = ClientCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ClientCollection
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ClientCollectionPydantic:
        raw_response = await self.raw.alist(
            **kwargs,
        )
        if validate:
            return ClientCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ClientCollectionPydantic, raw_response.body)
