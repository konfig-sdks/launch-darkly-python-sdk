...
SchemaFor200ResponseBodyApplicationJson = IntegrationDeliveryConfigurationSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_delivery_configuration_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
    ...
    async def _aupdate_delivery_configuration_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/integration-capabilities/featureStore/{projectKey}/{environmentKey}/{integrationKey}/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_delivery_configuration_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateDeliveryConfigurationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_delivery_configuration(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_delivery_configuration_mapped_args(
            body=body,
        ...
        return await self._aupdate_delivery_configuration_oapg(
            body=args.body,
    ...
    def update_delivery_configuration(
        ...
        return self._update_delivery_configuration_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDeliveryConfiguration(BaseApi):
    ...
    async def aupdate_delivery_configuration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_delivery_configuration(
            body=body,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
    ...
    def update_delivery_configuration(
        ...
        raw_response = self.raw.update_delivery_configuration(
            body=body,
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
