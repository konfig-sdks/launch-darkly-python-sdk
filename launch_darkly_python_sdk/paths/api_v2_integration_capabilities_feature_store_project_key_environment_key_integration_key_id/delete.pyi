...
class BaseApi(api_client.Api):
    ...
    def _delete_delivery_configuration_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
    ...
    async def _adelete_delivery_configuration_oapg(
        self,
    ...
    def _delete_delivery_configuration_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteDeliveryConfigurationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_delivery_configuration(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
        ...
        **kwargs,
        ...
        args = self._delete_delivery_configuration_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            id=id,
        )
        return await self._adelete_delivery_configuration_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_delivery_configuration(
        self,
        project_key: str,
        environment_key: str,
        integration_key: str,
        ...
        return self._delete_delivery_configuration_oapg(
            path_params=args.path,
        )

class DeleteDeliveryConfiguration(BaseApi):
    ...
    async def adelete_delivery_configuration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_delivery_configuration(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            id=id,
    ...
    def delete_delivery_configuration(
        ...
        raw_response = self.raw.delete_delivery_configuration(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            id=id,
