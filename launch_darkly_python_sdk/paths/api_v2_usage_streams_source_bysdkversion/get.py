...
request_query_tz = api_client.QueryParameter(
    name="tz",
    style=api_client.ParameterStyle.FORM,
    schema=TzSchema,
    explode=True,
...
class BaseApi(api_client.Api):
    ...
    def _get_stream_usage_by_sdk_version_data_mapped_args(
        self,
        source: str,
    ...
    async def _aget_stream_usage_by_sdk_version_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/streams/{source}/bysdkversion',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_stream_usage_by_sdk_version_data_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetStreamUsageBySdkVersionDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_stream_usage_by_sdk_version_data(
        self,
        source: str,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_stream_usage_by_sdk_version_data_mapped_args(
            source=source,
            _from=_from,
            to=to,
            tz=tz,
        ...
        return await self._aget_stream_usage_by_sdk_version_data_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_stream_usage_by_sdk_version_data(
        self,
        source: str,
        _from: typing.Optional[str] = None,
        to: typing.Optional[str] = None,
        ...
        return self._get_stream_usage_by_sdk_version_data_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetStreamUsageBySdkVersionData(BaseApi):
    ...
    async def aget_stream_usage_by_sdk_version_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_stream_usage_by_sdk_version_data(
            source=source,
            _from=_from,
            to=to,
            tz=tz,
    ...
    def get_stream_usage_by_sdk_version_data(
        ...
        raw_response = self.raw.get_stream_usage_by_sdk_version_data(
            source=source,
            _from=_from,
            to=to,
            tz=tz,
