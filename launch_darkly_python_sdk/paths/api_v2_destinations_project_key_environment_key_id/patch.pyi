...
from launch_darkly_python_sdk.model.destination import Destination as DestinationSchema
...
from launch_darkly_python_sdk.type.destination import Destination
...
from launch_darkly_python_sdk.pydantic.destination import Destination as DestinationPydantic
...
SchemaFor200ResponseBodyApplicationJson = DestinationSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_destination_patch_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
    ...
    async def _aupdate_destination_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/destinations/{projectKey}/{environmentKey}/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_destination_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateDestinationPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_destination_patch(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._update_destination_patch_mapped_args(
            body=body,
            project_key=project_key,
            environment_key=environment_key,
            id=id,
        )
        return await self._aupdate_destination_patch_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_destination_patch(
        self,
        body: JSONPatch,
        project_key: str,
        environment_key: str,
        ...
        return self._update_destination_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDestinationPatch(BaseApi):
    ...
    async def aupdate_destination_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_destination_patch(
            body=body,
            project_key=project_key,
            environment_key=environment_key,
            id=id,
        ...
        if validate:
            return DestinationPydantic(**raw_response.body)
        return api_client.construct_model_instance(DestinationPydantic, raw_response.body)
    ...
    def update_destination_patch(
        ...
        raw_response = self.raw.update_destination_patch(
            body=body,
            project_key=project_key,
            environment_key=environment_key,
            id=id,
