...
class BaseApi(api_client.Api):
    ...
    def _remove_application_mapped_args(
        self,
        application_key: str,
    ...
    async def _aremove_application_oapg(
        self,
...
class RemoveApplicationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_application(
        self,
        application_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_application_mapped_args(
            application_key=application_key,
        )
        return await self._aremove_application_oapg(
    ...
    def remove_application(
        ...
        return self._remove_application_oapg(
            path_params=args.path,
        )
...
class RemoveApplication(BaseApi):
    ...
    async def aremove_application(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_application(
            application_key=application_key,
            **kwargs,
        )
    ...
    def remove_application(
        ...
        raw_response = self.raw.remove_application(
            application_key=application_key,
        )
