...
class BaseApi(api_client.Api):
    ...
    def _get_application_by_key_mapped_args(
        self,
        application_key: str,
    ...
    async def _aget_application_by_key_oapg(
        self,
    ...
    def _get_application_by_key_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetApplicationByKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_application_by_key(
        self,
        application_key: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_application_by_key_mapped_args(
            application_key=application_key,
            expand=expand,
        )
        return await self._aget_application_by_key_oapg(
    ...
    def get_application_by_key(
        ...
        return self._get_application_by_key_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetApplicationByKey(BaseApi):
    ...
    async def aget_application_by_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_application_by_key(
            application_key=application_key,
            expand=expand,
            **kwargs,
        )
    ...
    def get_application_by_key(
        ...
        raw_response = self.raw.get_application_by_key(
            application_key=application_key,
            expand=expand,
        )
        if validate:
