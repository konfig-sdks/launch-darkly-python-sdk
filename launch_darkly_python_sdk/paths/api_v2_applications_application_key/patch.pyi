...
from launch_darkly_python_sdk.model.application_rep import ApplicationRep as ApplicationRepSchema
...
from launch_darkly_python_sdk.type.application_rep import ApplicationRep
...
from launch_darkly_python_sdk.pydantic.application_rep import ApplicationRep as ApplicationRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = ApplicationRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_application_patch_mapped_args(
        self,
        body: JSONPatch,
        application_key: str,
    ...
    async def _aupdate_application_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/applications/{applicationKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_application_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateApplicationPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_application_patch(
        self,
        body: JSONPatch,
        application_key: str,
        **kwargs,
        ...
        args = self._update_application_patch_mapped_args(
            body=body,
            application_key=application_key,
        )
        return await self._aupdate_application_patch_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_application_patch(
        self,
        body: JSONPatch,
        application_key: str,
    ) -> typing.Union[
        ...
        return self._update_application_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateApplicationPatch(BaseApi):
    ...
    async def aupdate_application_patch(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApplicationRepPydantic:
        raw_response = await self.raw.aupdate_application_patch(
            body=body,
            application_key=application_key,
            **kwargs,
        )
        if validate:
            return ApplicationRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ApplicationRepPydantic, raw_response.body)
    ...
    def update_application_patch(
        ...
        raw_response = self.raw.update_application_patch(
            body=body,
            application_key=application_key,
        )
        if validate:
