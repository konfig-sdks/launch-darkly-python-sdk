...
class BaseApi(api_client.Api):
    ...
    def _single_request_mapped_args(
        self,
        project_key: str,
    ...
    async def _asingle_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SingleRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asingle_request(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._single_request_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
        )
        return await self._asingle_request_oapg(
    ...
    def single_request(
        ...
        return self._single_request_oapg(
            path_params=args.path,
        )

class SingleRequest(BaseApi):
    ...
    async def asingle_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asingle_request(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    def single_request(
        ...
        raw_response = self.raw.single_request(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
