...
class BaseApi(api_client.Api):
    ...
    def _delete_approval_request_flag_mapped_args(
        self,
        project_key: str,
    ...
    async def _adelete_approval_request_flag_oapg(
        self,
    ...
    def _delete_approval_request_flag_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteApprovalRequestFlagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_approval_request_flag(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._delete_approval_request_flag_mapped_args(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
        )
        return await self._adelete_approval_request_flag_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_approval_request_flag(
        self,
        project_key: str,
        feature_flag_key: str,
        environment_key: str,
        ...
        return self._delete_approval_request_flag_oapg(
            path_params=args.path,
        )

class DeleteApprovalRequestFlag(BaseApi):
    ...
    async def adelete_approval_request_flag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_approval_request_flag(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    def delete_approval_request_flag(
        ...
        raw_response = self.raw.delete_approval_request_flag(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
