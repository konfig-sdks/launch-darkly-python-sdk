...
from launch_darkly_python_sdk.model.trigger_workflow_collection_rep import TriggerWorkflowCollectionRep as TriggerWorkflowCollectionRepSchema

from launch_darkly_python_sdk.type.trigger_workflow_collection_rep import TriggerWorkflowCollectionRep
...
from launch_darkly_python_sdk.pydantic.trigger_workflow_collection_rep import TriggerWorkflowCollectionRep as TriggerWorkflowCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = TriggerWorkflowCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TriggerWorkflowCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_trigger_workflows_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _alist_trigger_workflows_oapg(
        self,
    ...
    def _list_trigger_workflows_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListTriggerWorkflowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_trigger_workflows(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        **kwargs,
        ...
        args = self._list_trigger_workflows_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
        return await self._alist_trigger_workflows_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def list_trigger_workflows(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        ...
        return self._list_trigger_workflows_oapg(
            path_params=args.path,
        )

class ListTriggerWorkflows(BaseApi):
    ...
    async def alist_trigger_workflows(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TriggerWorkflowCollectionRepPydantic:
        raw_response = await self.raw.alist_trigger_workflows(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            **kwargs,
        ...
        if validate:
            return TriggerWorkflowCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(TriggerWorkflowCollectionRepPydantic, raw_response.body)
    ...
    def list_trigger_workflows(
        ...
        raw_response = self.raw.list_trigger_workflows(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
