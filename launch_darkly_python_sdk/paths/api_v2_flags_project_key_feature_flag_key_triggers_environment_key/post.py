...
from launch_darkly_python_sdk.model.trigger_post import TriggerPost as TriggerPostSchema
...
from launch_darkly_python_sdk.type.trigger_post import TriggerPost
...
from launch_darkly_python_sdk.pydantic.trigger_post import TriggerPost as TriggerPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TriggerPostSchema


request_body_trigger_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TriggerWorkflowRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_trigger_workflow_mapped_args(
        self,
        integration_key: str,
        project_key: str,
        environment_key: str,
    ...
    async def _acreate_trigger_workflow_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_trigger_post.serialize(body, content_type)
    ...
    def _create_trigger_workflow_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateTriggerWorkflowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_trigger_workflow(
        self,
        integration_key: str,
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._create_trigger_workflow_mapped_args(
        ...
        return await self._acreate_trigger_workflow_oapg(
            body=args.body,
    ...
    def create_trigger_workflow(
        ...
        return self._create_trigger_workflow_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateTriggerWorkflow(BaseApi):
    ...
    async def acreate_trigger_workflow(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_trigger_workflow(
            integration_key=integration_key,
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
    ...
    def create_trigger_workflow(
        ...
        raw_response = self.raw.create_trigger_workflow(
            integration_key=integration_key,
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
