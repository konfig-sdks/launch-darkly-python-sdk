...
from launch_darkly_python_sdk.model.statistic_collection_rep import StatisticCollectionRep as StatisticCollectionRepSchema
...
from launch_darkly_python_sdk.type.statistic_collection_rep import StatisticCollectionRep
...
from launch_darkly_python_sdk.pydantic.statistic_collection_rep import StatisticCollectionRep as StatisticCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = StatisticCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: StatisticCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _get_statistics_0_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_statistics_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/code-refs/statistics/{projectKey}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetStatistics0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_statistics_0(
        self,
        project_key: str,
        flag_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_statistics_0_mapped_args(
            project_key=project_key,
            flag_key=flag_key,
        )
        return await self._aget_statistics_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_statistics_0(
        self,
        project_key: str,
        flag_key: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_statistics_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetStatistics0(BaseApi):
    ...
    async def aget_statistics_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StatisticCollectionRepPydantic:
        raw_response = await self.raw.aget_statistics_0(
            project_key=project_key,
            flag_key=flag_key,
            **kwargs,
        )
        if validate:
            return StatisticCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(StatisticCollectionRepPydantic, raw_response.body)
    ...
    def get_statistics_0(
        ...
        raw_response = self.raw.get_statistics_0(
            project_key=project_key,
            flag_key=flag_key,
        )
        if validate:
