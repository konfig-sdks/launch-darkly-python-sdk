...
from launch_darkly_python_sdk.model.validation_failed_error_rep import ValidationFailedErrorRep as ValidationFailedErrorRepSchema
...
from launch_darkly_python_sdk.model.post_deployment_event_input_deployment_metadata import PostDeploymentEventInputDeploymentMetadata as PostDeploymentEventInputDeploymentMetadataSchema
from launch_darkly_python_sdk.model.post_deployment_event_input import PostDeploymentEventInput as PostDeploymentEventInputSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema
from launch_darkly_python_sdk.model.post_deployment_event_input_event_metadata import PostDeploymentEventInputEventMetadata as PostDeploymentEventInputEventMetadataSchema

from launch_darkly_python_sdk.type.post_deployment_event_input import PostDeploymentEventInput
from launch_darkly_python_sdk.type.post_deployment_event_input_deployment_metadata import PostDeploymentEventInputDeploymentMetadata
...
from launch_darkly_python_sdk.type.post_deployment_event_input_event_metadata import PostDeploymentEventInputEventMetadata
from launch_darkly_python_sdk.type.validation_failed_error_rep import ValidationFailedErrorRep
...
from launch_darkly_python_sdk.pydantic.post_deployment_event_input import PostDeploymentEventInput as PostDeploymentEventInputPydantic
from launch_darkly_python_sdk.pydantic.post_deployment_event_input_event_metadata import PostDeploymentEventInputEventMetadata as PostDeploymentEventInputEventMetadataPydantic
...
from launch_darkly_python_sdk.pydantic.post_deployment_event_input_deployment_metadata import PostDeploymentEventInputDeploymentMetadata as PostDeploymentEventInputDeploymentMetadataPydantic
from launch_darkly_python_sdk.pydantic.validation_failed_error_rep import ValidationFailedErrorRep as ValidationFailedErrorRepPydantic

# body param
SchemaForRequestBodyApplicationJson = PostDeploymentEventInputSchema


request_body_post_deployment_event_input = api_client.RequestBody(
    content={
...
SchemaFor400ResponseBodyApplicationJson = ValidationFailedErrorRepSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ValidationFailedErrorRep
...
class BaseApi(api_client.Api):
    ...
    def _create_deployment_event_mapped_args(
        self,
        version: str,
        project_key: str,
        environment_key: str,
        ...
        application_kind: typing.Optional[str] = None,
        version_name: typing.Optional[str] = None,
        event_time: typing.Optional[int] = None,
        event_metadata: typing.Optional[PostDeploymentEventInputEventMetadata] = None,
        deployment_metadata: typing.Optional[PostDeploymentEventInputDeploymentMetadata] = None,
        ...
        if project_key is not None:
            _body["projectKey"] = project_key
        if environment_key is not None:
            _body["environmentKey"] = environment_key
        if application_key is not None:
            _body["applicationKey"] = application_key
        if application_name is not None:
            _body["applicationName"] = application_name
        if application_kind is not None:
            _body["applicationKind"] = application_kind
        if version_name is not None:
            _body["versionName"] = version_name
        if event_type is not None:
            _body["eventType"] = event_type
        if event_time is not None:
            _body["eventTime"] = event_time
        if event_metadata is not None:
            _body["eventMetadata"] = event_metadata
        if deployment_metadata is not None:
            _body["deploymentMetadata"] = deployment_metadata
        args.body = _body
        return args

    async def _acreate_deployment_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/deployment-events',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_post_deployment_event_input.serialize(body, content_type)
    ...
    def _create_deployment_event_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateDeploymentEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_deployment_event(
        self,
        version: str,
        project_key: str,
        environment_key: str,
        ...
        **kwargs,
        ...
        args = self._create_deployment_event_mapped_args(
            version=version,
        ...
        return await self._acreate_deployment_event_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_deployment_event(
        ...
        return self._create_deployment_event_oapg(
            body=args.body,
        )

class CreateDeploymentEvent(BaseApi):
    ...
    async def acreate_deployment_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_deployment_event(
            version=version,
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
    ...
    def create_deployment_event(
        ...
        raw_response = self.raw.create_deployment_event(
            version=version,
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
