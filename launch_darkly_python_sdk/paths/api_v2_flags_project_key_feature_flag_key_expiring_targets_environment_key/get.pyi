...
from launch_darkly_python_sdk.model.expiring_target_get_response import ExpiringTargetGetResponse as ExpiringTargetGetResponseSchema
...
from launch_darkly_python_sdk.type.expiring_target_get_response import ExpiringTargetGetResponse
...
from launch_darkly_python_sdk.pydantic.expiring_target_get_response import ExpiringTargetGetResponse as ExpiringTargetGetResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ExpiringTargetGetResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExpiringTargetGetResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_context_instance_segments_membership_by_env_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_context_instance_segments_membership_by_env_oapg(
        self,
    ...
    def _get_context_instance_segments_membership_by_env_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetContextInstanceSegmentsMembershipByEnvRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_context_instance_segments_membership_by_env(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        **kwargs,
        ...
        args = self._get_context_instance_segments_membership_by_env_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
        return await self._aget_context_instance_segments_membership_by_env_oapg(
    ...
    def get_context_instance_segments_membership_by_env(
        ...
        return self._get_context_instance_segments_membership_by_env_oapg(
            path_params=args.path,
        )

class GetContextInstanceSegmentsMembershipByEnv(BaseApi):
    ...
    async def aget_context_instance_segments_membership_by_env(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExpiringTargetGetResponsePydantic:
        raw_response = await self.raw.aget_context_instance_segments_membership_by_env(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            **kwargs,
        ...
        if validate:
            return ExpiringTargetGetResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpiringTargetGetResponsePydantic, raw_response.body)
    ...
    def get_context_instance_segments_membership_by_env(
        ...
        raw_response = self.raw.get_context_instance_segments_membership_by_env(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
        )
