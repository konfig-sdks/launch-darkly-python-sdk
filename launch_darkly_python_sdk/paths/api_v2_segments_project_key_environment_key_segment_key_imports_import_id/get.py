...
from launch_darkly_python_sdk.model.model_import import ModelImport as ModelImportSchema

from launch_darkly_python_sdk.type.model_import import ModelImport
...
from launch_darkly_python_sdk.pydantic.model_import import ModelImport as ModelImportPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'importID': typing.Union[ImportIDSchema, str, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = ModelImportSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_import_info_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
    ...
    async def _aget_import_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/imports/{importID}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetImportInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_import_info(
        self,
        project_key: str,
        environment_key: str,
        segment_key: str,
        ...
        **kwargs,
        ...
        args = self._get_import_info_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            import_id=import_id,
        )
        return await self._aget_import_info_oapg(
    ...
    def get_import_info(
        ...
        return self._get_import_info_oapg(
            path_params=args.path,
        )

class GetImportInfo(BaseApi):
    ...
    async def aget_import_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_import_info(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            import_id=import_id,
        ...
        if validate:
            return ModelImportPydantic(**raw_response.body)
        return api_client.construct_model_instance(ModelImportPydantic, raw_response.body)
    ...
    def get_import_info(
        ...
        raw_response = self.raw.get_import_info(
            project_key=project_key,
            environment_key=environment_key,
            segment_key=segment_key,
            import_id=import_id,
