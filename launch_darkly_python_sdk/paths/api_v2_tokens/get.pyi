...
from launch_darkly_python_sdk.model.tokens import Tokens as TokensSchema
...
from launch_darkly_python_sdk.type.tokens import Tokens
...
from launch_darkly_python_sdk.pydantic.tokens import Tokens as TokensPydantic

# Query params
ShowAllSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'showAll': typing.Union[ShowAllSchema, bool, ],
...
request_query_show_all = api_client.QueryParameter(
    name="showAll",
    style=api_client.ParameterStyle.FORM,
    schema=ShowAllSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = TokensSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        self,
        show_all: typing.Optional[bool] = None,
        ...
        if show_all is not None:
            _query_params["showAll"] = show_all
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return TokensPydantic(**raw_response.body)
        return api_client.construct_model_instance(TokensPydantic, raw_response.body)
