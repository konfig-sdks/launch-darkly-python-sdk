...
from launch_darkly_python_sdk.model.token import Token as TokenSchema
from launch_darkly_python_sdk.model.access_token_post_custom_role_ids import AccessTokenPostCustomRoleIds as AccessTokenPostCustomRoleIdsSchema
from launch_darkly_python_sdk.model.access_token_post import AccessTokenPost as AccessTokenPostSchema
...
from launch_darkly_python_sdk.model.statement_post import StatementPost as StatementPostSchema

from launch_darkly_python_sdk.type.statement_post import StatementPost
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.access_token_post import AccessTokenPost
...
from launch_darkly_python_sdk.type.token import Token
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep
from launch_darkly_python_sdk.type.access_token_post_custom_role_ids import AccessTokenPostCustomRoleIds

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.access_token_post_custom_role_ids import AccessTokenPostCustomRoleIds as AccessTokenPostCustomRoleIdsPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.statement_post import StatementPost as StatementPostPydantic
from launch_darkly_python_sdk.pydantic.token import Token as TokenPydantic
...
from launch_darkly_python_sdk.pydantic.access_token_post import AccessTokenPost as AccessTokenPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AccessTokenPostSchema


request_body_access_token_post = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_token_mapped_args(
        self,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        role: typing.Optional[str] = None,
        custom_role_ids: typing.Optional[AccessTokenPostCustomRoleIds] = None,
        inline_role: typing.Optional[typing.List[StatementPost]] = None,
        service_token: typing.Optional[bool] = None,
        default_api_version: typing.Optional[int] = None,
        ...
        if custom_role_ids is not None:
            _body["customRoleIds"] = custom_role_ids
        if inline_role is not None:
            _body["inlineRole"] = inline_role
        if service_token is not None:
            _body["serviceToken"] = service_token
        if default_api_version is not None:
            _body["defaultApiVersion"] = default_api_version
        args.body = _body
        return args

    async def _acreate_new_token_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/tokens',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_access_token_post.serialize(body, content_type)
...
class CreateNewTokenRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_token(
        self,
        description: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        role: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_token_mapped_args(
        ...
        return await self._acreate_new_token_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_token(
        ...
        return self._create_new_token_oapg(
            body=args.body,
        )

class CreateNewToken(BaseApi):
    ...
    async def acreate_new_token(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_token(
            description=description,
            name=name,
            role=role,
            custom_role_ids=custom_role_ids,
    ...
    def create_new_token(
        ...
        raw_response = self.raw.create_new_token(
            description=description,
            name=name,
            role=role,
            custom_role_ids=custom_role_ids,
