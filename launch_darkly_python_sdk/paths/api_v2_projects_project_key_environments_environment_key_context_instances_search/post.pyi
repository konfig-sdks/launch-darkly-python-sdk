...
from launch_darkly_python_sdk.model.context_instances import ContextInstances as ContextInstancesSchema
from launch_darkly_python_sdk.model.context_instance_search import ContextInstanceSearch as ContextInstanceSearchSchema
...
from launch_darkly_python_sdk.type.context_instances import ContextInstances
...
from launch_darkly_python_sdk.type.context_instance_search import ContextInstanceSearch

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.context_instance_search import ContextInstanceSearch as ContextInstanceSearchPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.context_instances import ContextInstances as ContextInstancesPydantic
...
request_query_include_total_count = api_client.QueryParameter(
...
# body param
SchemaForRequestBodyApplicationJson = ContextInstanceSearchSchema


request_body_context_instance_search = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContextInstancesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContextInstances
...
class BaseApi(api_client.Api):
    ...
    def _search_context_instances_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        ...
        if continuation_token is not None:
            _body["continuationToken"] = continuation_token
        args.body = _body
        if limit is not None:
        ...
        if include_total_count is not None:
            _query_params["includeTotalCount"] = include_total_count
    ...
    async def _asearch_context_instances_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_include_total_count,
        ):
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/context-instances/search',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_context_instance_search.serialize(body, content_type)
    ...
    def _search_context_instances_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class SearchContextInstancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_context_instances(
        self,
        project_key: str,
        environment_key: str,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._search_context_instances_mapped_args(
        ...
        return await self._asearch_context_instances_oapg(
            body=args.body,
    ...
    def search_context_instances(
        ...
        return self._search_context_instances_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class SearchContextInstances(BaseApi):
    ...
    async def asearch_context_instances(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContextInstancesPydantic:
        raw_response = await self.raw.asearch_context_instances(
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
            sort=sort,
        ...
        if validate:
            return ContextInstancesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContextInstancesPydantic, raw_response.body)
    ...
    def search_context_instances(
        ...
        raw_response = self.raw.search_context_instances(
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
            sort=sort,
