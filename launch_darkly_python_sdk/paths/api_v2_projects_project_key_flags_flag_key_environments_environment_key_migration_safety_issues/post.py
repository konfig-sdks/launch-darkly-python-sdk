...
from launch_darkly_python_sdk.model.feature_flags_beta_get_migration_safety_issues_response import FeatureFlagsBetaGetMigrationSafetyIssuesResponse as FeatureFlagsBetaGetMigrationSafetyIssuesResponseSchema
...
from launch_darkly_python_sdk.model.status_service_unavailable import StatusServiceUnavailable as StatusServiceUnavailableSchema
...
from launch_darkly_python_sdk.model.flag_sempatch import FlagSempatch as FlagSempatchSchema

from launch_darkly_python_sdk.type.flag_sempatch import FlagSempatch
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.status_service_unavailable import StatusServiceUnavailable
...
from launch_darkly_python_sdk.type.feature_flags_beta_get_migration_safety_issues_response import FeatureFlagsBetaGetMigrationSafetyIssuesResponse

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.status_service_unavailable import StatusServiceUnavailable as StatusServiceUnavailablePydantic
...
from launch_darkly_python_sdk.pydantic.feature_flags_beta_get_migration_safety_issues_response import FeatureFlagsBetaGetMigrationSafetyIssuesResponse as FeatureFlagsBetaGetMigrationSafetyIssuesResponsePydantic
...
from launch_darkly_python_sdk.pydantic.flag_sempatch import FlagSempatch as FlagSempatchPydantic

from . import path

# Path params
ProjectKeySchema = schemas.StrSchema
FlagKeySchema = schemas.StrSchema
EnvironmentKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectKey': typing.Union[ProjectKeySchema, str, ],
        'flagKey': typing.Union[FlagKeySchema, str, ],
...
request_path_flag_key = api_client.PathParameter(
    name="flagKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FlagKeySchema,
    required=True,
)
...
# body param
SchemaForRequestBodyApplicationJson = FlagSempatchSchema


request_body_flag_sempatch = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FeatureFlagsBetaGetMigrationSafetyIssuesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeatureFlagsBetaGetMigrationSafetyIssuesResponse
...
SchemaFor503ResponseBodyApplicationJson = StatusServiceUnavailableSchema


@dataclass
class ApiResponseFor503(api_client.ApiResponse):
    body: StatusServiceUnavailable
...
class BaseApi(api_client.Api):
    ...
    def _get_migration_safety_issues_mapped_args(
        self,
    ...
    async def _aget_migration_safety_issues_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{flagKey}/environments/{environmentKey}/migration-safety-issues',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_flag_sempatch.serialize(body, content_type)
    ...
    def _get_migration_safety_issues_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMigrationSafetyIssuesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_migration_safety_issues(
        self,
        instructions: Instructions,
        project_key: str,
        flag_key: str,
        ...
        **kwargs,
        ...
        args = self._get_migration_safety_issues_mapped_args(
            instructions=instructions,
        ...
        return await self._aget_migration_safety_issues_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def get_migration_safety_issues(
        self,
        instructions: Instructions,
        project_key: str,
        flag_key: str,
        ...
        return self._get_migration_safety_issues_oapg(
            body=args.body,
            path_params=args.path,
        )

class GetMigrationSafetyIssues(BaseApi):
    ...
    async def aget_migration_safety_issues(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeatureFlagsBetaGetMigrationSafetyIssuesResponsePydantic:
        raw_response = await self.raw.aget_migration_safety_issues(
            instructions=instructions,
            project_key=project_key,
            flag_key=flag_key,
            environment_key=environment_key,
        ...
        if validate:
            return RootModel[FeatureFlagsBetaGetMigrationSafetyIssuesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FeatureFlagsBetaGetMigrationSafetyIssuesResponsePydantic, raw_response.body)
    ...
    def get_migration_safety_issues(
        ...
        raw_response = self.raw.get_migration_safety_issues(
            instructions=instructions,
            project_key=project_key,
            flag_key=flag_key,
            environment_key=environment_key,
