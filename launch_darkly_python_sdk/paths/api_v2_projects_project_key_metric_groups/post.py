...
from launch_darkly_python_sdk.model.metric_group_post import MetricGroupPost as MetricGroupPostSchema
...
from launch_darkly_python_sdk.model.metric_in_metric_group_input import MetricInMetricGroupInput as MetricInMetricGroupInputSchema
from launch_darkly_python_sdk.model.unauthorized_error_rep import UnauthorizedErrorRep as UnauthorizedErrorRepSchema
from launch_darkly_python_sdk.model.metric_group_post_tags import MetricGroupPostTags as MetricGroupPostTagsSchema
...
from launch_darkly_python_sdk.model.metric_group_rep import MetricGroupRep as MetricGroupRepSchema

from launch_darkly_python_sdk.type.metric_in_metric_group_input import MetricInMetricGroupInput
from launch_darkly_python_sdk.type.metric_group_rep import MetricGroupRep
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.metric_group_post import MetricGroupPost
...
from launch_darkly_python_sdk.type.metric_group_post_tags import MetricGroupPostTags
...
from launch_darkly_python_sdk.pydantic.metric_group_rep import MetricGroupRep as MetricGroupRepPydantic
...
from launch_darkly_python_sdk.pydantic.metric_group_post import MetricGroupPost as MetricGroupPostPydantic
from launch_darkly_python_sdk.pydantic.metric_group_post_tags import MetricGroupPostTags as MetricGroupPostTagsPydantic
...
from launch_darkly_python_sdk.pydantic.metric_in_metric_group_input import MetricInMetricGroupInput as MetricInMetricGroupInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MetricGroupPostSchema


request_body_metric_group_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = MetricGroupRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_metric_group_mapped_args(
        self,
        tags: MetricGroupPostTags,
        key: str,
        name: str,
        kind: str,
        maintainer_id: str,
        metrics: typing.List[MetricInMetricGroupInput],
        project_key: str,
        ...
        if maintainer_id is not None:
            _body["maintainerId"] = maintainer_id
    ...
    async def _acreate_metric_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/metric-groups',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_metric_group_post.serialize(body, content_type)
...
class CreateMetricGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_metric_group(
        self,
        tags: MetricGroupPostTags,
        key: str,
        name: str,
        ...
        **kwargs,
        ...
        args = self._create_metric_group_mapped_args(
            tags=tags,
            key=key,
            name=name,
            kind=kind,
        ...
        return await self._acreate_metric_group_oapg(
            body=args.body,
    ...
    def create_metric_group(
        ...
        return self._create_metric_group_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateMetricGroup(BaseApi):
    ...
    async def acreate_metric_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MetricGroupRepPydantic:
        raw_response = await self.raw.acreate_metric_group(
            tags=tags,
            key=key,
            name=name,
            kind=kind,
        ...
        if validate:
            return MetricGroupRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(MetricGroupRepPydantic, raw_response.body)
    ...
    def create_metric_group(
        ...
        raw_response = self.raw.create_metric_group(
            tags=tags,
            key=key,
            name=name,
            kind=kind,
