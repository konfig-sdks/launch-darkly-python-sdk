...
from launch_darkly_python_sdk.model.metric_group_collection_rep import MetricGroupCollectionRep as MetricGroupCollectionRepSchema
...
from launch_darkly_python_sdk.type.metric_group_collection_rep import MetricGroupCollectionRep
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.metric_group_collection_rep import MetricGroupCollectionRep as MetricGroupCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = MetricGroupCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MetricGroupCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_metric_groups_mapped_args(
        self,
        project_key: str,
    ...
    async def _alist_metric_groups_oapg(
        self,
...
class ListMetricGroupsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_metric_groups(
        self,
        project_key: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_metric_groups_mapped_args(
            project_key=project_key,
            expand=expand,
        )
        return await self._alist_metric_groups_oapg(
    ...
    def list_metric_groups(
        ...
        return self._list_metric_groups_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListMetricGroups(BaseApi):
    ...
    async def alist_metric_groups(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MetricGroupCollectionRepPydantic:
        raw_response = await self.raw.alist_metric_groups(
            project_key=project_key,
            expand=expand,
            **kwargs,
        )
        if validate:
            return MetricGroupCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(MetricGroupCollectionRepPydantic, raw_response.body)
    ...
    def list_metric_groups(
        ...
        raw_response = self.raw.list_metric_groups(
            project_key=project_key,
            expand=expand,
        )
        if validate:
