...
from launch_darkly_python_sdk.model.release_pipeline_collection import ReleasePipelineCollection as ReleasePipelineCollectionSchema

from launch_darkly_python_sdk.type.release_pipeline_collection import ReleasePipelineCollection
from launch_darkly_python_sdk.type.not_found_error_rep import NotFoundErrorRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.release_pipeline_collection import ReleasePipelineCollection as ReleasePipelineCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = ReleasePipelineCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReleasePipelineCollection
...
class BaseApi(api_client.Api):
    ...
    def _get_all_release_pipelines_mapped_args(
        self,
        project_key: str,
    ...
    async def _aget_all_release_pipelines_oapg(
        self,
    ...
    def _get_all_release_pipelines_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAllReleasePipelinesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_release_pipelines(
        self,
        project_key: str,
        filter: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_release_pipelines_mapped_args(
            project_key=project_key,
            filter=filter,
            limit=limit,
            offset=offset,
        )
        return await self._aget_all_release_pipelines_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_release_pipelines(
        self,
        project_key: str,
        filter: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_all_release_pipelines_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllReleasePipelines(BaseApi):
    ...
    async def aget_all_release_pipelines(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReleasePipelineCollectionPydantic:
        raw_response = await self.raw.aget_all_release_pipelines(
            project_key=project_key,
            filter=filter,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return ReleasePipelineCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ReleasePipelineCollectionPydantic, raw_response.body)
    ...
    def get_all_release_pipelines(
        ...
        raw_response = self.raw.get_all_release_pipelines(
            project_key=project_key,
            filter=filter,
            limit=limit,
            offset=offset,
