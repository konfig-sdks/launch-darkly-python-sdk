...
from launch_darkly_python_sdk.model.create_phase_input import CreatePhaseInput as CreatePhaseInputSchema
from launch_darkly_python_sdk.model.create_release_pipeline_input import CreateReleasePipelineInput as CreateReleasePipelineInputSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema
from launch_darkly_python_sdk.model.release_pipeline import ReleasePipeline as ReleasePipelineSchema
from launch_darkly_python_sdk.model.create_release_pipeline_input_tags import CreateReleasePipelineInputTags as CreateReleasePipelineInputTagsSchema

from launch_darkly_python_sdk.type.release_pipeline import ReleasePipeline
from launch_darkly_python_sdk.type.create_release_pipeline_input_tags import CreateReleasePipelineInputTags
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.create_release_pipeline_input import CreateReleasePipelineInput
...
from launch_darkly_python_sdk.type.create_phase_input import CreatePhaseInput

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.release_pipeline import ReleasePipeline as ReleasePipelinePydantic
from launch_darkly_python_sdk.pydantic.create_phase_input import CreatePhaseInput as CreatePhaseInputPydantic
from launch_darkly_python_sdk.pydantic.create_release_pipeline_input_tags import CreateReleasePipelineInputTags as CreateReleasePipelineInputTagsPydantic
...
from launch_darkly_python_sdk.pydantic.create_release_pipeline_input import CreateReleasePipelineInput as CreateReleasePipelineInputPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateReleasePipelineInputSchema


request_body_create_release_pipeline_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ReleasePipelineSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_pipeline_mapped_args(
        self,
        key: str,
        name: str,
        phases: typing.List[CreatePhaseInput],
        project_key: str,
        tags: typing.Optional[CreateReleasePipelineInputTags] = None,
    ...
    async def _acreate_new_pipeline_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/release-pipelines',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_release_pipeline_input.serialize(body, content_type)
...
class CreateNewPipelineRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_pipeline(
        self,
        key: str,
        name: str,
        phases: typing.List[CreatePhaseInput],
        ...
        **kwargs,
        ...
        args = self._create_new_pipeline_mapped_args(
            key=key,
            name=name,
            phases=phases,
        ...
        return await self._acreate_new_pipeline_oapg(
            body=args.body,
    ...
    def create_new_pipeline(
        ...
        return self._create_new_pipeline_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewPipeline(BaseApi):
    ...
    async def acreate_new_pipeline(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReleasePipelinePydantic:
        raw_response = await self.raw.acreate_new_pipeline(
            key=key,
            name=name,
            phases=phases,
            project_key=project_key,
        ...
        if validate:
            return ReleasePipelinePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReleasePipelinePydantic, raw_response.body)
    ...
    def create_new_pipeline(
        ...
        raw_response = self.raw.create_new_pipeline(
            key=key,
            name=name,
            phases=phases,
            project_key=project_key,
