...
from launch_darkly_python_sdk.model.flag_followers_by_proj_env_get_rep import FlagFollowersByProjEnvGetRep as FlagFollowersByProjEnvGetRepSchema
...
from launch_darkly_python_sdk.type.flag_followers_by_proj_env_get_rep import FlagFollowersByProjEnvGetRep
...
from launch_darkly_python_sdk.pydantic.flag_followers_by_proj_env_get_rep import FlagFollowersByProjEnvGetRep as FlagFollowersByProjEnvGetRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = FlagFollowersByProjEnvGetRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FlagFollowersByProjEnvGetRep
...
class BaseApi(api_client.Api):
    ...
    def _get_all_flag_followers_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_all_flag_followers_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/followers',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_all_flag_followers_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllFlagFollowersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_flag_followers(
        self,
        project_key: str,
        environment_key: str,
        **kwargs,
        ...
        args = self._get_all_flag_followers_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
        )
        return await self._aget_all_flag_followers_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_flag_followers(
        self,
        project_key: str,
        environment_key: str,
    ) -> typing.Union[
        ...
        return self._get_all_flag_followers_oapg(
            path_params=args.path,
        )

class GetAllFlagFollowers(BaseApi):
    ...
    async def aget_all_flag_followers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FlagFollowersByProjEnvGetRepPydantic:
        raw_response = await self.raw.aget_all_flag_followers(
            project_key=project_key,
            environment_key=environment_key,
            **kwargs,
        )
        if validate:
            return FlagFollowersByProjEnvGetRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagFollowersByProjEnvGetRepPydantic, raw_response.body)
    ...
    def get_all_flag_followers(
        ...
        raw_response = self.raw.get_all_flag_followers(
            project_key=project_key,
            environment_key=environment_key,
        )
        if validate:
