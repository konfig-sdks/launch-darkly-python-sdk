...
request_path_kind = api_client.PathParameter(
    name="kind",
    style=api_client.ParameterStyle.SIMPLE,
    schema=KindSchema,
    required=True,
...
class BaseApi(api_client.Api):
    ...
    def _get_by_kind_and_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        kind: str,
    ...
    async def _aget_by_kind_and_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{kind}/{key}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByKindAndKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_kind_and_key(
        self,
        project_key: str,
        environment_key: str,
        kind: str,
        ...
        **kwargs,
        ...
        args = self._get_by_kind_and_key_mapped_args(
        ...
        return await self._aget_by_kind_and_key_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_kind_and_key(
        self,
        project_key: str,
        environment_key: str,
        kind: str,
        ...
        return self._get_by_kind_and_key_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByKindAndKey(BaseApi):
    ...
    async def aget_by_kind_and_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_kind_and_key(
            project_key=project_key,
            environment_key=environment_key,
            kind=kind,
            key=key,
    ...
    def get_by_kind_and_key(
        ...
        raw_response = self.raw.get_by_kind_and_key(
            project_key=project_key,
            environment_key=environment_key,
            kind=kind,
            key=key,
