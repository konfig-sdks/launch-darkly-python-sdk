...
from launch_darkly_python_sdk.model.create_copy_flag_config_approval_request_request_notify_team_keys import CreateCopyFlagConfigApprovalRequestRequestNotifyTeamKeys as CreateCopyFlagConfigApprovalRequestRequestNotifyTeamKeysSchema
...
from launch_darkly_python_sdk.model.create_copy_flag_config_approval_request_request_excluded_actions import CreateCopyFlagConfigApprovalRequestRequestExcludedActions as CreateCopyFlagConfigApprovalRequestRequestExcludedActionsSchema
from launch_darkly_python_sdk.model.unauthorized_error_rep import UnauthorizedErrorRep as UnauthorizedErrorRepSchema
from launch_darkly_python_sdk.model.create_copy_flag_config_approval_request_request_notify_member_ids import CreateCopyFlagConfigApprovalRequestRequestNotifyMemberIds as CreateCopyFlagConfigApprovalRequestRequestNotifyMemberIdsSchema
from launch_darkly_python_sdk.model.source_flag import SourceFlag as SourceFlagSchema
from launch_darkly_python_sdk.model.flag_config_approval_request_response import FlagConfigApprovalRequestResponse as FlagConfigApprovalRequestResponseSchema
from launch_darkly_python_sdk.model.status_conflict_error_rep import StatusConflictErrorRep as StatusConflictErrorRepSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema
from launch_darkly_python_sdk.model.create_copy_flag_config_approval_request_request import CreateCopyFlagConfigApprovalRequestRequest as CreateCopyFlagConfigApprovalRequestRequestSchema
from launch_darkly_python_sdk.model.forbidden_error_rep import ForbiddenErrorRep as ForbiddenErrorRepSchema
from launch_darkly_python_sdk.model.create_copy_flag_config_approval_request_request_included_actions import CreateCopyFlagConfigApprovalRequestRequestIncludedActions as CreateCopyFlagConfigApprovalRequestRequestIncludedActionsSchema

from launch_darkly_python_sdk.type.create_copy_flag_config_approval_request_request_included_actions import CreateCopyFlagConfigApprovalRequestRequestIncludedActions
from launch_darkly_python_sdk.type.create_copy_flag_config_approval_request_request_notify_member_ids import CreateCopyFlagConfigApprovalRequestRequestNotifyMemberIds
from launch_darkly_python_sdk.type.flag_config_approval_request_response import FlagConfigApprovalRequestResponse
from launch_darkly_python_sdk.type.create_copy_flag_config_approval_request_request_notify_team_keys import CreateCopyFlagConfigApprovalRequestRequestNotifyTeamKeys
from launch_darkly_python_sdk.type.invalid_request_error_rep import InvalidRequestErrorRep
from launch_darkly_python_sdk.type.create_copy_flag_config_approval_request_request import CreateCopyFlagConfigApprovalRequestRequest
from launch_darkly_python_sdk.type.rate_limited_error_rep import RateLimitedErrorRep
from launch_darkly_python_sdk.type.source_flag import SourceFlag
from launch_darkly_python_sdk.type.unauthorized_error_rep import UnauthorizedErrorRep
from launch_darkly_python_sdk.type.status_conflict_error_rep import StatusConflictErrorRep
from launch_darkly_python_sdk.type.forbidden_error_rep import ForbiddenErrorRep
from launch_darkly_python_sdk.type.create_copy_flag_config_approval_request_request_excluded_actions import CreateCopyFlagConfigApprovalRequestRequestExcludedActions

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.create_copy_flag_config_approval_request_request_notify_team_keys import CreateCopyFlagConfigApprovalRequestRequestNotifyTeamKeys as CreateCopyFlagConfigApprovalRequestRequestNotifyTeamKeysPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.create_copy_flag_config_approval_request_request_notify_member_ids import CreateCopyFlagConfigApprovalRequestRequestNotifyMemberIds as CreateCopyFlagConfigApprovalRequestRequestNotifyMemberIdsPydantic
from launch_darkly_python_sdk.pydantic.create_copy_flag_config_approval_request_request import CreateCopyFlagConfigApprovalRequestRequest as CreateCopyFlagConfigApprovalRequestRequestPydantic
from launch_darkly_python_sdk.pydantic.source_flag import SourceFlag as SourceFlagPydantic
from launch_darkly_python_sdk.pydantic.create_copy_flag_config_approval_request_request_included_actions import CreateCopyFlagConfigApprovalRequestRequestIncludedActions as CreateCopyFlagConfigApprovalRequestRequestIncludedActionsPydantic
from launch_darkly_python_sdk.pydantic.flag_config_approval_request_response import FlagConfigApprovalRequestResponse as FlagConfigApprovalRequestResponsePydantic
...
from launch_darkly_python_sdk.pydantic.create_copy_flag_config_approval_request_request_excluded_actions import CreateCopyFlagConfigApprovalRequestRequestExcludedActions as CreateCopyFlagConfigApprovalRequestRequestExcludedActionsPydantic
from launch_darkly_python_sdk.pydantic.status_conflict_error_rep import StatusConflictErrorRep as StatusConflictErrorRepPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'featureFlagKey': typing.Union[FeatureFlagKeySchema, str, ],
...
# body param
SchemaForRequestBodyApplicationJson = CreateCopyFlagConfigApprovalRequestRequestSchema


request_body_create_copy_flag_config_approval_request_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FlagConfigApprovalRequestResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FlagConfigApprovalRequestResponse
...
SchemaFor409ResponseBodyApplicationJson = StatusConflictErrorRepSchema


@dataclass
class ApiResponseFor409(api_client.ApiResponse):
    body: StatusConflictErrorRep
...
class BaseApi(api_client.Api):
    ...
    def _create_flag_copy_request_mapped_args(
        self,
        description: str,
        source: SourceFlag,
        project_key: str,
        ...
        notify_member_ids: typing.Optional[CreateCopyFlagConfigApprovalRequestRequestNotifyMemberIds] = None,
        notify_team_keys: typing.Optional[CreateCopyFlagConfigApprovalRequestRequestNotifyTeamKeys] = None,
        included_actions: typing.Optional[CreateCopyFlagConfigApprovalRequestRequestIncludedActions] = None,
        excluded_actions: typing.Optional[CreateCopyFlagConfigApprovalRequestRequestExcludedActions] = None,
        ...
        if notify_member_ids is not None:
            _body["notifyMemberIds"] = notify_member_ids
        if notify_team_keys is not None:
            _body["notifyTeamKeys"] = notify_team_keys
        if source is not None:
            _body["source"] = source
        if included_actions is not None:
            _body["includedActions"] = included_actions
        if excluded_actions is not None:
            _body["excludedActions"] = excluded_actions
        args.body = _body
    ...
    async def _acreate_flag_copy_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests-flag-copy',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_copy_flag_config_approval_request_request.serialize(body, content_type)
    ...
    def _create_flag_copy_request_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateFlagCopyRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_flag_copy_request(
        self,
        description: str,
        source: SourceFlag,
        project_key: str,
        ...
        **kwargs,
        ...
        args = self._create_flag_copy_request_mapped_args(
        ...
        return await self._acreate_flag_copy_request_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_flag_copy_request(
        self,
        description: str,
        source: SourceFlag,
        project_key: str,
        ...
        return self._create_flag_copy_request_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateFlagCopyRequest(BaseApi):
    ...
    async def acreate_flag_copy_request(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FlagConfigApprovalRequestResponsePydantic:
        raw_response = await self.raw.acreate_flag_copy_request(
            description=description,
            source=source,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
        ...
        if validate:
            return FlagConfigApprovalRequestResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagConfigApprovalRequestResponsePydantic, raw_response.body)
    ...
    def create_flag_copy_request(
        ...
        raw_response = self.raw.create_flag_copy_request(
            description=description,
            source=source,
            project_key=project_key,
            feature_flag_key=feature_flag_key,
