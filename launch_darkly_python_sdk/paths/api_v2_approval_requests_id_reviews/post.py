...
from launch_darkly_python_sdk.model.post_approval_request_review_request import PostApprovalRequestReviewRequest as PostApprovalRequestReviewRequestSchema
...
from launch_darkly_python_sdk.type.post_approval_request_review_request import PostApprovalRequestReviewRequest
...
from launch_darkly_python_sdk.pydantic.post_approval_request_review_request import PostApprovalRequestReviewRequest as PostApprovalRequestReviewRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PostApprovalRequestReviewRequestSchema


request_body_post_approval_request_review_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ApprovalRequestResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _review_request_mapped_args(
        self,
        id: str,
    ...
    async def _areview_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/approval-requests/{id}/reviews',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_post_approval_request_review_request.serialize(body, content_type)
...
class ReviewRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areview_request(
        self,
        id: str,
        kind: typing.Optional[str] = None,
        comment: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._review_request_mapped_args(
            id=id,
            kind=kind,
            comment=comment,
        )
        return await self._areview_request_oapg(
            body=args.body,
...
class ReviewRequest(BaseApi):
    ...
    async def areview_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areview_request(
            id=id,
            kind=kind,
            comment=comment,
            **kwargs,
    ...
    def review_request(
        ...
        raw_response = self.raw.review_request(
            id=id,
            kind=kind,
            comment=comment,
        )
