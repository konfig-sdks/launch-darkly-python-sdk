...
from launch_darkly_python_sdk.model.relay_auto_config_post import RelayAutoConfigPost as RelayAutoConfigPostSchema
from launch_darkly_python_sdk.model.statement import Statement as StatementSchema
...
from launch_darkly_python_sdk.type.statement import Statement
from launch_darkly_python_sdk.type.relay_auto_config_post import RelayAutoConfigPost
...
from launch_darkly_python_sdk.pydantic.statement import Statement as StatementPydantic
from launch_darkly_python_sdk.pydantic.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepPydantic
from launch_darkly_python_sdk.pydantic.relay_auto_config_post import RelayAutoConfigPost as RelayAutoConfigPostPydantic
...
# body param
SchemaForRequestBodyApplicationJson = RelayAutoConfigPostSchema


request_body_relay_auto_config_post = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RelayAutoConfigRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_config_mapped_args(
        self,
        name: str,
        policy: typing.List[Statement],
    ...
    async def _acreate_new_config_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/account/relay-auto-configs',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_relay_auto_config_post.serialize(body, content_type)
...
class CreateNewConfigRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_config(
        self,
        name: str,
        policy: typing.List[Statement],
        **kwargs,
        ...
        args = self._create_new_config_mapped_args(
            name=name,
            policy=policy,
        )
        return await self._acreate_new_config_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_config(
        ...
        return self._create_new_config_oapg(
            body=args.body,
        )

class CreateNewConfig(BaseApi):
    ...
    async def acreate_new_config(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_config(
            name=name,
            policy=policy,
            **kwargs,
        )
    ...
    def create_new_config(
        ...
        raw_response = self.raw.create_new_config(
            name=name,
            policy=policy,
        )
        if validate:
