...
from launch_darkly_python_sdk.model.relay_auto_config_collection_rep import RelayAutoConfigCollectionRep as RelayAutoConfigCollectionRepSchema

from launch_darkly_python_sdk.type.relay_auto_config_collection_rep import RelayAutoConfigCollectionRep
...
from launch_darkly_python_sdk.pydantic.relay_auto_config_collection_rep import RelayAutoConfigCollectionRep as RelayAutoConfigCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = RelayAutoConfigCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RelayAutoConfigCollectionRep
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RelayAutoConfigCollectionRepPydantic:
        raw_response = await self.raw.alist(
            **kwargs,
        )
        if validate:
            return RelayAutoConfigCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(RelayAutoConfigCollectionRepPydantic, raw_response.body)
