...
class BaseApi(api_client.Api):
    ...
    def _delete_by_project_key_mapped_args(
        self,
        project_key: str,
    ...
    async def _adelete_by_project_key_oapg(
        self,
    ...
    def _delete_by_project_key_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteByProjectKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_by_project_key(
        self,
        project_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_by_project_key_mapped_args(
            project_key=project_key,
        )
        return await self._adelete_by_project_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_by_project_key(
        self,
        project_key: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_by_project_key_oapg(
            path_params=args.path,
        )

class DeleteByProjectKey(BaseApi):
    ...
    async def adelete_by_project_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_by_project_key(
            project_key=project_key,
            **kwargs,
        )
    ...
    def delete_by_project_key(
        ...
        raw_response = self.raw.delete_by_project_key(
            project_key=project_key,
        )
