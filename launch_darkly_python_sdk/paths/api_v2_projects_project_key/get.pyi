...
from launch_darkly_python_sdk.model.project import Project as ProjectSchema
...
from launch_darkly_python_sdk.type.project import Project
...
from launch_darkly_python_sdk.pydantic.project import Project as ProjectPydantic
...
class BaseApi(api_client.Api):
    ...
    def _single_by_project_key_mapped_args(
        self,
        project_key: str,
    ...
    async def _asingle_by_project_key_oapg(
        self,
    ...
    def _single_by_project_key_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SingleByProjectKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asingle_by_project_key(
        self,
        project_key: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._single_by_project_key_mapped_args(
            project_key=project_key,
            expand=expand,
        )
        return await self._asingle_by_project_key_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def single_by_project_key(
        self,
        project_key: str,
        expand: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._single_by_project_key_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class SingleByProjectKey(BaseApi):
    ...
    async def asingle_by_project_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asingle_by_project_key(
            project_key=project_key,
            expand=expand,
            **kwargs,
        )
    ...
    def single_by_project_key(
        ...
        raw_response = self.raw.single_by_project_key(
            project_key=project_key,
            expand=expand,
        )
        if validate:
