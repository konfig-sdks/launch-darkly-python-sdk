...
SchemaFor200ResponseBodyApplicationJson = ProjectRepSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_project_patch_mapped_args(
        self,
        body: JSONPatch,
        project_key: str,
    ...
    async def _aupdate_project_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_project_patch_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateProjectPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_project_patch(
        self,
        body: JSONPatch,
        project_key: str,
        **kwargs,
        ...
        args = self._update_project_patch_mapped_args(
            body=body,
            project_key=project_key,
        )
        return await self._aupdate_project_patch_oapg(
            body=args.body,
    ...
    def update_project_patch(
        ...
        return self._update_project_patch_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateProjectPatch(BaseApi):
    ...
    async def aupdate_project_patch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_project_patch(
            body=body,
            project_key=project_key,
            **kwargs,
        )
    ...
    def update_project_patch(
        ...
        raw_response = self.raw.update_project_patch(
            body=body,
            project_key=project_key,
        )
        if validate:
