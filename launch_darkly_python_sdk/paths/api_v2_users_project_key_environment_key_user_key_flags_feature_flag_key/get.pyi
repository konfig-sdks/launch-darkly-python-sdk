...
from launch_darkly_python_sdk.model.user_flag_setting import UserFlagSetting as UserFlagSettingSchema
...
from launch_darkly_python_sdk.type.user_flag_setting import UserFlagSetting
...
from launch_darkly_python_sdk.pydantic.user_flag_setting import UserFlagSetting as UserFlagSettingPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserFlagSettingSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserFlagSetting
...
class BaseApi(api_client.Api):
    ...
    def _single_flag_setting_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
    ...
    async def _asingle_flag_setting_oapg(
        self,
...
class SingleFlagSettingRaw(BaseApi):
    ...
    async def asingle_flag_setting(
        ...
        **kwargs,
        ...
        args = self._single_flag_setting_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            feature_flag_key=feature_flag_key,
        )
        return await self._asingle_flag_setting_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="user_settings")
    def single_flag_setting(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
        ...
        return self._single_flag_setting_oapg(
            path_params=args.path,
        )

class SingleFlagSetting(BaseApi):
    ...
    async def asingle_flag_setting(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserFlagSettingPydantic:
        raw_response = await self.raw.asingle_flag_setting(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            feature_flag_key=feature_flag_key,
        ...
        if validate:
            return UserFlagSettingPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserFlagSettingPydantic, raw_response.body)
    ...
    def single_flag_setting(
        ...
        raw_response = self.raw.single_flag_setting(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            feature_flag_key=feature_flag_key,
