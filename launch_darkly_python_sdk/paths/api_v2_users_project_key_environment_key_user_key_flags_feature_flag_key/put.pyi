...
class BaseApi(api_client.Api):
    ...
    def _update_flag_settings_for_user_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
    ...
    async def _aupdate_flag_settings_for_user_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_flag_settings_for_user_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFlagSettingsForUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="user_settings")
    async def aupdate_flag_settings_for_user(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
        ...
        **kwargs,
        ...
        args = self._update_flag_settings_for_user_mapped_args(
        ...
        return await self._aupdate_flag_settings_for_user_oapg(
            body=args.body,
    ...
    @api_client.DeprecationWarningOnce(prefix="user_settings")
    def update_flag_settings_for_user(
        self,
        project_key: str,
        environment_key: str,
        user_key: str,
        ...
        return self._update_flag_settings_for_user_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFlagSettingsForUser(BaseApi):
    ...
    async def aupdate_flag_settings_for_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_flag_settings_for_user(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            feature_flag_key=feature_flag_key,
    ...
    def update_flag_settings_for_user(
        ...
        raw_response = self.raw.update_flag_settings_for_user(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            feature_flag_key=feature_flag_key,
