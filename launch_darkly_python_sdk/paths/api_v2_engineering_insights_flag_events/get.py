...
from launch_darkly_python_sdk.model.flag_event_collection_rep import FlagEventCollectionRep as FlagEventCollectionRepSchema
...
from launch_darkly_python_sdk.type.flag_event_collection_rep import FlagEventCollectionRep
...
from launch_darkly_python_sdk.pydantic.flag_event_collection_rep import FlagEventCollectionRep as FlagEventCollectionRepPydantic
...
ImpactSizeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'impactSize': typing.Union[ImpactSizeSchema, str, ],
...
request_query_impact_size = api_client.QueryParameter(
    name="impactSize",
    style=api_client.ParameterStyle.FORM,
    schema=ImpactSizeSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = FlagEventCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FlagEventCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _list_flag_events_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        query: typing.Optional[str] = None,
        impact_size: typing.Optional[str] = None,
        ...
        if impact_size is not None:
            _query_params["impactSize"] = impact_size
    ...
    async def _alist_flag_events_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/flag-events',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListFlagEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_flag_events(
        self,
        project_key: str,
        environment_key: str,
        application_key: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_flag_events_mapped_args(
        ...
        return await self._alist_flag_events_oapg(
    ...
    def list_flag_events(
        ...
        return self._list_flag_events_oapg(
            query_params=args.query,
        )

class ListFlagEvents(BaseApi):
    ...
    async def alist_flag_events(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FlagEventCollectionRepPydantic:
        raw_response = await self.raw.alist_flag_events(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            query=query,
        ...
        if validate:
            return FlagEventCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(FlagEventCollectionRepPydantic, raw_response.body)
    ...
    def list_flag_events(
        ...
        raw_response = self.raw.list_flag_events(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            query=query,
