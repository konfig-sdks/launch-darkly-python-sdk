...
# Query params
ExpirySchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'expiry': typing.Union[ExpirySchema, decimal.Decimal, int, ],
    },
    total=False
)
...
class BaseApi(api_client.Api):
    ...
    def _reset_sdk_key_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _areset_sdk_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/apiKey',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ResetSdkKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areset_sdk_key(
        self,
        project_key: str,
        environment_key: str,
        expiry: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._reset_sdk_key_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            expiry=expiry,
        )
        return await self._areset_sdk_key_oapg(
    ...
    def reset_sdk_key(
        ...
        return self._reset_sdk_key_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ResetSdkKey(BaseApi):
    ...
    async def areset_sdk_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areset_sdk_key(
            project_key=project_key,
            environment_key=environment_key,
            expiry=expiry,
            **kwargs,
    ...
    def reset_sdk_key(
        ...
        raw_response = self.raw.reset_sdk_key(
            project_key=project_key,
            environment_key=environment_key,
            expiry=expiry,
        )
