...
from launch_darkly_python_sdk.model.ip_list import IpList as IpListSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema

from launch_darkly_python_sdk.type.ip_list import IpList
from launch_darkly_python_sdk.type.rate_limited_error_rep import RateLimitedErrorRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.ip_list import IpList as IpListPydantic
...
class BaseApi(api_client.Api):
    ...
    def _get_ip_list_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_ip_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/public-ip-list',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetIpListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_ip_list(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_ip_list_mapped_args(
        )
        return await self._aget_ip_list_oapg(
            **kwargs,
        )
    ...
    def get_ip_list(
        ...
        return self._get_ip_list_oapg(
        )

class GetIpList(BaseApi):
    ...
    async def aget_ip_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_ip_list(
            **kwargs,
        )
        if validate:
    ...
    def get_ip_list(
        ...
        raw_response = self.raw.get_ip_list(
        )
        if validate:
            return IpListPydantic(**raw_response.body)
        return api_client.construct_model_instance(IpListPydantic, raw_response.body)
