...
from launch_darkly_python_sdk.model.upsert_context_kind_payload import UpsertContextKindPayload as UpsertContextKindPayloadSchema
from launch_darkly_python_sdk.model.upsert_response_rep import UpsertResponseRep as UpsertResponseRepSchema
...
from launch_darkly_python_sdk.type.upsert_context_kind_payload import UpsertContextKindPayload
...
from launch_darkly_python_sdk.type.upsert_response_rep import UpsertResponseRep

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.upsert_response_rep import UpsertResponseRep as UpsertResponseRepPydantic
...
from launch_darkly_python_sdk.pydantic.upsert_context_kind_payload import UpsertContextKindPayload as UpsertContextKindPayloadPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpsertContextKindPayloadSchema


request_body_upsert_context_kind_payload = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UpsertResponseRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UpsertResponseRep
...
class BaseApi(api_client.Api):
    ...
    def _create_or_update_kind_mapped_args(
        self,
        name: str,
        project_key: str,
        key: str,
        ...
        hide_in_targeting: typing.Optional[bool] = None,
        ...
        if hide_in_targeting is not None:
            _body["hideInTargeting"] = hide_in_targeting
    ...
    async def _acreate_or_update_kind_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/context-kinds/{key}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_upsert_context_kind_payload.serialize(body, content_type)
    ...
    def _create_or_update_kind_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateOrUpdateKindRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_or_update_kind(
        self,
        name: str,
        project_key: str,
        key: str,
        ...
        **kwargs,
        ...
        args = self._create_or_update_kind_mapped_args(
            name=name,
        ...
        return await self._acreate_or_update_kind_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_or_update_kind(
        self,
        name: str,
        project_key: str,
        key: str,
        ...
        return self._create_or_update_kind_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateOrUpdateKind(BaseApi):
    ...
    async def acreate_or_update_kind(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UpsertResponseRepPydantic:
        raw_response = await self.raw.acreate_or_update_kind(
            name=name,
            project_key=project_key,
            key=key,
            description=description,
        ...
        if validate:
            return UpsertResponseRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(UpsertResponseRepPydantic, raw_response.body)
    ...
    def create_or_update_kind(
        ...
        raw_response = self.raw.create_or_update_kind(
            name=name,
            project_key=project_key,
            key=key,
            description=description,
