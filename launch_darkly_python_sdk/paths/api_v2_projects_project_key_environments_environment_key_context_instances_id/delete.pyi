...
class BaseApi(api_client.Api):
    ...
    def _delete_context_instance_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        id: str,
    ...
    async def _adelete_context_instance_oapg(
        self,
    ...
    def _delete_context_instance_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteContextInstanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_context_instance(
        self,
        project_key: str,
        environment_key: str,
        id: str,
        **kwargs,
        ...
        args = self._delete_context_instance_mapped_args(
            project_key=project_key,
            environment_key=environment_key,
            id=id,
        )
        return await self._adelete_context_instance_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_context_instance(
        self,
        project_key: str,
        environment_key: str,
        id: str,
        ...
        return self._delete_context_instance_oapg(
            path_params=args.path,
        )

class DeleteContextInstance(BaseApi):
    ...
    async def adelete_context_instance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_context_instance(
            project_key=project_key,
            environment_key=environment_key,
            id=id,
            **kwargs,
    ...
    def delete_context_instance(
        ...
        raw_response = self.raw.delete_context_instance(
            project_key=project_key,
            environment_key=environment_key,
            id=id,
        )
