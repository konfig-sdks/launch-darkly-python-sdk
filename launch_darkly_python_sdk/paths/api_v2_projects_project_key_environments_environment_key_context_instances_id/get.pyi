...
class BaseApi(api_client.Api):
    ...
    def _get_context_instances_mapped_args(
        self,
        project_key: str,
        environment_key: str,
        id: str,
    ...
    async def _aget_context_instances_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/projects/{projectKey}/environments/{environmentKey}/context-instances/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_context_instances_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetContextInstancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_context_instances(
        self,
        project_key: str,
        environment_key: str,
        id: str,
        ...
        **kwargs,
        ...
        args = self._get_context_instances_mapped_args(
        ...
        return await self._aget_context_instances_oapg(
    ...
    def get_context_instances(
        ...
        return self._get_context_instances_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetContextInstances(BaseApi):
    ...
    async def aget_context_instances(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_context_instances(
            project_key=project_key,
            environment_key=environment_key,
            id=id,
            limit=limit,
    ...
    def get_context_instances(
        ...
        raw_response = self.raw.get_context_instances(
            project_key=project_key,
            environment_key=environment_key,
            id=id,
            limit=limit,
