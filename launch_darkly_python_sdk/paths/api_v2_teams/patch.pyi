...
from launch_darkly_python_sdk.model.teams_patch_input import TeamsPatchInput as TeamsPatchInputSchema
...
from launch_darkly_python_sdk.model.bulk_edit_teams_rep import BulkEditTeamsRep as BulkEditTeamsRepSchema

from launch_darkly_python_sdk.type.bulk_edit_teams_rep import BulkEditTeamsRep
...
from launch_darkly_python_sdk.type.teams_patch_input import TeamsPatchInput
...
from launch_darkly_python_sdk.pydantic.teams_patch_input import TeamsPatchInput as TeamsPatchInputPydantic
...
from launch_darkly_python_sdk.pydantic.bulk_edit_teams_rep import BulkEditTeamsRep as BulkEditTeamsRepPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TeamsPatchInputSchema


request_body_teams_patch_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = BulkEditTeamsRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BulkEditTeamsRep
...
class BaseApi(api_client.Api):
    ...
    def _update_multiple_teams_semantic_patch_mapped_args(
        self,
    ...
    async def _aupdate_multiple_teams_semantic_patch_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_teams_patch_input.serialize(body, content_type)
    ...
    def _update_multiple_teams_semantic_patch_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateMultipleTeamsSemanticPatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_multiple_teams_semantic_patch(
        self,
        instructions: Instructions,
        comment: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_multiple_teams_semantic_patch_mapped_args(
            instructions=instructions,
            comment=comment,
        )
        return await self._aupdate_multiple_teams_semantic_patch_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_multiple_teams_semantic_patch(
        self,
        instructions: Instructions,
        comment: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._update_multiple_teams_semantic_patch_oapg(
            body=args.body,
        )

class UpdateMultipleTeamsSemanticPatch(BaseApi):
    ...
    async def aupdate_multiple_teams_semantic_patch(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BulkEditTeamsRepPydantic:
        raw_response = await self.raw.aupdate_multiple_teams_semantic_patch(
            instructions=instructions,
            comment=comment,
            **kwargs,
        )
        if validate:
            return BulkEditTeamsRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(BulkEditTeamsRepPydantic, raw_response.body)
    ...
    def update_multiple_teams_semantic_patch(
        ...
        raw_response = self.raw.update_multiple_teams_semantic_patch(
            instructions=instructions,
            comment=comment,
        )
        if validate:
