...
from launch_darkly_python_sdk.model.team_post_input import TeamPostInput as TeamPostInputSchema
from launch_darkly_python_sdk.model.team_post_input_custom_role_keys import TeamPostInputCustomRoleKeys as TeamPostInputCustomRoleKeysSchema
...
from launch_darkly_python_sdk.model.permission_grant_input import PermissionGrantInput as PermissionGrantInputSchema
from launch_darkly_python_sdk.model.rate_limited_error_rep import RateLimitedErrorRep as RateLimitedErrorRepSchema
from launch_darkly_python_sdk.model.team import Team as TeamSchema
from launch_darkly_python_sdk.model.team_post_input_member_ids import TeamPostInputMemberIDs as TeamPostInputMemberIDsSchema
...
from launch_darkly_python_sdk.type.team_post_input_custom_role_keys import TeamPostInputCustomRoleKeys
from launch_darkly_python_sdk.type.team_post_input import TeamPostInput
...
from launch_darkly_python_sdk.type.permission_grant_input import PermissionGrantInput
from launch_darkly_python_sdk.type.team import Team
from launch_darkly_python_sdk.type.team_post_input_member_ids import TeamPostInputMemberIDs

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.team_post_input_custom_role_keys import TeamPostInputCustomRoleKeys as TeamPostInputCustomRoleKeysPydantic
from launch_darkly_python_sdk.pydantic.permission_grant_input import PermissionGrantInput as PermissionGrantInputPydantic
from launch_darkly_python_sdk.pydantic.team_post_input import TeamPostInput as TeamPostInputPydantic
...
from launch_darkly_python_sdk.pydantic.team import Team as TeamPydantic
from launch_darkly_python_sdk.pydantic.team_post_input_member_ids import TeamPostInputMemberIDs as TeamPostInputMemberIDsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TeamPostInputSchema


request_body_team_post_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_team_mapped_args(
        ...
        custom_role_keys: typing.Optional[TeamPostInputCustomRoleKeys] = None,
        member_ids: typing.Optional[TeamPostInputMemberIDs] = None,
        permission_grants: typing.Optional[typing.List[PermissionGrantInput]] = None,
        ...
        if custom_role_keys is not None:
            _body["customRoleKeys"] = custom_role_keys
        if key is not None:
            _body["key"] = key
        if member_ids is not None:
            _body["memberIDs"] = member_ids
        if name is not None:
            _body["name"] = name
        if permission_grants is not None:
            _body["permissionGrants"] = permission_grants
        args.body = _body
    ...
    async def _acreate_team_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/teams',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_team_post_input.serialize(body, content_type)
