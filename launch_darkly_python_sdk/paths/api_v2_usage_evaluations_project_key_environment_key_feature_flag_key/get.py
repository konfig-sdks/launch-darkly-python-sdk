...
class BaseApi(api_client.Api):
    ...
    def _get_evaluations_usage_mapped_args(
        self,
        project_key: str,
        environment_key: str,
    ...
    async def _aget_evaluations_usage_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/usage/evaluations/{projectKey}/{environmentKey}/{featureFlagKey}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_evaluations_usage_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetEvaluationsUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_evaluations_usage(
        self,
        project_key: str,
        environment_key: str,
        feature_flag_key: str,
        ...
        **kwargs,
        ...
        args = self._get_evaluations_usage_mapped_args(
        ...
        return await self._aget_evaluations_usage_oapg(
    ...
    def get_evaluations_usage(
        ...
        return self._get_evaluations_usage_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetEvaluationsUsage(BaseApi):
    ...
    async def aget_evaluations_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_evaluations_usage(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            _from=_from,
    ...
    def get_evaluations_usage(
        ...
        raw_response = self.raw.get_evaluations_usage(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            _from=_from,
