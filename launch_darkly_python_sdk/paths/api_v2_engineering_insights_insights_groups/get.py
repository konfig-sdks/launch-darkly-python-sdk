...
from launch_darkly_python_sdk.model.insight_group_collection import InsightGroupCollection as InsightGroupCollectionSchema
...
from launch_darkly_python_sdk.type.insight_group_collection import InsightGroupCollection
...
from launch_darkly_python_sdk.pydantic.insight_group_collection import InsightGroupCollection as InsightGroupCollectionPydantic
...
SchemaFor200ResponseBodyApplicationJson = InsightGroupCollectionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InsightGroupCollection
...
class BaseApi(api_client.Api):
    ...
    def _list_group_insight_scores_mapped_args(
        self,
    ...
    async def _alist_group_insight_scores_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/engineering-insights/insights/groups',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_group_insight_scores_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListGroupInsightScoresRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_group_insight_scores(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        sort: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_group_insight_scores_mapped_args(
            limit=limit,
            offset=offset,
            sort=sort,
            query=query,
        ...
        return await self._alist_group_insight_scores_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_group_insight_scores(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        sort: typing.Optional[str] = None,
        ...
        return self._list_group_insight_scores_oapg(
            query_params=args.query,
        )

class ListGroupInsightScores(BaseApi):
    ...
    async def alist_group_insight_scores(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InsightGroupCollectionPydantic:
        raw_response = await self.raw.alist_group_insight_scores(
            limit=limit,
            offset=offset,
            sort=sort,
            query=query,
        ...
        if validate:
            return InsightGroupCollectionPydantic(**raw_response.body)
        return api_client.construct_model_instance(InsightGroupCollectionPydantic, raw_response.body)
    ...
    def list_group_insight_scores(
        ...
        raw_response = self.raw.list_group_insight_scores(
            limit=limit,
            offset=offset,
            sort=sort,
            query=query,
