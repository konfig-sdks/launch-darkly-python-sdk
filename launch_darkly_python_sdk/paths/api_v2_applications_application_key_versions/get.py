...
from launch_darkly_python_sdk.model.application_versions_collection_rep import ApplicationVersionsCollectionRep as ApplicationVersionsCollectionRepSchema
...
from launch_darkly_python_sdk.type.application_versions_collection_rep import ApplicationVersionsCollectionRep
...
from launch_darkly_python_sdk.pydantic.application_versions_collection_rep import ApplicationVersionsCollectionRep as ApplicationVersionsCollectionRepPydantic
...
SchemaFor200ResponseBodyApplicationJson = ApplicationVersionsCollectionRepSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ApplicationVersionsCollectionRep
...
class BaseApi(api_client.Api):
    ...
    def _get_application_versions_mapped_args(
        self,
        application_key: str,
    ...
    async def _aget_application_versions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/applications/{applicationKey}/versions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_application_versions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetApplicationVersionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_application_versions(
        self,
        application_key: str,
        filter: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_application_versions_mapped_args(
        ...
        return await self._aget_application_versions_oapg(
    ...
    def get_application_versions(
        ...
        return self._get_application_versions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetApplicationVersions(BaseApi):
    ...
    async def aget_application_versions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApplicationVersionsCollectionRepPydantic:
        raw_response = await self.raw.aget_application_versions(
            application_key=application_key,
            filter=filter,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return ApplicationVersionsCollectionRepPydantic(**raw_response.body)
        return api_client.construct_model_instance(ApplicationVersionsCollectionRepPydantic, raw_response.body)
    ...
    def get_application_versions(
        ...
        raw_response = self.raw.get_application_versions(
            application_key=application_key,
            filter=filter,
            limit=limit,
            offset=offset,
