...
class BaseApi(api_client.Api):
    ...
    def _delete_request_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_request_oapg(
        self,
...
class DeleteRequestRaw(BaseApi):
    ...
    async def adelete_request(
        ...
        **kwargs,
        ...
        args = self._delete_request_mapped_args(
            id=id,
        )
        return await self._adelete_request_oapg(
    ...
    def delete_request(
        ...
        return self._delete_request_oapg(
            path_params=args.path,
        )

class DeleteRequest(BaseApi):
    ...
    async def adelete_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_request(
            id=id,
            **kwargs,
        )
    ...
    def delete_request(
        ...
        raw_response = self.raw.delete_request(
            id=id,
        )
