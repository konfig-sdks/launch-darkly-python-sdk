...
from launch_darkly_python_sdk.model.expandable_approval_request_response import ExpandableApprovalRequestResponse as ExpandableApprovalRequestResponseSchema
...
from launch_darkly_python_sdk.type.expandable_approval_request_response import ExpandableApprovalRequestResponse
...
from launch_darkly_python_sdk.pydantic.expandable_approval_request_response import ExpandableApprovalRequestResponse as ExpandableApprovalRequestResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ExpandableApprovalRequestResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ExpandableApprovalRequestResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_request_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_request_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/approval-requests/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRequestByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_request_by_id(
        self,
        id: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_request_by_id_mapped_args(
            id=id,
            expand=expand,
        )
        return await self._aget_request_by_id_oapg(
    ...
    def get_request_by_id(
        ...
        return self._get_request_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRequestById(BaseApi):
    ...
    async def aget_request_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ExpandableApprovalRequestResponsePydantic:
        raw_response = await self.raw.aget_request_by_id(
            id=id,
            expand=expand,
            **kwargs,
        )
        if validate:
            return ExpandableApprovalRequestResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ExpandableApprovalRequestResponsePydantic, raw_response.body)
    ...
    def get_request_by_id(
        ...
        raw_response = self.raw.get_request_by_id(
            id=id,
            expand=expand,
        )
        if validate:
