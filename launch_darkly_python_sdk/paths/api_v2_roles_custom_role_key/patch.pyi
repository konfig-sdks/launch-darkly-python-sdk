...
from launch_darkly_python_sdk.model.custom_role import CustomRole as CustomRoleSchema
...
from launch_darkly_python_sdk.type.custom_role import CustomRole

from ...api_client import Dictionary
from launch_darkly_python_sdk.pydantic.custom_role import CustomRole as CustomRolePydantic
...
# Path params
CustomRoleKeySchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'customRoleKey': typing.Union[CustomRoleKeySchema, str, ],
    }
)
...
request_path_custom_role_key = api_client.PathParameter(
    name="customRoleKey",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CustomRoleKeySchema,
    required=True,
)
# body param
...
SchemaFor200ResponseBodyApplicationJson = CustomRoleSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_single_custom_role_mapped_args(
        self,
        patch: JSONPatch,
        custom_role_key: str,
        ...
        args.body = _body
        if custom_role_key is not None:
            _path_params["customRoleKey"] = custom_role_key
        args.path = _path_params
        return args

    async def _aupdate_single_custom_role_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v2/roles/{customRoleKey}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_single_custom_role_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSingleCustomRoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_single_custom_role(
        self,
        patch: JSONPatch,
        custom_role_key: str,
        comment: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_single_custom_role_mapped_args(
            patch=patch,
            custom_role_key=custom_role_key,
            comment=comment,
        )
        return await self._aupdate_single_custom_role_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_single_custom_role(
        self,
        patch: JSONPatch,
        custom_role_key: str,
        comment: typing.Optional[str] = None,
        ...
        return self._update_single_custom_role_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSingleCustomRole(BaseApi):
    ...
    async def aupdate_single_custom_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_single_custom_role(
            patch=patch,
            custom_role_key=custom_role_key,
            comment=comment,
            **kwargs,
        ...
        if validate:
            return CustomRolePydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomRolePydantic, raw_response.body)
    ...
    def update_single_custom_role(
        ...
        raw_response = self.raw.update_single_custom_role(
            patch=patch,
            custom_role_key=custom_role_key,
            comment=comment,
        )
