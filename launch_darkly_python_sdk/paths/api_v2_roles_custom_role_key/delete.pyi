...
class BaseApi(api_client.Api):
    ...
    def _delete_role_by_custom_key_mapped_args(
        self,
        custom_role_key: str,
    ...
    async def _adelete_role_by_custom_key_oapg(
        self,
    ...
    def _delete_role_by_custom_key_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteRoleByCustomKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_role_by_custom_key(
        self,
        custom_role_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_role_by_custom_key_mapped_args(
            custom_role_key=custom_role_key,
        )
        return await self._adelete_role_by_custom_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_role_by_custom_key(
        self,
        custom_role_key: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_role_by_custom_key_oapg(
            path_params=args.path,
        )

class DeleteRoleByCustomKey(BaseApi):
    ...
    async def adelete_role_by_custom_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_role_by_custom_key(
            custom_role_key=custom_role_key,
            **kwargs,
        )
    ...
    def delete_role_by_custom_key(
        ...
        raw_response = self.raw.delete_role_by_custom_key(
            custom_role_key=custom_role_key,
        )
