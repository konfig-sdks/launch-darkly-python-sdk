...
class BaseApi(api_client.Api):
    ...
    def _get_by_custom_key_mapped_args(
        self,
        custom_role_key: str,
    ...
    async def _aget_by_custom_key_oapg(
        self,
...
class GetByCustomKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_custom_key(
        self,
        custom_role_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_by_custom_key_mapped_args(
            custom_role_key=custom_role_key,
        )
        return await self._aget_by_custom_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_custom_key(
        self,
        custom_role_key: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_by_custom_key_oapg(
            path_params=args.path,
        )

class GetByCustomKey(BaseApi):
    ...
    async def aget_by_custom_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_custom_key(
            custom_role_key=custom_role_key,
            **kwargs,
        )
        if validate:
    ...
    def get_by_custom_key(
        ...
        raw_response = self.raw.get_by_custom_key(
            custom_role_key=custom_role_key,
        )
        if validate:
            return CustomRolePydantic(**raw_response.body)
